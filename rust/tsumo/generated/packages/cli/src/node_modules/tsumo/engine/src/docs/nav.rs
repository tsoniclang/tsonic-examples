...
pub(crate) fn compute_git_hub_blob_url(
    ...
    let repo: String = crate::node_modules::tsumo::engine::src::utils::strings::trim_end_char(
    ...
    let rel: String = crate::node_modules::tsumo::engine::src::utils::strings::trim_start_char(
...
pub(crate) fn resolve_markdown_nav_link(
    ...
    let split: crate::node_modules::tsumo::engine::src::docs::url::UrlSuffixSplit =
        crate::node_modules::tsumo::engine::src::docs::url::SPLIT_URL_SUFFIX
    ...
    {
        repo_path = crate::node_modules::tsumo::engine::src::utils::strings::trim_end_char(
...
pub(crate) struct NavGroupBuildState {
    ...
    pub(crate) order: i32,
    pub(crate) children:
        js_abi::JsArray<crate::node_modules::tsumo::engine::src::docs::models::NavItem>,
}
...
impl NavGroupBuild {
    ...
    pub fn new(title: String, order: i32) -> NavGroupBuild {
        ...
        let empty: js_abi::JsArray<crate::node_modules::tsumo::engine::src::docs::models::NavItem> =
            js_abi::JsArray::from_dense(vec![]);
        let field_children: js_abi::JsArray<
            crate::node_modules::tsumo::engine::src::docs::models::NavItem,
        > = empty.clone();
        NavGroupBuild {
...
> {
    ...
    let items: js_abi::JsArray<crate::node_modules::tsumo::engine::src::docs::models::NavItem> =
        js_abi::JsArray::from_dense(vec![]);
    let mut order: i32 = 1;
    {
        let mut item_index: f64 = 0.0;
        'loop_value: while item_index
            < (tsonic_rust_runtime::conversions::usize_to_i32({ let dispatch_receiver = &{ let downcast_value = &value; crate::node_modules::tsumo::engine::src::utils::json::JsonArray { identity: downcast_value.identity.clone(), dispatch: downcast_value.dispatch.clone().downcast_json_value_to_json_array().unwrap() } }; dispatch_receiver.dispatch.read_json_array_items() }.len())? as f64)
        {
            let current: crate::node_modules::tsumo::engine::src::utils::json::JsonValue = match {
            ...
            let url_value: Option<crate::node_modules::tsumo::engine::src::utils::json::JsonValue> =
                {
            ...
            let empty_children: js_abi::JsArray<
                crate::node_modules::tsumo::engine::src::docs::models::NavItem,
            > = js_abi::JsArray::from_dense(vec![]);
            let children: js_abi::JsArray<
                crate::node_modules::tsumo::engine::src::docs::models::NavItem,
    ...
    None => unreachable!("checked flow selected a missing optional value"),
            ...
            tsonic_rust_runtime::conversions::usize_to_i32(
                items.push_many([crate::node_modules::tsumo::engine::src::docs::models::NavItem::new(
                    match title.as_ref() {
                        Some(flow_value_5) => flow_value_5.clone(),
                        None => unreachable!("checked flow selected a missing optional value"),
                    },
...
pub fn module_init() {
    {
        ...
        >::new(move |callable_arguments| {
            ...
            let title: String = js_string::trim(
            ...
            let target: String = js_string::trim(
                &crate::node_modules::tsumo::engine::src::utils::strings::substring_count(
                    line.clone(),
                    mid + 2,
                    close - (mid + 2),
    ...
    };
    {
        ...
        >::new(move |callable_arguments_2| {
            ...
            let lines: js_abi::JsArray<String> = js_string::split_all(
                &crate::node_modules::tsumo::engine::src::utils::strings::replace_line_endings(
                    &markdown,
                    String::from("\n"),
                )?,
                "\n",
            ...
            let mut order: i32 = 1;
            {
                ...
                'loop_value: while i < (tsonic_rust_runtime::conversions::usize_to_i32(lines.len())? as f64) {
                    ...
                    let empty: js_abi::JsArray<
                        crate::node_modules::tsumo::engine::src::docs::models::NavItem,
                    > = js_abi::JsArray::from_dense(vec![]);
                    let item: crate::node_modules::tsumo::engine::src::docs::models::NavItem =
                        crate::node_modules::tsumo::engine::src::docs::models::NavItem::new(
                            match parsed.as_ref() {
                                Some(flow_value_4) => flow_value_4.clone(),
                                None => {
            ...
            let group_arr: js_abi::JsArray<NavGroupBuild> = groups.clone();
            {
                ...
                while i < (tsonic_rust_runtime::conversions::usize_to_i32(group_arr.len())? as f64)
                {
                    ...
                    let group_item: crate::node_modules::tsumo::engine::src::docs::models::NavItem =
                        crate::node_modules::tsumo::engine::src::docs::models::NavItem::new(
    ...
    };
    {
        ...
        >::new(move |callable_arguments_3| {
            ...
            let root: crate::node_modules::tsumo::engine::src::utils::json::JsonValue =
            ...
            if root
                ...
                .is_some()
            {
                let items: Option<crate::node_modules::tsumo::engine::src::utils::json::JsonValue> =
                    {
