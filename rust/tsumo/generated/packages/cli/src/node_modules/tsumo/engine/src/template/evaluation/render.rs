...
impl TemplateRangeValues {
    ...
    pub fn new(
        keys: js_abi::JsArray<
            crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue,
        >,
        values: js_abi::JsArray<
            crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue,
        >,
    ) -> TemplateRangeValues {
        let field_keys: js_abi::JsArray<
            crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue,
        > = keys.clone();
        let field_values: js_abi::JsArray<
            crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue,
        > = values.clone();
        TemplateRangeValues {
...
type CreateControlScopeCallable =
    rt::Callable<
        (
            crate::node_modules::tsumo::engine::src::template::scope::RenderScope,
            crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue,
            Option<
                crate::node_modules::tsumo::engine::src::template::nodes::TemplateVariableBinding,
            >,
            crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue,
        ),
        rt::TsonicResult<crate::node_modules::tsumo::engine::src::template::scope::RenderScope>,
    >;
...
pub type RenderTemplateNodesCallable =
    rt::Callable<
        (
            ...
            >,
            crate::node_modules::tsumo::engine::src::utils::text_builder::TextBuilder,
            crate::node_modules::tsumo::engine::src::template::scope::RenderScope,
...
pub fn module_init() {
            ...
            {
                {
                    let mut index: f64 = 0.0;
                    while index
                        < (tsonic_rust_runtime::conversions::usize_to_i32({ let dispatch_receiver_5 = &{ let downcast_value_5 = &value; crate::node_modules::tsumo::engine::src::template::values::docs::DocsMountArrayValue { identity: downcast_value_5.identity.clone(), dispatch: downcast_value_5.dispatch.clone().downcast_template_value_to_docs_mount_array_value().unwrap() } }; dispatch_receiver_5.dispatch.read_docs_mount_array_value_value() }.len())? as f64)
                    {
                        tsonic_rust_runtime::conversions::usize_to_i32(
                            values.push_many([{
                                let upcast_value_4 =
                                    crate::node_modules::tsumo::engine::src::template::values::docs::DocsMountValue::new(
                                        match {
            ...
            {
                {
                    let mut index: f64 = 0.0;
                    while index
                        < (tsonic_rust_runtime::conversions::usize_to_i32({ let dispatch_receiver_7 = &{ let downcast_value_7 = &value; crate::node_modules::tsumo::engine::src::template::values::docs::NavArrayValue { identity: downcast_value_7.identity.clone(), dispatch: downcast_value_7.dispatch.clone().downcast_template_value_to_nav_array_value().unwrap() } }; dispatch_receiver_7.dispatch.read_nav_array_value_value() }.len())? as f64)
                    {
                        tsonic_rust_runtime::conversions::usize_to_i32(
                            values.push_many([{
                                let upcast_value_5 =
                                    crate::node_modules::tsumo::engine::src::template::values::docs::NavItemValue::new(
                                        match {
            ...
            {
                {
                    let mut index: f64 = 0.0;
                    while index
                        < (tsonic_rust_runtime::conversions::usize_to_i32({ let dispatch_receiver_9 = &{ let downcast_value_9 = &value; crate::node_modules::tsumo::engine::src::template::values::site::SitesArrayValue { identity: downcast_value_9.identity.clone(), dispatch: downcast_value_9.dispatch.clone().downcast_template_value_to_sites_array_value().unwrap() } }; dispatch_receiver_9.dispatch.read_sites_array_value_value() }.len())? as f64)
                    {
                        tsonic_rust_runtime::conversions::usize_to_i32(
                            values.push_many([{
                                let upcast_value_6 =
                                    crate::node_modules::tsumo::engine::src::template::values::site::SiteValue::new(
                                        match {
            ...
            {
                {
                    let mut index: f64 = 0.0;
                    while index
                        < (tsonic_rust_runtime::conversions::usize_to_i32({ let dispatch_receiver_11 = &{ let downcast_value_11 = &value; crate::node_modules::tsumo::engine::src::template::values::menus::MenuArrayValue { identity: downcast_value_11.identity.clone(), dispatch: downcast_value_11.dispatch.clone().downcast_template_value_to_menu_array_value().unwrap() } }; dispatch_receiver_11.dispatch.read_menu_array_value_value() }.len())? as f64)
                    {
                        tsonic_rust_runtime::conversions::usize_to_i32(
                            values.push_many([{
                                let upcast_value_7 =
                                    crate::node_modules::tsumo::engine::src::template::values::menus::MenuEntryValue::new(
                                        match {
                                            let dispatch_receiver_12 = &{
                                                let downcast_value_12 = &value;
                                                crate::node_modules::tsumo::engine::src::template::values::menus::MenuArrayValue {
            ...
            {
                {
                    let mut index: f64 = 0.0;
                    while index
                        < (tsonic_rust_runtime::conversions::usize_to_i32({ let dispatch_receiver_14 = &{ let downcast_value_14 = &value; crate::node_modules::tsumo::engine::src::template::values::arrays::AnyArrayValue { identity: downcast_value_14.identity.clone(), dispatch: downcast_value_14.dispatch.clone().downcast_template_value_to_any_array_value().unwrap() } }; dispatch_receiver_14.dispatch.read_any_array_value_value() }.len())? as f64)
                    {
                        tsonic_rust_runtime::conversions::usize_to_i32(
                            values.push_many([match {
    ...
    };
    {
        ...
        >::new(move |callable_arguments_5| {
                ...
                .is_some()
            {
                output.append({
                    let dispatch_receiver_18 = &{
                        ...
                        crate::node_modules::tsumo::engine::src::template::nodes::TextNode {
            ...
            {
                output.append(
                    crate::node_modules::tsumo::engine::src::template::runtime_helpers::STRINGIFY
                        .with(|module_binding| module_binding.load())
                        .call((
                            crate::node_modules::tsumo::engine::src::template::evaluation::evaluate::evaluate_pipeline(
                                {
                                    let dispatch_receiver_19 = &{
                                        let downcast_value_19 = &node;
                                        crate::node_modules::tsumo::engine::src::template::nodes::OutputNode {
                    ...
                    crate::node_modules::tsumo::engine::src::template::evaluation::evaluate::evaluate_pipeline(
                        {
                            let dispatch_receiver_21 = &{
                                ...
                                crate::node_modules::tsumo::engine::src::template::nodes::AssignmentNode {
            ...
            if node
                ...
                .is_some()
            {
                let context: crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue =
                    crate::node_modules::tsumo::engine::src::template::evaluation::evaluate::evaluate_pipeline(
                        {
                            let dispatch_receiver_25 = &{
                                let downcast_value_25 = &node;
                                crate::node_modules::tsumo::engine::src::template::nodes::TemplateInvokeNode {
                ...
                let dot: crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue =
                    if context
                        .dispatch
                        .clone()
    ...
    None => unreachable!("checked flow selected a missing optional value"),
                ...
                let invoked_scope: crate::node_modules::tsumo::engine::src::template::scope::RenderScope =
                    crate::node_modules::tsumo::engine::src::template::scope::RenderScope::new(
                        dot.clone(),
                        dot.clone(),
                        scope.state.with(|state| state.site.clone()),
            ...
            if node
                ...
                .is_some()
            {
                let condition: crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue =
                    crate::node_modules::tsumo::engine::src::template::evaluation::evaluate::evaluate_pipeline(
                        {
                            let dispatch_receiver_33 = &{
                                let downcast_value_30 = &node;
                                crate::node_modules::tsumo::engine::src::template::nodes::IfNode {
                ...
                let block_scope: crate::node_modules::tsumo::engine::src::template::scope::RenderScope =
                    CREATE_CONTROL_SCOPE
                        .with(|module_binding| module_binding.load())
                        .call((
                            scope.clone(),
                            scope.state.with(|state| state.dot.clone()),
                ...
                .is_some()
            {
                let range: Option<TemplateRangeValues> = TO_RANGE_VALUES
                    .with(|module_binding| module_binding.load())
                    .call((crate::node_modules::tsumo::engine::src::template::evaluation::evaluate::evaluate_pipeline(
                        {
                            let dispatch_receiver_37 = &{
                                let downcast_value_34 = &node;
                                crate::node_modules::tsumo::engine::src::template::nodes::RangeNode {
    ...
    None => unreachable!("checked flow selected a missing optional value"),
}).state.with(|state| state.values.clone()).len())? as f64)
                    {
                        ...
                        let item_scope: crate::node_modules::tsumo::engine::src::template::scope::RenderScope =
                            crate::node_modules::tsumo::engine::src::template::scope::RenderScope::new(
                ...
                .is_some()
            {
                    ...
                    crate::node_modules::tsumo::engine::src::template::evaluation::evaluate::evaluate_pipeline(
                        {
                            let dispatch_receiver_42 = &{
                                ...
                                crate::node_modules::tsumo::engine::src::template::nodes::WithNode {
                ...
                if value
                    ...
                    .is_some()
                {
                    let deferred: crate::node_modules::tsumo::engine::src::template::values::deferred::DeferredTemplateValue =
                        {
                            let downcast_value_40 = &value;
                            crate::node_modules::tsumo::engine::src::template::values::deferred::DeferredTemplateValue {
                ...
                let nested_scope: crate::node_modules::tsumo::engine::src::template::scope::RenderScope =
                    CREATE_CONTROL_SCOPE
                        .with(|module_binding| module_binding.load())
                        .call((
                            scope.clone(),
                    ...
                    crate::node_modules::tsumo::engine::src::template::evaluation::evaluate::evaluate_pipeline(
                        {
                            let dispatch_receiver_50 = &{
                                ...
                                crate::node_modules::tsumo::engine::src::template::nodes::BlockNode {
