...
type ProtectStandardShortcodesCallable =
    rt::Callable<
        (
            String,
            js_abi::JsArray<crate::node_modules::tsumo::engine::src::shortcode::ShortcodeCall>,
            ...
            crate::node_modules::tsumo::engine::src::markdown::shortcodes::ShortcodeOrdinalTracker,
...
pub type RenderMarkdownWithShortcodesCallable =
    rt::Callable<
        ...
        rt::TsonicResult<
            crate::node_modules::tsumo::engine::src::markdown::result::MarkdownResult,
        >,
    >;
...
pub fn module_init() {
    {
        ...
        >::new(move |callable_arguments| {
            ...
            let outputs: js_abi::JsArray<String> = js_abi::JsArray::from_dense(vec![]);
            {
                ...
                while i < (tsonic_rust_runtime::conversions::usize_to_i32(calls.len())? as f64) {
                    tsonic_rust_runtime::conversions::usize_to_i32(
                        outputs
                            .push_many([crate::node_modules::tsumo::engine::src::markdown::shortcodes::RENDER_SHORTCODE
                                ...
                                .call((
                                    ...
                                    Option::<crate::node_modules::tsumo::engine::src::template::contexts::ShortcodeContext>::None,
            ...
            let mut source: String = text.clone();
            {
                ...
                while i >= 0 {
                    let call: crate::node_modules::tsumo::engine::src::shortcode::ShortcodeCall =
                        match calls
    ...
    };
    {
        ...
        >::new(move |callable_arguments_3| {
            ...
            let ordinal_tracker: crate::node_modules::tsumo::engine::src::markdown::shortcodes::ShortcodeOrdinalTracker =
                crate::node_modules::tsumo::engine::src::markdown::shortcodes::CREATE_ORDINAL_TRACKER
                    .with(|module_binding| module_binding.load())
                    .call(())?;
            let recursion_guard: js_abi::JsMap<String, bool> = js_abi::JsMap::new();
            let calls: js_abi::JsArray<
            ...
            if tsonic_rust_runtime::conversions::usize_to_i32(md_calls.len())? > 0 {
                text_after_markdown_shortcodes =
                    crate::node_modules::tsumo::engine::src::markdown::shortcodes::PROCESS_SHORTCODE_CALLS
                        .with(|module_binding| module_binding.load())
                        .call((
                            markdown.clone(),
                            md_calls.clone(),
            ...
            let parsed_standard_calls: js_abi::JsArray<
                crate::node_modules::tsumo::engine::src::shortcode::ShortcodeCall,
            > = if tsonic_rust_runtime::conversions::usize_to_i32(md_calls.len())? == 0 {
                calls.clone()
            } else {
            ...
            let standard_calls: js_abi::JsArray<
                crate::node_modules::tsumo::engine::src::shortcode::ShortcodeCall,
            > = js_abi::JsArray::from_dense(vec![]);
            {
                let mut i: f64 = 0.0;
            ...
            let source_plan: tsumo_platform::MarkdownSourcePlan =
                crate::node_modules::tsumo::engine::src::markdown::platform::create_markdown_source_plan(
                    markdown_source.clone(),
                )?;
            let full_document: tsumo_platform::MarkdownDocument =
                crate::node_modules::tsumo::engine::src::markdown::platform::create_markdown_document(
                    source_plan.full_source.clone(),
                );
            let toc: String = if source_plan.full_source == source_plan.toc_source {
                full_document.table_of_contents()
            } else {
                crate::node_modules::tsumo::engine::src::markdown::platform::create_markdown_document(
                    source_plan.toc_source.clone(),
                )
                .table_of_contents()
            };
            let hook_ctx: crate::node_modules::tsumo::engine::src::markdown::render_hooks::RenderHookContext =
                crate::node_modules::tsumo::engine::src::markdown::render_hooks::RenderHookContext::new(
                    page.clone(),
                    site.clone(),
                    env.clone(),
                )?;
            ...
            let mut html: String = if has_hooks {
                crate::node_modules::tsumo::engine::src::markdown::render_hooks::RENDER_MARKDOWN_WITH_HOOKS
                    .with(|module_binding| module_binding.load())
            ...
            Ok::<_, rt::TsonicError>(crate::node_modules::tsumo::engine::src::markdown::result::MarkdownResult::new(
                html.clone(),
                summary_html.clone(),
                plain_text.clone(),
                toc.clone(),
