...
impl TomlValueReader {
    ...
    > {
            ...
            ))?
        {
            ...
            return SCALAR_TO_TEMPLATE_VALUE
                ...
                .call((crate::node_modules::tsumo::engine::src::utils::structured_scalars::parse_structured_scalar(
                    &raw,
                    crate::node_modules::tsumo::engine::src::utils::structured_scalars::StructuredScalarFormat::Toml,
                    {
    ...
    > {
        self.expect(String::from("{"))?;
        let fields: crate::node_modules::tsumo::engine::src::template::values::dict::DictValue =
    ...
    > {
        ...
        let source_path: Option<String> = self.state.with(|state| state.source_path.clone());
        let line: i32 = self.state.with(|state| state.line);
        let try_body: rt::TsonicResult<rt::Completion<crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue>> =
        ...
        let try_flow: rt::TsonicResult<rt::Completion<crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue>> =
            match try_body {
...
pub fn module_init() {
                    ...
                    <= tsonic_rust_runtime::conversions::usize_to_i32(js_string::js_len(&text))?
                {
                        ...
                        || js_string::starts_with_from_start(&raw, "'")
                    {
                        ...
                        if parsed.state.with(|state| state.kind)
                            != crate::node_modules::tsumo::engine::src::params::PARAM_KIND_STRING
                                .with(|module_binding| module_binding.load())
                        {
                            return Err(
                                rt::TsonicError::from(
    ...
    };
    {
        ...
        >::new(move |callable_arguments_9| {
            ...
            let mut current: crate::node_modules::tsumo::engine::src::template::values::dict::DictValue =
                root.clone();
            {
                let mut index: i32 = 0;
                'loop_value_5: while index < tsonic_rust_runtime::conversions::usize_to_i32(segments.len())? {
                    ...
                    .get(&segment);
                    if existing.is_none() {
                        let created: crate::node_modules::tsumo::engine::src::template::values::dict::DictValue =
                            crate::node_modules::tsumo::engine::src::template::values::dict::DictValue::new(
                                js_abi::JsMap::new(),
                            );
                        {
    ...
    };
    {
        ...
        >::new(move |callable_arguments_10| {
            ...
            let parent: crate::node_modules::tsumo::engine::src::template::values::dict::DictValue =
    ...
    };
    {
        ...
        >::new(move |callable_arguments_11| {
            ...
            let root: crate::node_modules::tsumo::engine::src::template::values::dict::DictValue =
                crate::node_modules::tsumo::engine::src::template::values::dict::DictValue::new(
                    js_abi::JsMap::new(),
                );
            let mut current_table: crate::node_modules::tsumo::engine::src::template::values::dict::DictValue =
                root.clone();
                ...
                .call((text.clone(), source_path.clone()))?;
            {
                ...
                'loop_value_7: while index < tsonic_rust_runtime::conversions::usize_to_i32(statements.len())? {
                        ...
                        && js_string::ends_with_at_end(&raw, "]]")
                    {
                        ...
                        .get(&name);
                        let entries: crate::node_modules::tsumo::engine::src::template::values::arrays::AnyArrayValue;
                        if existing.is_none() {
                            entries =
                                crate::node_modules::tsumo::engine::src::template::values::arrays::AnyArrayValue::new(
                                    js_abi::JsArray::from_dense(vec![]),
