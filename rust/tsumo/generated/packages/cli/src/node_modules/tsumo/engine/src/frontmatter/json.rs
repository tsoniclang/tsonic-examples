...
pub(crate) fn require_string_array(
    ...
    let array: crate::node_modules::tsumo::engine::src::utils::json::JsonArray = {
        let downcast_value = &value;
    ...
    let result: js_abi::JsArray<String> = js_abi::JsArray::from_dense(vec![]);
    {
        ...
        {
            let item: crate::node_modules::tsumo::engine::src::utils::json::JsonValue = match {
...
pub(crate) fn assert_case_insensitive_keys_unique(
    value: crate::node_modules::tsumo::engine::src::utils::json::JsonObject,
    context: String,
    source_path: Option<String>,
) -> rt::TsonicResult<()> {
...
pub(crate) fn apply_menu_property(
    entry: crate::node_modules::tsumo::engine::src::frontmatter::menu::FrontMatterMenu,
    key_raw: String,
    value: crate::node_modules::tsumo::engine::src::utils::json::JsonValue,
    source_path: Option<String>,
) -> rt::TsonicResult<()> {
...
pub fn parse_json_front_matter(
    text: String,
    source_path: Option<String>,
) -> rt::TsonicResult<crate::node_modules::tsumo::engine::src::frontmatter::data::FrontMatter> {
    ...
    let root: crate::node_modules::tsumo::engine::src::utils::json::JsonObject = {
    ...
    let front_matter: crate::node_modules::tsumo::engine::src::frontmatter::data::FrontMatter =
        crate::node_modules::tsumo::engine::src::frontmatter::data::FrontMatter::new();
    {
        let mut index: f64 = 0.0;
        while index
                                        ...
                                        if key == "tags" {
                                            ...
                                            if key == "categories" {
                                                ...
                                                if key == "params" {
                                                    ...
                                                    let params: crate::node_modules::tsumo::engine::src::utils::json::JsonObject =
                                                        {
                                                    ...
                                                    if key == "menu" {
                                                        ...
                                                        let menu_object: crate::node_modules::tsumo::engine::src::utils::json::JsonObject =
                                                            {
                                                        ...
                                                        )?;
                                                        {
                                                                ...
                                                                < (tsonic_rust_runtime::conversions::usize_to_i32({ let dispatch_receiver_10 = &menu_object; dispatch_receiver_10.dispatch.read_json_object_properties() }.len())? as f64)
                                                            {
                                                                ...
                                                                let menu_fields: crate::node_modules::tsumo::engine::src::utils::json::JsonObject =
                                                                    {
                                                                ...
                                                                let entry: crate::node_modules::tsumo::engine::src::frontmatter::menu::FrontMatterMenu =
                                                                    crate::node_modules::tsumo::engine::src::frontmatter::menu::FrontMatterMenu::new(
                                                                        menu.state.with(|state| {
                                                                            state.key.clone()
                                                                        }),
                                                                    );
