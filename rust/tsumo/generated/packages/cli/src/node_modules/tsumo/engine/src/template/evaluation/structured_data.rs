...
impl YamlParseResult {
    ...
    pub fn new(
        ...
        let field_value: crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue =
            value.clone();
...
type JsonToTemplateValueCallable =
    rt::Callable<
        (
            crate::node_modules::tsumo::engine::src::utils::json::JsonValue,
        ),
        rt::TsonicResult<
            crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue,
        >,
...
impl YamlTemplateParser {
    ...
    > {
        ...
        {
            return Ok(crate::node_modules::tsumo::engine::src::template::runtime_helpers::NIL
                .with(|module_binding| module_binding.load()));
        }
        ...
        let mut indentation: Option<i32> = Option::<i32>::None;
        {
            ...
            'loop_value: while index < tsonic_rust_runtime::conversions::usize_to_i32(js_string::js_len(&value))?
            {
                ...
                let parsed_indentation: Option<i32> =
                    crate::node_modules::tsumo::engine::src::utils::int32::parse_int32(&character)?;
    ...
    .as_ref()
{
    ...
    > {
        ...
        let parsed: crate::node_modules::tsumo::engine::src::params::ParamValue =
            crate::node_modules::tsumo::engine::src::utils::structured_scalars::parse_structured_scalar(
                &value,
                crate::node_modules::tsumo::engine::src::utils::structured_scalars::StructuredScalarFormat::Yaml,
                {
                    ...
                    >::new(move |callable_arguments| {
                        ...
                        Ok::<_, rt::TsonicError>(crate::node_modules::tsumo::engine::src::diagnostics::create_tsumo_error(
    ...
    };
    {
        ...
        >::new(move |callable_arguments_6| {
            ...
            let mut content: String = js_string::trim_end(
                &crate::node_modules::tsumo::engine::src::utils::structured_scalars::strip_structured_comment(
                    crate::node_modules::tsumo::engine::src::utils::strings::substring_from(
                        &raw,
                        indent,
                    )?,
    ...
    };
    {
        ...
        >::new(move |callable_arguments_8| {
            ...
            if value
                ...
                .is_some()
            {
                let resource: crate::node_modules::tsumo::engine::src::resources::models::Resource =
                    {
        ...
        >::new(move |callable_arguments_11| {
            ...
            if format == "json" {
                return JSON_TO_TEMPLATE_VALUE
                    .with(|module_binding| module_binding.load())
                    .call((crate::node_modules::tsumo::engine::src::utils::json::PARSE_JSON
                        .with(|module_binding| module_binding.load())
            ...
            if format == "toml" {
                return Ok::<_, rt::TsonicError>({
                    let upcast_value_6 =
                        crate::node_modules::tsumo::engine::src::template::evaluation::toml_data::PARSE_TOML_TEMPLATE_DATA
                            .with(|module_binding| module_binding.load())
                            .call((text.clone(), source_path.clone()))?;
                    crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue {
