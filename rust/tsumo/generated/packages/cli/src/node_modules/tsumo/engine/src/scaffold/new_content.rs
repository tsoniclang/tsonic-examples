...
pub fn new_content(
    ...
    let content_dir: String = tsonic_rust_node::path::resolve(&[dir.as_str(), "content"])
        .map_err(tsonic_rust_runtime::TsonicError::from)?;
    let rel: String = crate::node_modules::tsumo::engine::src::utils::strings::replace_text(
    ...
    let template: String = if crate::node_modules::tsumo::engine::src::fs::FILE_EXISTS
        .with(|module_binding| module_binding.load())
    ...
    let slug: String = crate::node_modules::tsumo::engine::src::utils::text::slugify(
    ...
    content = crate::node_modules::tsumo::engine::src::utils::strings::replace_text(
        &content,
        String::from("{{ .Title }}"),
        title.clone(),
    )?;
