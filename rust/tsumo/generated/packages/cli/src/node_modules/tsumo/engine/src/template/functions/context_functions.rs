...
> {
    ...
    let env: crate::node_modules::tsumo::engine::src::template::environment::TemplateEnvironment =
        context.state.with(|state| state.environment.clone());
    let overrides: js_abi::JsMap<
        String,
    ...
    {
        let store: crate::node_modules::tsumo::engine::src::template::values::scratch::ScratchStore =
            crate::node_modules::tsumo::engine::src::template::evaluation::property_support::GET_SITE_STORE
    ...
    {
        let receiver_value: crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue =
            crate::node_modules::tsumo::engine::src::template::evaluation::expression_semantics::eval_token(
        ...
        return Ok(
            Some(
                crate::node_modules::tsumo::engine::src::template::evaluation::expression_semantics::call_method(
    ...
    if name == "return" {
        ...
        return Err(rt::TsonicError::from(crate::node_modules::tsumo::engine::src::template::evaluation::return_signal::TemplateReturnSignal::new(
            v.clone(),
        )));
    }
    ...
    if name == "hugo.version" {
        return Ok(
            Some({
                let upcast_value_4 =
                    crate::node_modules::tsumo::engine::src::template::values::version::VersionStringValue::new(
    ...
    if name == "now.year" {
        let year: Option<i32> = crate::node_modules::tsumo::engine::src::utils::int32::parse_int32(
            &crate::node_modules::tsumo::engine::src::utils::strings::substring_count(
                {
        ...
        return Ok(
            Some({
                let upcast_value_11 =
                    crate::node_modules::tsumo::engine::src::template::values::primitives::NumberValue::new(rt::option_coalesce(
                        year,
    ...
    if name == "now.format" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1 {
        ...
        return Ok(
            if rendered.is_some() {
                ...
                Some(crate::node_modules::tsumo::engine::src::template::runtime_helpers::NIL
                    .with(|module_binding| module_binding.load()))
            },
        );
    }
    if name == "now.unix" {
        ...
        let seconds: Option<i32> =
            crate::node_modules::tsumo::engine::src::utils::int32::to_int32(unix_seconds)?;
        if seconds.is_none() {
    ...
    if name == "i18n" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1 {
        ...
        let argument: crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue =
        ...
        let mut render_context: crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue =
            argument.clone();
        if argument
            .dispatch
            .clone()
