...
pub(crate) struct ParseNodesResultState {
    ...
    pub(crate) terminator_segment:
        Option<crate::node_modules::tsumo::engine::src::template::parser::tokens::TemplateSegment>,
...
impl ParseNodesResult {
    ...
    pub fn new(
        ...
        terminator_segment: Option<
            crate::node_modules::tsumo::engine::src::template::parser::tokens::TemplateSegment,
        >,
        terminator_segment_index: i32,
    ) -> ParseNodesResult {
        let field_nodes: js_abi::JsArray<
            crate::node_modules::tsumo::engine::src::template::nodes::TemplateNode,
        > = nodes.clone();
        let field_terminator: TemplateTerminator = terminator;
        let field_else_tokens: js_abi::JsArray<String> = else_tokens.clone();
        let field_terminator_segment: Option<
            crate::node_modules::tsumo::engine::src::template::parser::tokens::TemplateSegment,
...
pub(crate) struct ParsedControlPipelineState {
    pub(crate) pipeline:
        crate::node_modules::tsumo::engine::src::template::syntax::expressions::Pipeline,
    pub(crate) binding:
        Option<crate::node_modules::tsumo::engine::src::template::nodes::TemplateVariableBinding>,
}
...
impl ParsedControlPipeline {
    ...
    pub fn new(
        ...
        let field_pipeline: crate::node_modules::tsumo::engine::src::template::syntax::expressions::Pipeline =
            pipeline.clone();
        let field_binding: Option<
            crate::node_modules::tsumo::engine::src::template::nodes::TemplateVariableBinding,
        > = binding.clone();
        ParsedControlPipeline {
...
impl TemplateParser {
    #[allow(dead_code, reason = "preserves the checked source contract")]
    pub fn new(
        segments: js_abi::JsArray<
            crate::node_modules::tsumo::engine::src::template::parser::tokens::TemplateSegment,
        >,
        source_text: String,
        source_path: Option<String>,
    ) -> TemplateParser {
        let field_segments: js_abi::JsArray<
            crate::node_modules::tsumo::engine::src::template::parser::tokens::TemplateSegment,
        > = segments.clone();
    ...
    > {
        let result: ParseNodesResult = self.parse_nodes(
            false,
            false,
            Option::<crate::node_modules::tsumo::engine::src::template::parser::tokens::TemplateSegment>::None,
        )?;
        Ok(crate::node_modules::tsumo::engine::src::template::template_2::Template::new(
    ...
    pub fn parse_independent_nodes(
        &self,
        opening: crate::node_modules::tsumo::engine::src::template::parser::tokens::TemplateSegment,
    ...
    pub fn parse_if(
        ...
        opening: crate::node_modules::tsumo::engine::src::template::parser::tokens::TemplateSegment,
    ) -> rt::TsonicResult<crate::node_modules::tsumo::engine::src::template::nodes::IfNode> {
        ...
        if then_result.state.with(|state| state.terminator) == TemplateTerminator::End {
            return Ok(crate::node_modules::tsumo::engine::src::template::nodes::IfNode::new(
        ...
        Ok(crate::node_modules::tsumo::engine::src::template::nodes::IfNode::new(
            control.state.with(|state| state.pipeline.clone()),
            control.state.with(|state| state.binding.clone()),
            then_result.state.with(|state| state.nodes.clone()),
    ...
    pub fn parse_with(
    ...
    ) -> rt::TsonicResult<crate::node_modules::tsumo::engine::src::template::nodes::WithNode> {
        let body: ParseNodesResult = self.parse_nodes(true, true, Some(opening.clone()))?;
        let else_nodes: js_abi::JsArray<
            crate::node_modules::tsumo::engine::src::template::nodes::TemplateNode,
        ...
        Ok(crate::node_modules::tsumo::engine::src::template::nodes::WithNode::new(
            control.state.with(|state| state.pipeline.clone()),
            control.state.with(|state| state.binding.clone()),
    ...
    > {
        ...
        let else_segment: crate::node_modules::tsumo::engine::src::template::parser::tokens::TemplateSegment =
            rt::option_coalesce(
            ...
            }) == "if"
        {
            let control: ParsedControlPipeline = PARSE_CONTROL_PIPELINE
                ...
                .call((
                    crate::node_modules::tsumo::engine::src::template::parser::tokens::SLICE_TOKENS
                        .with(|module_binding| module_binding.load())
                        .call((tokens.clone(), 2))?,
                    self.state.with(|state| state.source_path.clone()),
    ...
    pub fn parse_nodes(
            ...
            )?
        {
            ...
            let segment: crate::node_modules::tsumo::engine::src::template::parser::tokens::TemplateSegment =
                match self
                    .state
            ...
            if !segment.state.with(|state| state.is_action) {
                tsonic_rust_runtime::conversions::usize_to_i32(nodes.push_many([{
                    let upcast_value =
                        crate::node_modules::tsumo::engine::src::template::nodes::TextNode::new(
            ...
            let tokens: js_abi::JsArray<String> =
                crate::node_modules::tsumo::engine::src::template::parser::tokens::TOKENIZE_TEMPLATE_ACTION
                    .with(|module_binding| module_binding.load())
                    .call((
                        segment.state.with(|state| state.text.clone()),
            ...
            if head == "break" || head == "continue" {
                ...
                tsonic_rust_runtime::conversions::usize_to_i32(
                    nodes.push_many([if head == "break" {
                        let upcast_value_2 = crate::node_modules::tsumo::engine::src::template::nodes::BreakNode::new();
                        crate::node_modules::tsumo::engine::src::template::nodes::TemplateNode {
                            identity: upcast_value_2.identity.clone(),
                            dispatch: upcast_value_2.dispatch.clone(),
                        }
                    } else {
                        let upcast_value_3 = crate::node_modules::tsumo::engine::src::template::nodes::ContinueNode::new();
                        crate::node_modules::tsumo::engine::src::template::nodes::TemplateNode {
            ...
            if head == "block" {
                ...
                tsonic_rust_runtime::conversions::usize_to_i32(
                    nodes
                        .push_many([{
                            let upcast_value_4 =
                                crate::node_modules::tsumo::engine::src::template::nodes::BlockNode::new(
                                    name.clone(),
                                    crate::node_modules::tsumo::engine::src::template::parser::parse_pipeline::PARSE_PIPELINE
                                        .with(|module_binding| module_binding.load())
                                        .call((
            ...
            if head == "range" {
                ...
                tsonic_rust_runtime::conversions::usize_to_i32(
                    nodes
                        .push_many([{
                            let upcast_value_7 =
                                crate::node_modules::tsumo::engine::src::template::nodes::RangeNode::new(
                                    crate::node_modules::tsumo::engine::src::template::parser::parse_pipeline::PARSE_PIPELINE
                                        .with(|module_binding| module_binding.load())
                                        .call((
            ...
            if head == "template" {
                ...
                tsonic_rust_runtime::conversions::usize_to_i32(
                    nodes
                        .push_many([{
                            let upcast_value_8 =
                                crate::node_modules::tsumo::engine::src::template::nodes::TemplateInvokeNode::new(
                                    name.clone(),
                                    crate::node_modules::tsumo::engine::src::template::parser::parse_pipeline::PARSE_PIPELINE
                                        .with(|module_binding| module_binding.load())
                                        .call((
                ...
                if operation == ":=" || operation == "=" {
                    tsonic_rust_runtime::conversions::usize_to_i32(
                        nodes
                            .push_many([{
                                let upcast_value_9 =
                                    crate::node_modules::tsumo::engine::src::template::nodes::AssignmentNode::new(
                                        crate::node_modules::tsumo::engine::src::utils::strings::substring_from(
                                            &head,
                                            1,
                                        )?,
            ...
            tsonic_rust_runtime::conversions::usize_to_i32(
                nodes
                    .push_many([{
                        let upcast_value_10 =
                            crate::node_modules::tsumo::engine::src::template::nodes::OutputNode::new(
                                crate::node_modules::tsumo::engine::src::template::parser::parse_pipeline::PARSE_PIPELINE
                                    .with(|module_binding| module_binding.load())
                                    .call((
                                        tokens.clone(),
...
pub fn module_init() {
        ...
        >::new(move |callable_arguments| {
            ...
            if !has_binding {
                return Ok::<_, rt::TsonicError>(ParsedControlPipeline::new(
                    ...
                    Option::<crate::node_modules::tsumo::engine::src::template::nodes::TemplateVariableBinding>::None,
                ));
            }
            if tsonic_rust_runtime::conversions::usize_to_i32(tokens.len())? < 3 {
                return Err(rt::TsonicError::from(crate::node_modules::tsumo::engine::src::diagnostics::create_tsumo_error(
            ...
            Ok::<_, rt::TsonicError>(ParsedControlPipeline::new(
                ...
                Some(crate::node_modules::tsumo::engine::src::template::nodes::TemplateVariableBinding::new(
                    crate::node_modules::tsumo::engine::src::utils::strings::substring_from(
                        &first,
                        1,
                    )?,
    ...
    };
    {
        ...
        >::new(move |callable_arguments_2| {
            ...
            TemplateParser::new(
                crate::node_modules::tsumo::engine::src::template::parser::tokens::SCAN_TEMPLATE_SEGMENTS
                    .with(|module_binding| module_binding.load())
