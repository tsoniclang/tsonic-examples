...
pub(crate) struct LoadedDocsConfigState {
    ...
    pub(crate) config: crate::node_modules::tsumo::engine::src::docs::models::DocsSiteConfig,
}
...
impl LoadedDocsConfig {
    pub fn new(
        path: String,
        config: crate::node_modules::tsumo::engine::src::docs::models::DocsSiteConfig,
    ) -> LoadedDocsConfig {
        let field_path: String = path.clone();
        let field_config: crate::node_modules::tsumo::engine::src::docs::models::DocsSiteConfig =
            config.clone();
        LoadedDocsConfig {
...
type ParseMountCallable =
    rt::Callable<
        ...
        rt::TsonicResult<crate::node_modules::tsumo::engine::src::docs::models::DocsMountConfig>,
    >;
...
pub fn module_init() {
    ...
    };
    {
        ...
        >::new(move |callable_arguments_3| {
            ...
            let value: Option<crate::node_modules::tsumo::engine::src::utils::json::JsonValue> = {
            ...
            rt::Callable::<(String,), rt::TsonicResult<String>>::new(move |callable_arguments_7| {
                ...
                Ok::<_, rt::TsonicError>(
                    crate::node_modules::tsumo::engine::src::utils::text::ensure_trailing_slash(
                        crate::node_modules::tsumo::engine::src::utils::text::ensure_leading_slash(
                            &js_string::trim(&raw),
                        ),
                    ),
                )
    ...
    None => unreachable!("checked flow selected a missing optional value"),
            ...
            Ok::<_, rt::TsonicError>(crate::node_modules::tsumo::engine::src::docs::models::DocsMountConfig::new(
                name.clone(),
                source_dir.clone(),
                url_prefix.clone(),
                repo_url.clone(),
    ...
    };
    {
        ...
        >::new(move |callable_arguments_11| {
            ...
            let parsed_root: Option<
                crate::node_modules::tsumo::engine::src::utils::json::JsonObject,
            > = crate::node_modules::tsumo::engine::src::utils::json::JSON_OBJECT
                .with(|module_binding| module_binding.load())
                .call((Some(
            ...
            let config: crate::node_modules::tsumo::engine::src::docs::models::DocsSiteConfig =
                crate::node_modules::tsumo::engine::src::docs::models::DocsSiteConfig::new(
                    mounts.clone(),
                    rt::option_coalesce(
                        OPTIONAL_BOOL
                            .with(|module_binding| module_binding.load())
