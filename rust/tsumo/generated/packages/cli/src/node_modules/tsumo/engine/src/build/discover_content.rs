...
pub(crate) fn create_page_file(
    ...
    file_name: String,
    file_path: String,
) -> rt::TsonicResult<crate::node_modules::tsumo::engine::src::models::page_file::PageFile> {
    Ok(crate::node_modules::tsumo::engine::src::models::page_file::PageFile::new(
        ...
        crate::node_modules::tsumo::engine::src::build::site_routes::without_markdown_extension(
            file_name.clone(),
        )?,
    ))
}
...
pub(crate) fn compare_content_pages(
    left: crate::node_modules::tsumo::engine::src::build::content_model::ContentPageSource,
    right: crate::node_modules::tsumo::engine::src::build::content_model::ContentPageSource,
) -> rt::TsonicResult<f64> {
    ...
    let route: i32 = crate::node_modules::tsumo::engine::src::utils::strings::compare_text(
...
> {
    ...
    let outputs: js_abi::JsMap<String, String> = js_abi::JsMap::new();
    {
        ...
        'loop_value: while file_index < (tsonic_rust_runtime::conversions::usize_to_i32(files.len())? as f64) {
            ...
            let relative_path: String =
                crate::node_modules::tsumo::engine::src::build::site_routes::normalize_site_path(
                ...
                )?;
            {
                ...
                {
                    crate::node_modules::tsumo::engine::src::build::site_routes::assert_site_route_segment(
            ...
            let file: crate::node_modules::tsumo::engine::src::models::page_file::PageFile =
            ...
            if is_branch_index_file(&file_name) {
                ...
                assert_unique_output(
                    outputs.clone(),
                    crate::node_modules::tsumo::engine::src::build::site_routes::site_output_path(
                        directory_segments.clone(),
                    )?,
                    file_path.clone(),
                )?;
                list_pages_by_route.set(
                    directory.clone(),
                    crate::node_modules::tsumo::engine::src::build::content_model::ListPageSource::new(
    ...
    None => unreachable!("checked flow selected a missing optional value"),
            ...
            let page: crate::node_modules::tsumo::engine::src::build::content_model::ContentPageSource =
    ...
    Ok(crate::node_modules::tsumo::engine::src::build::content_model::ContentInventory::new(
        pages.clone(),
