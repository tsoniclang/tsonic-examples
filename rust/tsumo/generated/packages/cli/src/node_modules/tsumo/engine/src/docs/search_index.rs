...
pub fn module_init() {
    {
        let module_value =
            rt::Callable::<(String,), rt::TsonicResult<String>>::new(move |callable_arguments| {
                ...
                value = crate::node_modules::tsumo::engine::src::utils::strings::replace_text(
                    &value,
                    String::from("\\"),
                    String::from("\\\\"),
                )?;
    ...
    };
    {
        ...
        >::new(move |callable_arguments_2| {
            ...
            let url: i32 = crate::node_modules::tsumo::engine::src::utils::strings::compare_text(
            ...
            let mount: i32 = crate::node_modules::tsumo::engine::src::utils::strings::compare_text(
