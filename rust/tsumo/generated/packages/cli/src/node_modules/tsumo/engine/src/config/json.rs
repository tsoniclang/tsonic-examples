...
pub(crate) fn invalid_field(
    field: String,
    expected: String,
    value: crate::node_modules::tsumo::engine::src::utils::json::JsonValue,
    source_path: Option<String>,
) -> crate::node_modules::tsumo::engine::src::diagnostics::TsumoError {
    crate::node_modules::tsumo::engine::src::diagnostics::create_tsumo_error(
...
pub(crate) fn require_int(
    ...
    if value
        ...
        .is_some()
    {
        let narrowed: Option<i32> =
            crate::node_modules::tsumo::engine::src::utils::int32::to_int32({
                let dispatch_receiver = &{
                    let downcast_value = &value;
                    crate::node_modules::tsumo::engine::src::utils::json::JsonNumber {
                        identity: downcast_value.identity.clone(),
                        dispatch: downcast_value
                            .dispatch
                            .clone()
...
pub(crate) fn require_object(
    ...
    value: crate::node_modules::tsumo::engine::src::utils::json::JsonValue,
    source_path: Option<String>,
) -> rt::TsonicResult<crate::node_modules::tsumo::engine::src::utils::json::JsonObject> {
    if value
        .dispatch
        .clone()
...
pub(crate) fn require_array(
    ...
    value: crate::node_modules::tsumo::engine::src::utils::json::JsonValue,
    source_path: Option<String>,
) -> rt::TsonicResult<crate::node_modules::tsumo::engine::src::utils::json::JsonArray> {
    if value
        .dispatch
        .clone()
...
pub(crate) fn assert_unique_fields(
    object: crate::node_modules::tsumo::engine::src::utils::json::JsonObject,
    context: String,
    source_path: Option<String>,
) -> rt::TsonicResult<()> {
    let names: js_abi::JsSet<String> = js_abi::JsSet::new();
    {
        ...
        {
            let property: crate::node_modules::tsumo::engine::src::utils::json::JsonProperty =
                match {
...
pub(crate) fn to_param(
        ...
        .is_some()
    {
        return Ok(crate::node_modules::tsumo::engine::src::params::ParamValue::bool({
            let dispatch_receiver_2 = &{
                ...
                crate::node_modules::tsumo::engine::src::utils::json::JsonBool {
    ...
    if value
        ...
        .is_some()
    {
        return Ok(crate::node_modules::tsumo::engine::src::params::ParamValue::number(require_int(
            field.clone(),
            value.clone(),
            source_path.clone(),
        )?));
...
pub(crate) fn apply_language_field(
    builder: crate::node_modules::tsumo::engine::src::config::builders::LanguageConfigBuilder,
    field: String,
    value: crate::node_modules::tsumo::engine::src::utils::json::JsonValue,
    source_path: Option<String>,
) -> rt::TsonicResult<()> {
...
pub(crate) fn apply_menu_field(
    builder: crate::node_modules::tsumo::engine::src::config::builders::MenuEntryBuilder,
    field: String,
    value: crate::node_modules::tsumo::engine::src::utils::json::JsonValue,
    source_path: Option<String>,
) -> rt::TsonicResult<()> {
...
pub fn parse_json_config(
    text: String,
    source_path: Option<String>,
) -> rt::TsonicResult<crate::node_modules::tsumo::engine::src::models::site_config::SiteConfig> {
    let root_value: crate::node_modules::tsumo::engine::src::utils::json::JsonValue =
        crate::node_modules::tsumo::engine::src::utils::json::PARSE_JSON
            .with(|module_binding| module_binding.load())
            .call((text.clone(), source_path.clone()))?;
    let root: crate::node_modules::tsumo::engine::src::utils::json::JsonObject = require_object(
        String::from("<root>"),
        root_value.clone(),
        source_path.clone(),
    )?;
    ...
    let params: js_abi::JsMap<String, crate::node_modules::tsumo::engine::src::params::ParamValue> =
        js_abi::JsMap::new();
    let languages: js_abi::JsArray<
        crate::node_modules::tsumo::engine::src::models::language::LanguageConfig,
    > = js_abi::JsArray::from_dense(vec![]);
    let menus: js_abi::JsMap<
        String,
                        ...
                        if key == "contentdir" {
                            ...
                            if key == "theme" {
                                ...
                                if key == "copyright" {
                                    ...
                                    if key == "params" {
                                        let object: crate::node_modules::tsumo::engine::src::utils::json::JsonObject =
                                            require_object(
                                                property.state.with(|state| state.key.clone()),
                                                value.clone(),
                                                source_path.clone(),
                                        ...
                                        )?;
                                        {
                                            ...
                                            {
                                                let parameter: crate::node_modules::tsumo::engine::src::utils::json::JsonProperty =
                                                    match {
                                        ...
                                        if key == "languages" {
                                            ...
                                            )?;
                                            {
                                                ...
                                                {
                                                    let language: crate::node_modules::tsumo::engine::src::utils::json::JsonProperty =
                                                        match {
                                                    ...
                                                    let fields: crate::node_modules::tsumo::engine::src::utils::json::JsonObject =
                                                        require_object(
                                                            language
                                                                .state
                                                                .with(|state| state.key.clone()),
                                                    ...
                                                    let builder: crate::node_modules::tsumo::engine::src::config::builders::LanguageConfigBuilder =
                                                        crate::node_modules::tsumo::engine::src::config::builders::LanguageConfigBuilder::new(
                                                            language
                                                                .state
                                                                .with(|state| state.key.clone()),
                                                            None,
                                                        );
                                                    {
                                                        ...
                                                        {
                                                            let field: crate::node_modules::tsumo::engine::src::utils::json::JsonProperty =
                                                                match {
                                            ...
                                            if key == "menu" {
                                                ...
                                                )?;
                                                {
                                                    ...
                                                    {
                                                        let menu: crate::node_modules::tsumo::engine::src::utils::json::JsonProperty =
                                                            match {
                                                        ...
                                                        let menu_items: crate::node_modules::tsumo::engine::src::utils::json::JsonArray =
                                                            require_array(
                                                                menu
                                                                    .state
                                                                    .with(|state| state.key.clone()),
                                                        ...
                                                        > = js_abi::JsArray::from_dense(vec![]);
                                                        {
                                                            ...
                                                            {
                                                                let entry_value: crate::node_modules::tsumo::engine::src::utils::json::JsonValue =
                                                                    match {
                                                                ...
                                                                let builder: crate::node_modules::tsumo::engine::src::config::builders::MenuEntryBuilder =
                                                                    crate::node_modules::tsumo::engine::src::config::builders::MenuEntryBuilder::new(
                                                                        menu.state.with(|state| {
                                                                            state.key.clone()
                                                                        }),
                                                                    );
    ...
    if tsonic_rust_runtime::conversions::usize_to_i32(languages.len())? > 0 {
        {
            ...
            let value_5 = crate::node_modules::tsumo::engine::src::config::helpers::sort_languages(
                languages.clone(),
            )?;
            receiver_4.state.with_mut(|state| state.languages = value_5)
        };
        let selected: crate::node_modules::tsumo::engine::src::models::language::LanguageConfig =
            match config
                .state
