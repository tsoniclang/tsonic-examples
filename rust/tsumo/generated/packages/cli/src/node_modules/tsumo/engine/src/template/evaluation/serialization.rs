...
pub fn get_path_extension(path: String) -> rt::TsonicResult<String> {
    ...
    crate::node_modules::tsumo::engine::src::utils::strings::substring_from(&path, last_dot)
}
        ...
        .is_some()
    {
        return to_json_string({
            let dispatch_receiver_4 = &{
                ...
                crate::node_modules::tsumo::engine::src::template::values::date::DateValue {
...
pub fn parse_url(
    value: String,
) -> rt::TsonicResult<crate::node_modules::tsumo::engine::src::template::values::url::ParsedUrl> {
    ...
    crate::node_modules::tsumo::engine::src::template::values::url::ParsedUrl::new(
        trimmed.clone(),
...
pub fn trim_end_character(value: String, ch: String) -> rt::TsonicResult<String> {
    ...
    crate::node_modules::tsumo::engine::src::utils::strings::substring_count(value.clone(), 0, end)
}
