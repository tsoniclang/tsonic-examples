...
pub(crate) struct TestTemplateEnvironmentRoot {
    ...
    state: rt::ObjectState<TestTemplateEnvironmentState>,
}
...
impl TestTemplateEnvironmentRoot {
    ...
    fn exact_template_environment_register_deferred_template(
        ...
        if request.is_none() {
            request = Some(
                tsumo_engine::template::environment::DeferredTemplateRequest::new(
                    value.clone(),
                    body,
                    definitions,
                    source_path.clone(),
        ...
        );
        {
            ...
            operation_input_0.push_many_discard([
                tsumo_engine::template::environment::DeferredTemplatePlacement::new(
                    token.clone(),
            ...
            )?;
        {
            ...
            while index < (rt::conversions::usize_to_i32(candidates.len())? as f64) {
                ...
                if definition.is_some() {
                    return Ok(Some(
                        tsumo_engine::template::environment::PartialTemplateResolution::new(
    ...
    ) -> Result<(), tsumo_engine::program::TsonicError> {
        let project_this = tsumo_engine::testing::TemplateEnvironment {
            identity: self.identity.clone(),
            dispatch: self.clone(),
        };
    ...
    for TestTemplateEnvironmentRoot
{
    ...
    fn dispatch_template_environment_source_file_exists(
        ...
        TestTemplateEnvironmentRoot::exact_test_template_environment_source_file_exists(self, _path)
    }
