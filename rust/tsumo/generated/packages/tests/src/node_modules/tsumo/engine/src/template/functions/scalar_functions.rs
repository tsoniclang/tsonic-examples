...
pub(crate) fn require_substring_integer(
    ...
    let result: Option<i32> = crate::node_modules::tsumo::engine::src::utils::int32::parse_int32(
        &crate::node_modules::tsumo::engine::src::template::runtime_helpers::TO_PLAIN_STRING
...
pub(crate) fn format_template_value(
    ...
    if verb == "q" {
        return crate::node_modules::tsumo::engine::src::template::evaluation::serialization::to_json(
            {
                let upcast_value =
...
pub fn call_scalar_function(
    ...
    args: js_abi::JsArray<
        crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue,
    >,
    context: crate::node_modules::tsumo::engine::src::template::functions::function_context::TemplateFunctionContext,
) -> rt::TsonicResult<
...
> {
    ...
    if name == "reflect.ismap" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1 {
        return Ok(
            Some({
                let upcast_value =
                    crate::node_modules::tsumo::engine::src::template::values::primitives::BoolValue::new(
                        crate::node_modules::tsumo::engine::src::template::runtime_helpers::IS_TEMPLATE_MAP
                            .with(|module_binding| module_binding.load())
    ...
    if name == "reflect.isslice" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1
    {
        return Ok(
            Some({
                let upcast_value_2 =
                    crate::node_modules::tsumo::engine::src::template::values::primitives::BoolValue::new(
                        crate::node_modules::tsumo::engine::src::template::runtime_helpers::IS_TEMPLATE_SLICE
                            .with(|module_binding| module_binding.load())
                            .call((match args.get_number(0.0).as_ref() {
    ...
    if name == "add" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 2 {
        let mut sum: i32 = 0;
        {
            ...
            while i < (tsonic_rust_runtime::conversions::usize_to_i32(args.len())? as f64) {
                let v: crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue =
                ...
                sum += rt::option_coalesce(
                    crate::node_modules::tsumo::engine::src::utils::int32::parse_int32(&s)?,
        ...
        return Ok(
            Some({
                let upcast_value_3 =
                    crate::node_modules::tsumo::engine::src::template::values::primitives::NumberValue::new(
                        sum,
                    );
                crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue {
    ...
    if name == "sub" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 2 {
        let a: i32 = crate::node_modules::tsumo::engine::src::template::runtime_helpers::TO_NUMBER
            .with(|module_binding| module_binding.load())
            .call((match args.get_number(0.0).as_ref() {
                Some(flow_value_4) => flow_value_4.clone(),
                None => unreachable!("checked flow selected a missing optional value"),
            },))?;
        let b: i32 = crate::node_modules::tsumo::engine::src::template::runtime_helpers::TO_NUMBER
            .with(|module_binding| module_binding.load())
        ...
        .is_some()
    {
        return Ok(Some({
            let upcast_value_8 = {
                ...
                crate::node_modules::tsumo::engine::src::template::values::primitives::NumberValue {
        ...
        && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1
    {
        let mut selected: i32 =
            crate::node_modules::tsumo::engine::src::template::runtime_helpers::TO_NUMBER
                .with(|module_binding| module_binding.load())
                .call((match args.get_number(0.0).as_ref() {
    ...
    if name == "int" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? == 1 {
        let value: crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue =
            match args.get_number(0.0).as_ref() {
        ...
        let parsed: Option<i32> =
            crate::node_modules::tsumo::engine::src::utils::int32::parse_int32(
                &crate::node_modules::tsumo::engine::src::template::runtime_helpers::TO_PLAIN_STRING
                    .with(|module_binding| module_binding.load())
                    .call((value.clone(),))?,
            )?;
    ...
    if name == "newscratch" {
        return Ok(
            Some({
                let upcast_value_14 =
                    crate::node_modules::tsumo::engine::src::template::values::scratch::ScratchValue::new(
                        crate::node_modules::tsumo::engine::src::template::values::scratch::ScratchStore::new(),
                    );
                crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue {
    ...
    if name == "encoding.jsonify" || name == "jsonify" {
        let v: crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue =
            if tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1 {
                ...
                crate::node_modules::tsumo::engine::src::template::runtime_helpers::NIL
                    .with(|module_binding| module_binding.load())
            };
        return Ok(
            Some({
                let upcast_value_15 =
                    crate::node_modules::tsumo::engine::src::template::values::primitives::StringValue::new(
                        crate::node_modules::tsumo::engine::src::template::evaluation::serialization::to_json(
                            v.clone(),
                        )?,
                    );
                crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue {
    ...
    if name == "urls.parse" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1 {
        ...
        return Ok(
            Some({
                let upcast_value_18 =
                    crate::node_modules::tsumo::engine::src::template::values::url::UrlValue::new(
                        crate::node_modules::tsumo::engine::src::template::evaluation::serialization::parse_url(
                            s.clone(),
                        )?,
                    );
                crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue {
    ...
    if name == "urls.joinpath" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1 {
        let parts: js_abi::JsArray<String> = js_abi::JsArray::from_dense(vec![]);
        {
            ...
            while i < (tsonic_rust_runtime::conversions::usize_to_i32(args.len())? as f64) {
                tsonic_rust_runtime::conversions::usize_to_i32(
                    parts
                        .push_many([crate::node_modules::tsumo::engine::src::template::runtime_helpers::TO_PLAIN_STRING
                            .with(|module_binding| module_binding.load())
        ...
        let mut out: String = String::from("");
        {
            ...
            while i < (tsonic_rust_runtime::conversions::usize_to_i32(arr.len())? as f64) {
                ...
                out = if out.is_empty() {
                    crate::node_modules::tsumo::engine::src::template::evaluation::serialization::trim_slashes(
                        p.clone(),
                    )?
                } else {
                    format!(
                        "{}{}{}",
                        crate::node_modules::tsumo::engine::src::template::evaluation::serialization::trim_end_character(
                            out.clone(),
                            String::from("/"),
                        )?,
                        String::from("/"),
                        crate::node_modules::tsumo::engine::src::template::evaluation::serialization::trim_start_character(
                            p.clone(),
                            String::from("/"),
                        )?,
                    )
        ...
        && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 2
    {
        ...
        return Ok(
            Some({
                let upcast_value_20 =
                    crate::node_modules::tsumo::engine::src::template::values::primitives::BoolValue::new(js_string::includes_from_start(
                        &s, &sub,
                    ));
                crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue {
        ...
        && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 2
    {
        ...
        return Ok(
            Some({
                let upcast_value_22 =
                    crate::node_modules::tsumo::engine::src::template::values::primitives::BoolValue::new(js_string::starts_with_from_start(
                        &s, &prefix,
                    ));
                crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue {
        ...
        && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 2
    {
        ...
        return Ok(
            Some({
                let upcast_value_23 =
                    crate::node_modules::tsumo::engine::src::template::values::primitives::BoolValue::new(js_string::ends_with_at_end(
                        &s, &suffix,
                    ));
                crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue {
                ...
                let upcast_value_24 =
                    crate::node_modules::tsumo::engine::src::template::values::primitives::StringValue::new(
                        if js_string::starts_with_from_start(&s, &prefix) {
                            crate::node_modules::tsumo::engine::src::utils::strings::substring_from(
                                &s,
    ...
    if name == "strings.trim" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 2 {
        ...
        return Ok(
            Some({
                let upcast_value_26 =
                    crate::node_modules::tsumo::engine::src::template::values::primitives::StringValue::new(
                        crate::node_modules::tsumo::engine::src::utils::strings::trim_code_points(
                            value.clone(),
                            cutset.clone(),
                        )?,
                    );
        ...
        && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 2
    {
        return Ok(
            Some({
                let upcast_value_27 =
                    crate::node_modules::tsumo::engine::src::template::values::primitives::StringValue::new(
                        crate::node_modules::tsumo::engine::src::utils::strings::trim_start_code_points(
                            crate::node_modules::tsumo::engine::src::template::runtime_helpers::TO_PLAIN_STRING
                                .with(|module_binding| module_binding.load())
                                .call((match args.get_number(1.0).as_ref() {
        ...
        && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 2
    {
        return Ok(
            Some({
                let upcast_value_28 =
                    crate::node_modules::tsumo::engine::src::template::values::primitives::StringValue::new(
                        crate::node_modules::tsumo::engine::src::utils::strings::trim_end_code_points(
                            crate::node_modules::tsumo::engine::src::template::runtime_helpers::TO_PLAIN_STRING
                                .with(|module_binding| module_binding.load())
                                .call((match args.get_number(1.0).as_ref() {
        ...
        && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1
    {
        return Ok(
            Some({
                let upcast_value_29 =
                    crate::node_modules::tsumo::engine::src::template::values::primitives::StringValue::new(
                        crate::node_modules::tsumo::engine::src::utils::strings::trim_unicode_space(
                            crate::node_modules::tsumo::engine::src::template::runtime_helpers::TO_PLAIN_STRING
                                .with(|module_binding| module_binding.load())
                                .call((match args.get_number(0.0).as_ref() {
            ...
            || tsonic_rust_runtime::conversions::usize_to_i32(args.len())? == 3)
    {
        ...
        let source_length: i32 =
            crate::node_modules::tsumo::engine::src::utils::strings::code_point_length(
                source.clone(),
            )?;
        if source_length == 0 {
            return Ok(
        ...
        return Ok(
            Some({
                let upcast_value_34 =
                    crate::node_modules::tsumo::engine::src::template::values::primitives::StringValue::new(
                        crate::node_modules::tsumo::engine::src::utils::strings::substring_code_points(
                            source.clone(),
                            start,
                            end - start,
                        )?,
    ...
    if name == "urlize" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1 {
        ...
        return Ok(
            Some({
                let upcast_value_35 =
                    crate::node_modules::tsumo::engine::src::template::values::primitives::StringValue::new(
                        crate::node_modules::tsumo::engine::src::utils::text::slugify(
                            &crate::node_modules::tsumo::engine::src::template::runtime_helpers::TO_PLAIN_STRING
                                .with(|module_binding| module_binding.load())
                                .call((v.clone(),))?,
                        )?,
    ...
    if name == "anchorize" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1 {
        return Ok(
            Some({
                let upcast_value_36 =
                    crate::node_modules::tsumo::engine::src::template::values::primitives::StringValue::new(
                        crate::node_modules::tsumo::engine::src::template::functions::text_compatibility::ANCHORIZE_TEXT
                            .with(|module_binding| module_binding.load())
                            .call((crate::node_modules::tsumo::engine::src::template::runtime_helpers::TO_PLAIN_STRING
                                .with(|module_binding| module_binding.load())
                                .call((match args.get_number(0.0).as_ref() {
    ...
    if name == "emojify" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1 {
        return Ok(
            Some({
                let upcast_value_37 =
                    crate::node_modules::tsumo::engine::src::template::values::primitives::HtmlValue::new(
                        crate::node_modules::tsumo::engine::src::utils::html::HtmlString::new(
                            crate::node_modules::tsumo::engine::src::template::functions::text_compatibility::EMOJIFY_TEXT
                                .with(|module_binding| module_binding.load())
                                .call((crate::node_modules::tsumo::engine::src::template::runtime_helpers::TO_PLAIN_STRING
                                    .with(|module_binding| module_binding.load())
                                    .call((match args.get_number(0.0).as_ref() {
    ...
    if name == "humanize" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1 {
        ...
        return Ok(
            Some({
                let upcast_value_38 =
                    crate::node_modules::tsumo::engine::src::template::values::primitives::StringValue::new(
                        crate::node_modules::tsumo::engine::src::utils::text::humanize_slug(
                            crate::node_modules::tsumo::engine::src::template::runtime_helpers::TO_PLAIN_STRING
                                .with(|module_binding| module_binding.load())
                                .call((v.clone(),))?,
                        )?,
    ...
    if name == "chomp" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1 {
        ...
        {
            value = crate::node_modules::tsumo::engine::src::utils::strings::substring_count(
                value.clone(),
                0,
    ...
    if name == "replacere" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 3 {
        ...
        return Ok(
            Some({
                let upcast_value_44 =
                    crate::node_modules::tsumo::engine::src::template::values::primitives::StringValue::new(
                        crate::node_modules::tsumo::engine::src::utils::regular_expressions::replace_regular_expression(
                            pattern.clone(),
                            replacement.clone(),
                            s.clone(),
                            limit,
    ...
    if name == "findre" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 2 {
        ...
        return Ok(
            Some({
                let upcast_value_45 =
                    crate::node_modules::tsumo::engine::src::template::values::arrays::StringArrayValue::new(
                        crate::node_modules::tsumo::engine::src::utils::regular_expressions::find_regular_expression_matches(
                            pattern.clone(),
                            input.clone(),
                            limit,
                        )?,
    ...
    if name == "findresubmatch" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 2
    {
        ...
        let matches: js_abi::JsArray<js_abi::JsArray<String>> =
            crate::node_modules::tsumo::engine::src::utils::regular_expressions::find_regular_expression_submatches(
                pattern.clone(),
                input.clone(),
                limit,
            )?;
        let result: js_abi::JsArray<
            crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue,
        ...
        return Ok(
            Some({
                let upcast_value_47 =
                    crate::node_modules::tsumo::engine::src::template::values::arrays::AnyArrayValue::new(
                        result.clone(),
                    );
                crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue {
    ...
    if name == "truncate" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 2 {
        ...
        return Ok(
            Some({
                let upcast_value_50 =
                    crate::node_modules::tsumo::engine::src::template::values::primitives::StringValue::new(format!(
                        "{}{}",
                        crate::node_modules::tsumo::engine::src::utils::strings::substring_count(
                            s.clone(),
                            0,
    ...
    if name == "markdownify" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1 {
        ...
        let md: crate::node_modules::tsumo::engine::src::markdown::result::MarkdownResult =
            crate::node_modules::tsumo::engine::src::markdown::render_basic::render_markdown(
                s.clone(),
            )?;
        ...
        {
            html = crate::node_modules::tsumo::engine::src::utils::strings::substring_count(
                html.clone(),
                3,
    ...
    if name == "absurl" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1 {
        ...
        let rel: String = if js_string::starts_with_from_start(&s, "/") {
            crate::node_modules::tsumo::engine::src::utils::strings::substring_from(&s, 1)?
        } else {
            s.clone()
        };
        return Ok(
            Some({
                let upcast_value_53 =
                    crate::node_modules::tsumo::engine::src::template::values::primitives::StringValue::new(format!(
                        "{}{}",
                        crate::node_modules::tsumo::engine::src::utils::text::ensure_trailing_slash(
                            scope
                                .state
    ...
    if name == "default" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? == 2 {
        let fallback: crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue =
            match args.get_number(0.0).as_ref() {
        ...
        return Ok(
            if crate::node_modules::tsumo::engine::src::template::runtime_helpers::IS_DEFAULT_SET
                .with(|module_binding| module_binding.load())
                .call((v.clone(),))?
            {
                Some(v.clone())
                ...
                js_string::js_len(
                    &{
                        let dispatch_receiver = &{
                            ...
                            crate::node_modules::tsumo::engine::src::template::values::primitives::StringValue {
                ...
                js_string::js_len(
                    &{
                        let dispatch_receiver_2 = &{
                            ...
                            crate::node_modules::tsumo::engine::src::template::values::primitives::HtmlValue {
            ...
            let l: i32 = tsonic_rust_runtime::conversions::usize_to_i32(
                {
                    let dispatch_receiver_3 = &{
                        ...
                        crate::node_modules::tsumo::engine::src::template::values::page::PageArrayValue {
            ...
            let l: i32 = tsonic_rust_runtime::conversions::usize_to_i32(
                {
                    let dispatch_receiver_4 = &{
                        ...
                        crate::node_modules::tsumo::engine::src::template::values::arrays::StringArrayValue {
            ...
            let l: i32 = tsonic_rust_runtime::conversions::usize_to_i32(
                {
                    let dispatch_receiver_5 = &{
                        ...
                        crate::node_modules::tsumo::engine::src::template::values::site::SitesArrayValue {
            ...
            let l: i32 = tsonic_rust_runtime::conversions::usize_to_i32(
                {
                    let dispatch_receiver_6 = &{
                        ...
                        crate::node_modules::tsumo::engine::src::template::values::docs::DocsMountArrayValue {
            ...
            let l: i32 = tsonic_rust_runtime::conversions::usize_to_i32(
                {
                    let dispatch_receiver_7 = &{
                        ...
                        crate::node_modules::tsumo::engine::src::template::values::docs::NavArrayValue {
                            ...
                            tsonic_rust_runtime::conversions::usize_to_i32(
                                {
                                    let dispatch_receiver_9 = &{
                                        ...
                                        crate::node_modules::tsumo::engine::src::template::values::arrays::AnyArrayValue {
    ...
    if name == "dateformat" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 2 {
        ...
        return Ok(
            Some({
                let upcast_value_68 =
                    crate::node_modules::tsumo::engine::src::template::values::primitives::StringValue::new(rt::option_coalesce(
                        crate::node_modules::tsumo::engine::src::template::evaluation::scalar_semantics::FORMAT_DATE_TIME
                            .with(|module_binding| module_binding.load())
    ...
    if name == "print" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1 {
        let sb: crate::node_modules::tsumo::engine::src::utils::text_builder::TextBuilder =
    ...
    if tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 2 {
        let is_compare: bool = name == "eq"
            ...
            || name == "ge";
        if is_compare {
            let a: crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue =
                match args.get_number(0.0).as_ref() {
                    Some(flow_value_91) => flow_value_91.clone(),
                    None => unreachable!("checked flow selected a missing optional value"),
                };
            let b: crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue =
                match args.get_number(1.0).as_ref() {
                    ...
                    .is_some()
            {
                ...
                cmp = tsonic_rust_runtime::conversions::i32_to_f64(
                    crate::node_modules::tsumo::engine::src::template::values::version::VersionStringValue::compare(
                        av.clone(),
                        bv.clone(),
                    )?,
                );
    ...
    if name == "not" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1 {
        return Ok(
            Some({
                let upcast_value_77 =
                    crate::node_modules::tsumo::engine::src::template::values::primitives::BoolValue::new(
                        !crate::node_modules::tsumo::engine::src::template::runtime_helpers::IS_TRUTHY
                            .with(|module_binding| module_binding.load())
                            .call((match args.get_number(0.0).as_ref() {
    ...
    if name == "and" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1 {
        let mut cur: crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue =
            match args.get_number(0.0).as_ref() {
    ...
    None => unreachable!("checked flow selected a missing optional value"),
                ...
                if !crate::node_modules::tsumo::engine::src::template::runtime_helpers::IS_TRUTHY
                    .with(|module_binding| module_binding.load())
                    .call((cur.clone(),))?
                {
    ...
    if name == "or" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1 {
        {
            let mut i: f64 = 0.0;
            while i < (tsonic_rust_runtime::conversions::usize_to_i32(args.len())? as f64) {
                let cur: crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue =
                    match args.get_number(i).as_ref() {
