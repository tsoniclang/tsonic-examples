...
pub(crate) fn menu_entry_identity(
    entry: crate::node_modules::tsumo::engine::src::models::menu_entry::MenuEntry,
) -> String {
...
pub(crate) fn compare_menu_entries(
    left: crate::node_modules::tsumo::engine::src::models::menu_entry::MenuEntry,
    right: crate::node_modules::tsumo::engine::src::models::menu_entry::MenuEntry,
) -> f64 {
    ...
    let identity: i32 = crate::node_modules::tsumo::engine::src::utils::strings::compare_text(
    ...
    let name: i32 = crate::node_modules::tsumo::engine::src::utils::strings::compare_text(
...
pub(crate) fn assert_acyclic_parents(
...
) -> rt::TsonicResult<()> {
    {
        ...
        while index < (tsonic_rust_runtime::conversions::usize_to_i32(entries.len())? as f64) {
            ...
            let mut current: crate::node_modules::tsumo::engine::src::models::menu_entry::MenuEntry =
                match entries.get_number(index).as_ref() {
                    Some(flow_value) => flow_value.clone(),
                    None => unreachable!("checked flow selected a missing optional value"),
                };
            while !js_string::trim(&current.state.with(|state| state.parent.clone())).is_empty() {
                ...
                let parent: Option<
                    crate::node_modules::tsumo::engine::src::models::menu_entry::MenuEntry,
                > = by_identity.get(&js_string::trim(
                    &current.state.with(|state| state.parent.clone()),
                ));
                if parent.is_none() {
                    return Err(rt::TsonicError::from(crate::node_modules::tsumo::engine::src::diagnostics::create_tsumo_error(
...
pub(crate) fn append_flat_menu_entries(
...
) -> rt::TsonicResult<()> {
    {
        ...
        while index < (tsonic_rust_runtime::conversions::usize_to_i32(entries.len())? as f64) {
            ...
            let clone: crate::node_modules::tsumo::engine::src::models::menu_entry::MenuEntry =
