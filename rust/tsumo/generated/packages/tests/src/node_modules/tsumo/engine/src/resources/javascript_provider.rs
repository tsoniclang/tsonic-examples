...
pub fn module_init() {
        ...
        >::new(move |callable_arguments| {
            ...
            let extension: String = js_string::to_lower_case(
                &crate::node_modules::tsumo::engine::src::resources::paths::SPLIT_RESOURCE_FILE_NAME
                    ...
                    .call((crate::node_modules::tsumo::engine::src::resources::paths::SPLIT_RESOURCE_PATH
                        .with(|module_binding| module_binding.load())
                        .call((raw.clone(),))?
                        .state
    ...
    None => unreachable!("checked flow selected a missing optional value"),
            ...
            Ok::<_, rt::TsonicError>(crate::node_modules::tsumo::engine::src::resources::models::Resource::new(
                format!(
                    "{}{}{}{}{}",
                    String::from(""),
