...
pub(crate) struct DeferredTemplateRequestState {
    ...
    pub(crate) data: crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue,
    ...
    pub(crate) overrides:
        js_abi::JsMap<
            ...
            >,
        >,
    pub(crate) state: crate::node_modules::tsumo::engine::src::template::scope::RenderState,
...
impl DeferredTemplateRequest {
    ...
    pub fn new(
        ...
        let field_data: crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue =
            {
        ...
        let field_overrides: js_abi::JsMap<
            ...
            >,
        > = overrides.clone();
        let field_state: crate::node_modules::tsumo::engine::src::template::scope::RenderState =
            state.clone();
...
impl PartialTemplateResolution {
    pub fn new(
        ...
        let field_definition: Option<
            js_abi::JsArray<
                crate::node_modules::tsumo::engine::src::template::nodes::TemplateNode,
            >,
        > = definition.clone();
        let field_template: Option<
...
impl TemplateEnvironment {
    pub(crate) fn initialize_state(
        ...
        let field_site_data: crate::node_modules::tsumo::engine::src::template::values::dict::DictValue =
            rt::option_coalesce(site_data.clone(), std::convert::identity, || {
                crate::node_modules::tsumo::engine::src::template::values::dict::DictValue::new(
                    js_abi::JsMap::new(),
                )
            });
        let field_global_store: crate::node_modules::tsumo::engine::src::template::values::scratch::ScratchStore =
            ...
            )?;
        {
            ...
            while index < (tsonic_rust_runtime::conversions::usize_to_i32(candidates.len())? as f64)
            {
                ...
                if definition.is_some() {
                    return Ok(
                        Some(PartialTemplateResolution::new(
