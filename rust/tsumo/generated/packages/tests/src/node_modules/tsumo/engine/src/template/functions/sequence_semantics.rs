    ...
    .as_ref()
{
    ...
    let size: Option<i32> =
        crate::node_modules::tsumo::engine::src::utils::int32::to_int32(size_value)?;
    if size.is_none()
        || (match size.as_ref() {
    ...
    Ok(crate::node_modules::tsumo::engine::src::template::values::arrays::AnyArrayValue::new(
        values.clone(),
    ))
}

pub fn reverse_template_collection(
    collection: crate::node_modules::tsumo::engine::src::template::values::base::TemplateValue,
) -> rt::TsonicResult<
