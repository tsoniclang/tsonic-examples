...
pub(crate) trait BuildEnvironmentDispatch:
    crate::node_modules::tsumo::engine::src::layouts::LayoutEnvironmentDispatch
{
    ...
    fn read_build_environment_resources(
        &self,
...
pub(crate) struct BuildEnvironmentState {
    pub(crate) base: crate::node_modules::tsumo::engine::src::layouts::LayoutEnvironmentState,
...
impl BuildEnvironment {
    pub(crate) fn initialize_state(
        ...
        let base_state =
            crate::node_modules::tsumo::engine::src::layouts::LayoutEnvironment::initialize_state(
                site_dir.clone(),
                theme_dir.clone(),
                mounts.clone(),
                build_time.clone(),
        ...
        let field_resources: crate::node_modules::tsumo::engine::src::resources::manager::ResourceManager =
...
impl BuildEnvironmentRoot {
    ...
    fn exact_build_environment_source_file_exists(
        ...
        crate::node_modules::tsumo::engine::src::fs::FILE_EXISTS
            .with(|module_binding| module_binding.load())
            .call((crate::node_modules::tsumo::engine::src::resources::paths::RESOLVE_CONTAINED_RESOURCE_PATH
                .with(|module_binding| module_binding.load())
                .call((
                    {
                        let dispatch_receiver = &project_this;
    ...
    fn exact_layout_environment_get_i18n(
        ...
        let project_this = crate::node_modules::tsumo::engine::src::layouts::LayoutEnvironment {
            identity: self.identity.clone(),
            dispatch: self.clone(),
        };
        {
...
.as_ref()
{
    ...
    fn exact_layout_environment_render_page_view(
        ...
        let template_path: Option<String> =
            crate::node_modules::tsumo::engine::src::layouts::SELECT_TEMPLATE_PATH
                .with(|module_binding| module_binding.load())
...
impl crate::node_modules::tsumo::engine::src::template::environment::TemplateEnvironmentDispatch for BuildEnvironmentRoot {
...
impl crate::node_modules::tsumo::engine::src::layouts::LayoutEnvironmentDispatch for BuildEnvironmentRoot {
