...
pub fn concatenate_resources(
    target_path: String,
    resources: js_abi::JsArray<
        crate::node_modules::tsumo::engine::src::resources::models::Resource,
    >,
) -> rt::TsonicResult<crate::node_modules::tsumo::engine::src::resources::models::Resource> {
    let target: String =
        crate::node_modules::tsumo::engine::src::resources::paths::NORMALIZE_RESOURCE_RELATIVE_PATH
            .with(|module_binding| module_binding.load())
            .call((target_path.clone(),))?;
    let identity: crate::node_modules::tsumo::engine::src::utils::text_builder::TextBuilder =
    ...
    let text: crate::node_modules::tsumo::engine::src::utils::text_builder::TextBuilder =
        crate::node_modules::tsumo::engine::src::utils::text_builder::TextBuilder::new();
    {
    ...
    let path: crate::node_modules::tsumo::engine::src::resources::paths::ResourcePathParts =
        crate::node_modules::tsumo::engine::src::resources::paths::SPLIT_RESOURCE_PATH
            .with(|module_binding| module_binding.load())
            .call((target.clone(),))?;
    let file: crate::node_modules::tsumo::engine::src::resources::paths::ResourceFileNameParts =
        crate::node_modules::tsumo::engine::src::resources::paths::SPLIT_RESOURCE_FILE_NAME
            .with(|module_binding| module_binding.load())
            .call((path.state.with(|state| state.file_name.clone()),))?;
    Ok(crate::node_modules::tsumo::engine::src::resources::models::Resource::new(
        identity.to_string(),
        Option::<String>::None,
        true,
        Some(target.clone()),
        ...
        Some(
            crate::node_modules::tsumo::engine::src::resources::media_types::resource_media_type_for_extension(
...
pub fn minify_resource(
    resource: crate::node_modules::tsumo::engine::src::resources::models::Resource,
) -> rt::TsonicResult<crate::node_modules::tsumo::engine::src::resources::models::Resource> {
