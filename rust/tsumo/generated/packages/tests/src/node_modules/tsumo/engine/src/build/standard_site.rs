...
pub fn build_standard_site(
    ...
    let config: crate::node_modules::tsumo::engine::src::models::site_config::SiteConfig =
        crate::node_modules::tsumo::engine::src::config::loader::load_site_config(site_dir.clone())?
            .state
    ...
    let theme_dir: Option<String> =
        crate::node_modules::tsumo::engine::src::build::layout::resolve_theme_dir(
            site_dir.clone(),
            config.clone(),
            {
    ...
    let environment: crate::node_modules::tsumo::engine::src::env::BuildEnvironment =
        crate::node_modules::tsumo::engine::src::env::BuildEnvironment::new(
            site_dir.clone(),
            theme_dir.clone(),
            out_dir.clone(),
    ...
    let output_plan: crate::node_modules::tsumo::engine::src::build::output_plan::SiteOutputPlan =
    ...
    let inventory: crate::node_modules::tsumo::engine::src::build::content_model::ContentInventory =
    ...
    let page_graph: crate::node_modules::tsumo::engine::src::build::standard_page_graph::StandardPageGraph =
    ...
    crate::node_modules::tsumo::engine::src::build::render_page_content::render_standard_page_content(
        page_graph.clone(),
        environment.clone(),
    )?;
    let templates: crate::node_modules::tsumo::engine::src::build::standard_templates::StandardTemplates =
        crate::node_modules::tsumo::engine::src::build::standard_templates::SELECT_STANDARD_TEMPLATES
            .with(|module_binding| module_binding.load())
            .call((environment.clone(),))?;
    let sitemap_urls: js_abi::JsMap<String, bool> = js_abi::JsMap::new();
    crate::node_modules::tsumo::engine::src::build::plan_home_output::plan_home_output(
        page_graph.clone(),
        environment.clone(),
        templates.clone(),
        output_plan.clone(),
    ...
    crate::node_modules::tsumo::engine::src::build::plan_list_outputs::plan_list_outputs(
        page_graph.clone(),
        environment.clone(),
        templates.clone(),
        output_plan.clone(),
    ...
    crate::node_modules::tsumo::engine::src::build::plan_taxonomy_outputs::plan_taxonomy_outputs(
        taxonomies.clone(),
        environment.clone(),
        templates.clone(),
        output_plan.clone(),
    ...
    crate::node_modules::tsumo::engine::src::build::plan_content_outputs::plan_content_outputs(
        page_graph.clone(),
        environment.clone(),
        templates.clone(),
        output_plan.clone(),
    ...
    output_plan.add_default_text(
        ...
        crate::node_modules::tsumo::engine::src::outputs::render_sitemap(
            config.clone(),
    ...
    output_plan.add_default_text(
        ...
        crate::node_modules::tsumo::engine::src::outputs::render_rss(
            config.clone(),
    ...
    output_plan.add_default_text(
        ...
        crate::node_modules::tsumo::engine::src::outputs::render_robots_txt(config.clone()),
