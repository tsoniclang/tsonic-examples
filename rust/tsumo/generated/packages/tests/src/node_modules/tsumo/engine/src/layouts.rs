    ...
    crate::node_modules::tsumo::engine::src::template::environment::TemplateEnvironmentDispatch
{
    ...
    fn read_layout_environment_i18n_store(
        &self,
    ) -> crate::node_modules::tsumo::engine::src::i18n::I18nStore;
    fn write_layout_environment_i18n_store(
        &self,
        value: crate::node_modules::tsumo::engine::src::i18n::I18nStore,
    );
...
pub(crate) struct LayoutEnvironmentState {
    ...
    pub(crate) i18n_store: crate::node_modules::tsumo::engine::src::i18n::I18nStore,
}
...
impl LayoutEnvironment {
    pub(crate) fn initialize_state(
        ...
        mounts_raw: Option<
            js_abi::JsArray<
                crate::node_modules::tsumo::engine::src::models::site_config::ModuleMount,
            >,
        >,
    ...
    None => unreachable!("checked flow selected a missing optional value"),
        ...
        let field_i18n_store: crate::node_modules::tsumo::engine::src::i18n::I18nStore =
    ...
    None => unreachable!("checked flow selected a missing optional value"),
                ...
                'loop_value: while i >= 0 {
                    let mount: crate::node_modules::tsumo::engine::src::models::site_config::ModuleMount =
                        match match mounts.as_ref() {
                    ...
                    if crate::node_modules::tsumo::engine::src::fs::DIR_EXISTS
...
impl LayoutEnvironmentRoot {
    ...
    None => unreachable!("checked flow selected a missing optional value"),
        ...
        let mut resolved: Option<String> = Option::<String>::None;
        {
            ...
            'loop_value_2: while i < (tsonic_rust_runtime::conversions::usize_to_i32(candidates.len())? as f64) {
                ...
                if crate::node_modules::tsumo::engine::src::fs::FILE_EXISTS
                    .with(|module_binding| module_binding.load())
        ...
        let tpl: crate::node_modules::tsumo::engine::src::template::template_2::Template =
            crate::node_modules::tsumo::engine::src::template::parser::parse_template::PARSE_TEMPLATE
                .with(|module_binding| module_binding.load())
                .call((
                    crate::node_modules::tsumo::engine::src::fs::READ_TEXT_FILE
                        .with(|module_binding| module_binding.load())
    ...
    > {
        ...
        let rel_path: String =
            crate::node_modules::tsumo::engine::src::template::paths::normalize_template_relative_path(
                js_string::trim(
                    &crate::node_modules::tsumo::engine::src::utils::strings::trim_start_char(
                        &rel_path_raw,
                        slash.clone(),
                    )?,
                ),
            )?;
        let logical_cached: Option<
            crate::node_modules::tsumo::engine::src::template::template_2::Template,
        > = {
            let dispatch_receiver = &project_this;
            dispatch_receiver
            ...
            while i < (tsonic_rust_runtime::conversions::usize_to_i32(relative_paths.len())? as f64)
            {
                tsonic_rust_runtime::conversions::usize_to_i32(
                    candidates.push_many([tsonic_rust_node::path::join(&[
                        ...
                        .as_str(),
                        crate::node_modules::tsumo::engine::src::utils::strings::replace_text(
...
.as_ref()
{
    ...
    None => unreachable!("checked flow selected a missing optional value"),
            ...
            let embedded: crate::node_modules::tsumo::engine::src::template::template_2::Template =
                crate::node_modules::tsumo::engine::src::template::parser::parse_template::PARSE_TEMPLATE
                    .with(|module_binding| module_binding.load())
                    .call((
        ...
        let text: String = crate::node_modules::tsumo::engine::src::fs::READ_TEXT_FILE
            .with(|module_binding| module_binding.load())
            .call((match resolved.as_ref() {
    ...
    fn exact_layout_environment_render_page_view(
        ...
        let context: crate::node_modules::tsumo::engine::src::template::values::page::PageValue =
...
impl crate::node_modules::tsumo::engine::src::template::environment::TemplateEnvironmentDispatch for LayoutEnvironmentRoot {
    ...
    fn downcast_template_environment_to_test_template_environment(
        self: std::rc::Rc<Self>,
    ) -> Option<std::rc::Rc<dyn crate::template_test_harness::TestTemplateEnvironmentDispatch>> {
        None
    }
