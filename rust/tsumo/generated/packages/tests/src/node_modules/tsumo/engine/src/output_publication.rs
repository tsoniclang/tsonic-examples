...
impl OutputPublication {
    ...
    pub fn publish(&self) -> rt::TsonicResult<()> {
        ...
        if previous_output_moved
            && crate::node_modules::tsumo::engine::src::fs::DIR_EXISTS
                .with(|module_binding| module_binding.load())
...
pub fn module_init() {
    {
        ...
        >::new(move |callable_arguments| {
            ...
            if !tsonic_rust_node::path::is_absolute(&requested_destination_dir)
                && !crate::node_modules::tsumo::engine::src::utils::paths::path_contains_or_equals(
                    site_root.clone(),
            ...
            crate::node_modules::tsumo::engine::src::fs::ENSURE_DIR
                .with(|module_binding| module_binding.load())
                .call((parent.clone(),))?;
            ...
            if preserve_existing_output
                && crate::node_modules::tsumo::engine::src::fs::DIR_EXISTS
                    ...
                    .call((destination_dir.clone(),))?
            {
                crate::node_modules::tsumo::engine::src::fs::COPY_DIR_RECURSIVE
                    .with(|module_binding| module_binding.load())
