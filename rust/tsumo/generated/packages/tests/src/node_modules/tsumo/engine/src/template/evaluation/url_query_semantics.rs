...
pub(crate) fn decode_query_component(value: String) -> rt::TsonicResult<String> {
    {
        ...
        {
            if crate::node_modules::tsumo::engine::src::utils::strings::substring_count(
                value.clone(),
    ...
    let try_body: rt::TsonicResult<rt::Completion<String>> = rt::completion_region(|| {
        Ok(rt::Completion::Return(
            crate::node_modules::tsumo::engine::src::utils::url_components::decode_url_component(
...
pub fn parse_url_query(
    ...
    crate::node_modules::tsumo::engine::src::template::values::url::UrlQueryValue,
> {
    let values: js_abi::JsMap<String, js_abi::JsArray<String>> = js_abi::JsMap::new();
    if raw_query.is_empty() {
        return Ok(
            crate::node_modules::tsumo::engine::src::template::values::url::UrlQueryValue::new(
                values.clone(),
            ),
        );
    }
    ...
    Ok(crate::node_modules::tsumo::engine::src::template::values::url::UrlQueryValue::new(
        values.clone(),
    ))
}
