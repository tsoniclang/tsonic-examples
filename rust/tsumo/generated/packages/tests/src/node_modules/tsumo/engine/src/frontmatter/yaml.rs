...
pub(crate) fn split_yaml_pair(
    ...
    Ok(js_abi::JsArray::from_dense(vec![
        js_string::trim(&crate::node_modules::tsumo::engine::src::utils::strings::substring_count(
            text.clone(),
            0,
            separator,
        )?),
        js_string::trim(&crate::node_modules::tsumo::engine::src::utils::strings::substring_from(
            &text,
            separator + 1,
        )?),
    ]))
    ...
    if key == "weight" {
        {
            let receiver = &entry;
            let value =
                crate::node_modules::tsumo::engine::src::frontmatter::scalars::parse_front_matter_int(
                    value_raw.clone(),
                    key_raw.clone(),
                    crate::node_modules::tsumo::engine::src::utils::structured_scalars::StructuredScalarFormat::Yaml,
                    source_path.clone(),
        ...
        if key == "name" {
            {
                ...
                let value_2 =
                    crate::node_modules::tsumo::engine::src::frontmatter::scalars::parse_front_matter_string(
                        value_raw.clone(),
                        key_raw.clone(),
                        crate::node_modules::tsumo::engine::src::utils::structured_scalars::StructuredScalarFormat::Yaml,
                        source_path.clone(),
...
pub fn parse_yaml_front_matter(
    ...
    'loop_value: while index < tsonic_rust_runtime::conversions::usize_to_i32(lines.len())? {
        ...
        crate::node_modules::tsumo::engine::src::frontmatter::scalars::record_front_matter_field(
            root_fields.clone(),
            key.clone(),
        ...
        if !value.is_empty() {
            crate::node_modules::tsumo::engine::src::frontmatter::scalars::apply_front_matter_scalar(
                front_matter.clone(),
                &key,
                &value,
                crate::node_modules::tsumo::engine::src::utils::structured_scalars::StructuredScalarFormat::Yaml,
    ...
    None => unreachable!("checked flow selected a missing optional value"),
                    ...
                    front_matter
                        ...
                        .set(
                            ...
                            crate::node_modules::tsumo::engine::src::frontmatter::scalars::parse_front_matter_param(
        ...
        if normalized_key == "tags" || normalized_key == "categories" {
                ...
                })? > 0
            {
                ...
                if !child_text.is_empty() && !js_string::starts_with_from_start(&child_text, "#") {
                    ...
                    let item: String = js_string::trim(
