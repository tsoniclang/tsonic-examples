...
pub(crate) fn resolve_menu_page_references(
...
) -> rt::TsonicResult<()> {
    {
        ...
        while index < (tsonic_rust_runtime::conversions::usize_to_i32(entries.len())? as f64) {
            let entry: crate::node_modules::tsumo::engine::src::models::menu_entry::MenuEntry =
            ...
            if !js_string::trim(&entry.state.with(|state| state.page_ref.clone())).is_empty() {
                let page: Option<
                    crate::node_modules::tsumo::engine::src::models::page_context::PageContext,
                > = pages_by_route.get(&normalize_page_reference(
...
pub fn configure_site_menus(
    ...
    > = js_abi::JsMap::new();
    {
            ...
            < (tsonic_rust_runtime::conversions::usize_to_i32(page_sources.len())? as f64)
        {
                ...
                };
            {
                ...
                {
                    let menu: crate::node_modules::tsumo::engine::src::frontmatter::menu::FrontMatterMenu =
                        match source
                            .state
    ...
    });
    {
        ...
        while index < (tsonic_rust_runtime::conversions::usize_to_i32(menu_names.len())? as f64) {
            ...
            let combined: js_abi::JsArray<
                crate::node_modules::tsumo::engine::src::models::menu_entry::MenuEntry,
            > = if existing.is_none() {
                js_abi::JsArray::from_dense(vec![])
            } else {
                crate::node_modules::tsumo::engine::src::menus::flatten_menu_entries(
    ...
    let pages_by_route: js_abi::JsMap<
        String,
        crate::node_modules::tsumo::engine::src::models::page_context::PageContext,
