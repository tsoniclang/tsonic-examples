...
pub struct ContentPageSource {
    ...
    #[doc(hidden)]
    pub dispatch: alloc::rc::Rc<dyn ContentPageSourceDispatch + 'static>,
}

impl core::fmt::Debug for ContentPageSource {
...
impl rt::ObjectIdentityCarrier for ContentPageSource {
...
impl rt::ObjectIdentityCarrier for ListPageSource {
    fn object_identity(&self) -> &rt::ObjectIdentity {
...
impl rt::ObjectIdentityCarrier for ContentInventory {
    fn object_identity(&self) -> &rt::ObjectIdentity {
        self.state.object_identity()
    }
}
