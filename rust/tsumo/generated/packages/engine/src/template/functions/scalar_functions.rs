...
pub fn call_scalar_function(
    ...
    if name == "len" && rt::conversions::usize_to_i32(args.len())? >= 1 {
        ...
        if let Some(selected_dispatch) =
            v.dispatch.clone().downcast_template_value_to_string_value()
        {
            let selected_value = crate::template::values::primitives::StringValue {
                identity: v.identity.clone(),
                dispatch: selected_dispatch,
            };
            let l: i32 = rt::conversions::usize_to_i32(js_string::js_len(&{
                let dispatch_receiver_15 = &selected_value;
        ...
        if let Some(selected_dispatch_2) =
            v.dispatch.clone().downcast_template_value_to_html_value()
        {
            ...
            let l: i32 = rt::conversions::usize_to_i32(js_string::js_len(&{
                let dispatch_receiver_17 = &{
                    let dispatch_receiver_16 = &selected_value_2;
        ...
        if let Some(selected_dispatch_3) = v
            .dispatch
            .clone()
            .downcast_template_value_to_page_array_value()
        {
            ...
            let l: i32 = rt::conversions::usize_to_i32(
                {
                    let dispatch_receiver_18 = &selected_value_3;
        ...
        if let Some(selected_dispatch_4) = v
            .dispatch
            .clone()
            .downcast_template_value_to_string_array_value()
        {
            let selected_value_4 = crate::template::values::arrays::StringArrayValue {
                identity: v.identity.clone(),
                dispatch: selected_dispatch_4,
            };
            let l: i32 = rt::conversions::usize_to_i32(
                {
                    let dispatch_receiver_19 = &selected_value_4;
        ...
        if let Some(selected_dispatch_5) = v
            .dispatch
            .clone()
            .downcast_template_value_to_sites_array_value()
        {
            ...
            let l: i32 = rt::conversions::usize_to_i32(
                {
                    let dispatch_receiver_20 = &selected_value_5;
        ...
        if let Some(selected_dispatch_6) = v
            .dispatch
            .clone()
            .downcast_template_value_to_docs_mount_array_value()
        {
            let selected_value_6 = crate::template::values::docs::DocsMountArrayValue {
                identity: v.identity.clone(),
                dispatch: selected_dispatch_6,
            };
            let l: i32 = rt::conversions::usize_to_i32(
                {
                    let dispatch_receiver_21 = &selected_value_6;
        ...
        if let Some(selected_dispatch_7) = v
            .dispatch
            .clone()
            .downcast_template_value_to_nav_array_value()
        {
            let selected_value_7 = crate::template::values::docs::NavArrayValue {
                identity: v.identity.clone(),
                dispatch: selected_dispatch_7,
            };
            let l: i32 = rt::conversions::usize_to_i32(
                {
                    let dispatch_receiver_22 = &selected_value_7;
        ...
        if let Some(selected_dispatch_8) =
            v.dispatch.clone().downcast_template_value_to_dict_value()
        {
            ...
            return Ok(Some({
                let upcast_value_63 = crate::template::values::primitives::NumberValue::new(
                    rt::conversions::usize_to_i32(
                        {
                            let dispatch_receiver_23 = &selected_value_8;
        ...
        if let Some(selected_dispatch_9) = v
            .dispatch
            .clone()
            .downcast_template_value_to_any_array_value()
        {
            let selected_value_9 = crate::template::values::arrays::AnyArrayValue {
                identity: v.identity.clone(),
            ...
            return Ok(Some({
                let upcast_value_64 = crate::template::values::primitives::NumberValue::new(
                    rt::conversions::usize_to_i32(
                        {
                            let dispatch_receiver_24 = &selected_value_9;
    ...
    if rt::conversions::usize_to_i32(args.len())? >= 2 {
        ...
        if is_compare {
            ...
            } else if let Some(selected_dispatch_10) =
                a.dispatch.clone().downcast_template_value_to_number_value()
            {
                let selected_value_10 = crate::template::values::primitives::NumberValue {
                    identity: a.identity.clone(),
                    dispatch: selected_dispatch_10,
                };
                if let Some(selected_dispatch_11) =
                    b.dispatch.clone().downcast_template_value_to_number_value()
                {
                    let selected_value_11 = crate::template::values::primitives::NumberValue {
                        identity: b.identity.clone(),
                        dispatch: selected_dispatch_11,
                    };
                    let av: i32 = {
                        let dispatch_receiver_31 = &selected_value_10;
                        dispatch_receiver_31.dispatch.read_number_value_value()
                    };
                    let bv: i32 = {
                        let dispatch_receiver_32 = &selected_value_11;
