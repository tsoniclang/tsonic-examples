...
pub fn call_template_function_family(
    ...
    if name == "partial" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1 {
        ...
        let try_body: rt::TsonicResult<rt::Completion<Option<crate::template::values::base::TemplateValue>>> =
        ...
        let try_flow: rt::TsonicResult<rt::Completion<Option<crate::template::values::base::TemplateValue>>> =
            match try_body {
    ...
    if name == "partialcached" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1 {
        ...
        let try_body_2: rt::TsonicResult<rt::Completion<Option<crate::template::values::base::TemplateValue>>> =
            rt::completion_region(|| {
                let rendered: String = render_partial_resolution(
                    match selected.as_ref() {
        ...
        let try_flow_2: rt::TsonicResult<rt::Completion<Option<crate::template::values::base::TemplateValue>>> =
            match try_body_2 {
                Ok(completion) => Ok(completion),
                Err(e) => rt::completion_region(|| {
                    if matches!(e.clone(), rt::TsonicError::Project1(_)) {
    ...
    if name == "path.base" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1 {
        ...
        return Ok(if idx >= 0 {
            ...
            Some({
                let upcast_value_15 =
                    crate::template::values::primitives::StringValue::new(normalized.clone());
                crate::template::values::base::TemplateValue {
    ...
    if name == "path.ext" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1 {
        return Ok(Some({
    ...
    if name == "path.join" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1 {
        ...
        return Ok(Some({
            let upcast_value_17 = crate::template::values::primitives::StringValue::new(if rooted {
                format!("{}{}", String::from("/"), joined)
            } else {
                if joined.is_empty() {
                    String::from(".")
                } else {
    ...
    if name == "title" && tsonic_rust_runtime::conversions::usize_to_i32(args.len())? >= 1 {
        return Ok(Some({
