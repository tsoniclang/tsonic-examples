...
pub fn call_context_function(
    ...
    if name == "now.year" {
        ...
        return Ok(Some({
            let upcast_value_11 = crate::template::values::primitives::NumberValue::new(
                rt::option_coalesce(year, core::convert::identity, || 0),
            );
            crate::template::values::base::TemplateValue {
    ...
    if name == "now.unix" {
        ...
        return Ok(Some({
            let upcast_value_13 =
                crate::template::values::primitives::NumberValue::new(match seconds.as_ref() {
    ...
    if name == "getenv" && rt::conversions::usize_to_i32(args.len())? >= 1 {
        ...
        return Ok(if value.is_some() {
            Some({
                let upcast_value_15 =
                    crate::template::values::primitives::StringValue::new(match value.as_ref() {
    ...
    if name == "i18n" && rt::conversions::usize_to_i32(args.len())? >= 1 {
            ...
            .downcast_template_value_to_number_value()
        {
            ...
            count = Some({
                let dispatch_receiver_20 = &selected_value;
            ...
            fields.set_discard(String::from("Count"), {
                let upcast_value_18 = selected_value.clone();
                crate::template::values::base::TemplateValue {
        ...
        } else if let Some(selected_dispatch_2) = argument
            .dispatch
            .clone()
            .downcast_template_value_to_dict_value()
        {
            let selected_value_2 = crate::template::values::dict::DictValue {
                identity: argument.identity.clone(),
                dispatch: selected_dispatch_2,
            };
            'loop_value: for field in {
                let dispatch_receiver_21 = &selected_value_2;
            ...
            .keys()
            {
                ...
                let value: Option<crate::template::values::base::TemplateValue> = {
                    let dispatch_receiver_22 = &selected_value_2;
