...
.as_ref()
{
    ...
    None => unreachable!("checked flow selected a missing optional value"),
}, tsonic_rust_runtime::conversions::usize_to_i32(args.len())?)?;
        if tsonic_rust_runtime::conversions::usize_to_i32(args.len())? == 2 {
            if last < first {
                increment = -1;
            }
        } else {
            increment = sequence_argument(match args.get_number(1.0).as_ref() {
    ...
    let difference: f64 = tsonic_rust_runtime::conversions::i32_to_f64(last - first);
            ...
            let mut index: i32 = tsonic_rust_runtime::conversions::usize_to_i32(
                {
                    let dispatch_receiver_3 = &{
                        let downcast_value_3 = &collection;
            ...
            let mut index: i32 = tsonic_rust_runtime::conversions::usize_to_i32(
                {
                    let dispatch_receiver_5 = &{
                        let downcast_value_5 = &collection;
