        ...
        'loop_value: while i < (rt::conversions::usize_to_i32(segments.len())? as f64) {
                ...
                .is_some()
            {
                ...
                if k == "title" {
                    ...
                    let rel: String = {
                        let conditional_test_2 = js_string::starts_with_from_start(
                            &{
                    ...
                    let mgr: Option<crate::resources::manager::ResourceManager> = {
                        let dispatch_receiver_29 = {
                            ...
                            dispatch_receiver_28.dispatch.read_render_scope_env()
                        };
                    ...
                    cur = {
                        let upcast_value_34 = crate::template::values::primitives::BoolValue::new(
                            ({
                    ...
                    cur = {
                        let upcast_value_35 = crate::template::values::primitives::BoolValue::new(
                            ({
                    ...
                    cur = {
                        let upcast_value_36 = crate::template::values::primitives::BoolValue::new(
                            ({
                ...
                } else if k == "istaxonomy" {
                    cur = {
                        let upcast_value_37 = crate::template::values::primitives::BoolValue::new(
                            ({
                    ...
                    cur = {
                        let upcast_value_38 = crate::template::values::primitives::BoolValue::new(
                            ({
                    ...
                    cur = {
                        let upcast_value_39 = crate::template::values::primitives::BoolValue::new(
                            ({
                    ...
                    cur = {
                        let upcast_value_40 = crate::template::values::primitives::BoolValue::new(
                            !{
                                let dispatch_receiver_44 = &{
                                    let dispatch_receiver_43 = &page;
                                    dispatch_receiver_43.dispatch.read_page_context_summary()
                                };
                                dispatch_receiver_44.dispatch.read_html_string_value()
                            }
                            .is_empty()
                                && ({
                                    let dispatch_receiver_46 = &{
                                        let dispatch_receiver_45 = &page;
                                        dispatch_receiver_45.dispatch.read_page_context_summary()
                                    };
                                    dispatch_receiver_46.dispatch.read_html_string_value()
                                }) != {
                                    let dispatch_receiver_48 = &{
                                        let dispatch_receiver_47 = &page;
                                        dispatch_receiver_47.dispatch.read_page_context_content()
                                    };
                    ...
                    let selected: Option<crate::template::values::pagination::PaginatorValue> = {
                ...
                if k == "title" {
                    ...
                    let pages: js_abi::JsArray<crate::models::page_context::PageContext> = {
                        ...
                        if conditional_test_3 {
                            ...
                            let dispatch_receiver_94 = &site;
                            dispatch_receiver_94.dispatch.read_site_context_pages()
                        }
                    };
                    cur = {
                    ...
                    cur = {
                        let upcast_value_65 = {
                            let dispatch_receiver_96 = {
                                ...
                                dispatch_receiver_95.dispatch.read_render_scope_env()
                            };
                ...
                .is_some()
            {
                ...
                if k == "name" {
                    ...
                    cur = {
                        let upcast_value_89 = crate::template::values::menus::MenuArrayValue::new(
                            {
                ...
                if k == "host" {
                    cur = {
                        let upcast_value_130 =
                            crate::template::values::primitives::StringValue::new(
                                if uri.state.with(|state| state.absolute) {
                ...
                .is_some()
            {
                ...
                if key == "pages" {
                    ...
                    cur = {
                        let upcast_value_156 = crate::template::values::primitives::BoolValue::new(
                            ({
                    ...
                    cur = {
                        let upcast_value_157 = crate::template::values::primitives::BoolValue::new(
                            ({
