...
pub fn eval_token(
    ...
    if lit.is_some() {
        return Ok({
            let upcast_value_11 =
                crate::template::values::primitives::StringValue::new(match lit.as_ref() {
    ...
    if number.is_some() {
        return Ok({
            let upcast_value_14 =
                crate::template::values::primitives::NumberValue::new(match number.as_ref() {
...
pub fn call_method(
    ...
    if let Some(selected_dispatch) = receiver
        .dispatch
        .clone()
        .downcast_template_value_to_scratch_value()
    {
        let selected_value = crate::template::values::scratch::ScratchValue {
    ...
    if let Some(selected_dispatch_2) = receiver
        .dispatch
        .clone()
        .downcast_template_value_to_any_array_value()
    {
        let selected_value_2 = crate::template::values::arrays::AnyArrayValue {
            identity: receiver.identity.clone(),
        ...
        if method == "getmatch" && rt::conversions::usize_to_i32(args.len())? >= 1 {
            ...
            let items: js_abi::JsArray<crate::template::values::base::TemplateValue> = arr.clone();
            {
                ...
                while i < (rt::conversions::usize_to_i32(items.len())? as f64) {
                    ...
                    if let Some(selected_dispatch_3) = item
                        .dispatch
                        .clone()
                        .downcast_template_value_to_resource_value()
                    {
                        let selected_value_3 = crate::template::values::resources::ResourceValue {
        ...
        if method == "match" && rt::conversions::usize_to_i32(args.len())? >= 1 {
            ...
            let items: js_abi::JsArray<crate::template::values::base::TemplateValue> = arr.clone();
            {
                ...
                while i < (rt::conversions::usize_to_i32(items.len())? as f64) {
                    ...
                    if let Some(selected_dispatch_4) = item
                        .dispatch
                        .clone()
                        .downcast_template_value_to_resource_value()
                    {
                        let selected_value_4 = crate::template::values::resources::ResourceValue {
                            identity: item.identity.clone(),
                            dispatch: selected_dispatch_4,
                        };
                        let res: crate::resources::models::Resource = {
                            let dispatch_receiver_6 = &selected_value_4;
        ...
        if method == "bytype" && rt::conversions::usize_to_i32(args.len())? >= 1 {
                ...
                arr.clone();
            {
                ...
                while i < (rt::conversions::usize_to_i32(by_type_items.len())? as f64) {
                    let item: crate::template::values::base::TemplateValue =
                        match by_type_items.get_number(i).as_ref() {
                            Some(flow_value_21) => flow_value_21.clone(),
                            None => unreachable!("checked flow selected a missing optional value"),
                        };
                    if let Some(selected_dispatch_5) = item
                        .dispatch
                        .clone()
                        .downcast_template_value_to_resource_value()
                    {
                        let selected_value_5 = crate::template::values::resources::ResourceValue {
                            identity: item.identity.clone(),
        ...
        {
            let target: crate::template::values::base::TemplateValue =
                match args.get_number(0.0).as_ref() {
                    Some(flow_value_22) => flow_value_22.clone(),
                    None => unreachable!("checked flow selected a missing optional value"),
                };
            if let Some(selected_dispatch_6) = target
                .dispatch
                .clone()
                .downcast_template_value_to_page_value()
            {
                let selected_value_6 = crate::template::values::page::PageValue {
    ...
    if let Some(selected_dispatch_7) = receiver
        .dispatch
        .clone()
        .downcast_template_value_to_site_value()
    {
        let selected_value_7 = crate::template::values::site::SiteValue {
            identity: receiver.identity.clone(),
    ...
    if let Some(selected_dispatch_8) = receiver
        .dispatch
        .clone()
        .downcast_template_value_to_page_value()
    {
        let selected_value_8 = crate::template::values::page::PageValue {
            identity: receiver.identity.clone(),
        ...
        if method == "getpage" && rt::conversions::usize_to_i32(args.len())? >= 1 {
            ...
            return Ok(if found.is_some() {
                let upcast_value_11 =
                    crate::template::values::page::PageValue::new(match found.as_ref() {
            ...
            && rt::conversions::usize_to_i32(args.len())? >= 2
        {
            ...
            let menu_name: String = crate::template::runtime_helpers::to_plain_string(match args
                .get_number(0.0)
                .as_ref()
            {
    ...
    if let Some(selected_dispatch_9) = receiver
        .dispatch
        .clone()
        .downcast_template_value_to_output_formats_value()
    {
        let selected_value_9 = crate::template::values::output::OutputFormatsValue {
            identity: receiver.identity.clone(),
        ...
        if method == "get" && rt::conversions::usize_to_i32(args.len())? >= 1 {
            ...
            let formats: js_abi::JsArray<crate::models::output_format::OutputFormat> = {
                let dispatch_receiver_42 = {
                    let dispatch_receiver_41 = &selected_value_9;
            ...
            };
            {
                ...
                while index < (rt::conversions::usize_to_i32(formats.len())? as f64) {
                    let format: crate::models::output_format::OutputFormat =
                        match formats.get_number(index).as_ref() {
    ...
    if let Some(selected_dispatch_10) = receiver
        .dispatch
        .clone()
        .downcast_template_value_to_shortcode_value()
    {
        let selected_value_10 = crate::template::contexts::ShortcodeValue {
            identity: receiver.identity.clone(),
    ...
    if let Some(selected_dispatch_11) = receiver
        .dispatch
        .clone()
        .downcast_template_value_to_url_query_value()
    {
        let selected_value_11 = crate::template::values::url::UrlQueryValue {
            identity: receiver.identity.clone(),
    ...
    if let Some(selected_dispatch_12) = receiver
        .dispatch
        .clone()
        .downcast_template_value_to_resource_value()
    {
        let selected_value_12 = crate::template::values::resources::ResourceValue {
            identity: receiver.identity.clone(),
        ...
        if method == "resize" && rt::conversions::usize_to_i32(args.len())? >= 1 {
            let resized: crate::resources::models::Resource = {
                ...
                dispatch_receiver_52
                    .dispatch
                    .clone()
                    .dispatch_resource_manager_resize(
                        {
            ...
            return Ok({
                let upcast_value_23 = crate::template::values::resources::ResourceValue::new(
                    {
                        let dispatch_receiver_53 = &selected_value_12;
