    ...
    crate::template::values::base::TemplateValueDispatch
{
    fn downcast_output_formats_value_to_output_formats_value(
        self: std::rc::Rc<Self>,
    ) -> Option<std::rc::Rc<dyn OutputFormatsValueDispatch + 'static>>;
...
pub struct OutputFormatsValue {
    ...
    #[doc(hidden)]
    pub dispatch: std::rc::Rc<dyn OutputFormatsValueDispatch + 'static>,
}
...
impl OutputFormatsValue {
    ...
    pub fn new(site: crate::models::site_context::SiteContext) -> OutputFormatsValue {
        ...
        let root = std::rc::Rc::new(OutputFormatsValueRoot {
...
impl crate::template::values::base::TemplateValueDispatch for OutputFormatsValueRoot {
    ...
    fn downcast_template_value_to_output_formats_get_value(
        self: std::rc::Rc<Self>,
    ) -> Option<std::rc::Rc<dyn OutputFormatsGetValueDispatch + 'static>> {
        None
    }
    ...
    fn downcast_template_value_to_output_format_value(
        self: std::rc::Rc<Self>,
    ) -> Option<std::rc::Rc<dyn OutputFormatValueDispatch + 'static>> {
        None
    }
...
pub struct OutputFormatValue {
    ...
    pub identity: rt::ObjectIdentity,
    #[doc(hidden)]
    pub dispatch: std::rc::Rc<dyn OutputFormatValueDispatch + 'static>,
}
...
impl OutputFormatValue {
    ...
    pub fn new(value: crate::models::output_format::OutputFormat) -> OutputFormatValue {
        ...
        let identity = rt::ObjectIdentity::new();
        let root = std::rc::Rc::new(OutputFormatValueRoot {
            identity: identity.clone(),
            state: rt::ObjectHandle::new(state),
        });
        OutputFormatValue {
...
pub struct OutputFormatsGetValue {
    ...
    pub identity: rt::ObjectIdentity,
    #[doc(hidden)]
    pub dispatch: std::rc::Rc<dyn OutputFormatsGetValueDispatch + 'static>,
}
...
impl OutputFormatsGetValue {
    ...
    pub fn new(site: crate::models::site_context::SiteContext) -> OutputFormatsGetValue {
        ...
        let identity = rt::ObjectIdentity::new();
        let root = std::rc::Rc::new(OutputFormatsGetValueRoot {
            identity: identity.clone(),
            state: rt::ObjectHandle::new(state),
        });
