    ...
    crate::template::values::base::TemplateValueDispatch
{
    fn downcast_deferred_template_value_to_deferred_template_value(
        self: std::rc::Rc<Self>,
    ) -> Option<std::rc::Rc<dyn DeferredTemplateValueDispatch + 'static>>;
...
pub struct DeferredTemplateValue {
    ...
    #[doc(hidden)]
    pub dispatch: std::rc::Rc<dyn DeferredTemplateValueDispatch + 'static>,
}
...
impl DeferredTemplateValue {
    ...
    pub fn new(
        ...
        let root = std::rc::Rc::new(DeferredTemplateValueRoot {
