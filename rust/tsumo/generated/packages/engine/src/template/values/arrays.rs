    ...
    crate::template::values::base::TemplateValueDispatch
{
    fn downcast_string_array_value_to_string_array_value(
        self: std::rc::Rc<Self>,
    ) -> Option<std::rc::Rc<dyn StringArrayValueDispatch + 'static>>;
...
pub struct StringArrayValue {
    ...
    #[doc(hidden)]
    pub dispatch: std::rc::Rc<dyn StringArrayValueDispatch + 'static>,
}
...
impl crate::template::values::base::TemplateValueDispatch for StringArrayValueRoot {
    ...
    fn downcast_template_value_to_any_array_value(
        self: std::rc::Rc<Self>,
    ) -> Option<std::rc::Rc<dyn AnyArrayValueDispatch + 'static>> {
        None
    }
...
pub struct AnyArrayValue {
    ...
    pub identity: rt::ObjectIdentity,
    #[doc(hidden)]
    pub dispatch: std::rc::Rc<dyn AnyArrayValueDispatch + 'static>,
}
