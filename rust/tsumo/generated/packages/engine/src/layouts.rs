...
pub struct LayoutEnvironment {
    ...
    #[doc(hidden)]
    pub dispatch: alloc::rc::Rc<dyn LayoutEnvironmentDispatch + 'static>,
}

impl core::fmt::Debug for LayoutEnvironment {
...
impl rt::ObjectIdentityCarrier for LayoutEnvironment {
