...
pub fn parse_nav_json(
    ...
    if let Some(selected_dispatch) = root.dispatch.clone().downcast_json_value_to_json_object() {
        let selected_value = crate::utils::json::JsonObject {
            identity: root.identity.clone(),
            dispatch: selected_dispatch,
        };
        let items: Option<crate::utils::json::JsonValue> = {
            let dispatch_receiver = selected_value.clone();
            dispatch_receiver
                .dispatch
                .clone()
