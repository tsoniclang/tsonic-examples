...
pub struct DocsMountConfig {
    ...
    #[doc(hidden)]
    pub dispatch: alloc::rc::Rc<dyn DocsMountConfigDispatch + 'static>,
}

impl core::fmt::Debug for DocsMountConfig {
...
impl rt::ObjectIdentityCarrier for DocsMountConfig {
...
impl rt::ObjectIdentityCarrier for DocsSiteConfig {
    fn object_identity(&self) -> &rt::ObjectIdentity {
...
impl rt::ObjectIdentityCarrier for NavItem {
    fn object_identity(&self) -> &rt::ObjectIdentity {
        self.state.object_identity()
    }
}
...
impl rt::ObjectIdentityCarrier for DocsMountContext {
    fn object_identity(&self) -> &rt::ObjectIdentity {
        self.state.object_identity()
    }
}
