...
pub fn require_string_array(
    ...
    let result: js_abi::JsArray<String> = js_abi::JsArray::from_dense(vec![]);
    {
        ...
        while index
            < (tsonic_rust_runtime::conversions::usize_to_i32({ let dispatch_receiver = &array; dispatch_receiver.dispatch.read_json_array_items() }.len())? as f64)
        {
...
pub fn parse_json_front_matter(
        ...
        crate::frontmatter::data::FrontMatter::new();
    {
        let mut index: f64 = 0.0;
        while index
            < (tsonic_rust_runtime::conversions::usize_to_i32({ let dispatch_receiver_3 = &root; dispatch_receiver_3.dispatch.read_json_object_properties() }.len())? as f64)
        {
            let property: crate::utils::json::JsonProperty = match {
                                ...
                                if key == "draft" {
                                    ...
                                    if key == "date" {
                                        ...
                                        }
                                        {
                                            ...
                                            let value_8 =
                                                Some(js_abi::JsDate::from_millis(milliseconds));
                                        ...
                                        if key == "tags" {
                                            {
                                                ...
                                                receiver_8
                                                    .state
                                                    .with_mut(|state| state.tags = value_9)
                                            };
                                        } else {
                                            if key == "categories" {
                                                {
                                                    ...
                                                    receiver_9.state.with_mut(|state| {
                                                        state.categories = value_10
                                                    })
                                                };
                                            } else {
                                                if key == "params" {
                                                    ...
                                                    )?;
                                                    {
                                                        ...
                                                        while param_index
                                                            < (tsonic_rust_runtime::conversions::usize_to_i32({ let dispatch_receiver_8 = &params; dispatch_receiver_8.dispatch.read_json_object_properties() }.len())? as f64)
                                                        {
                                                    ...
                                                    if key == "menu" {
                                                        ...
                                                        )?;
                                                        {
                                                            ...
                                                            while menu_index
                                                                < (tsonic_rust_runtime::conversions::usize_to_i32({ let dispatch_receiver_10 = &menu_object; dispatch_receiver_10.dispatch.read_json_object_properties() }.len())? as f64)
                                                            {
                                                                    ...
                                                                    );
                                                                {
                                                                    ...
                                                                    while field_index
                                                                        < (tsonic_rust_runtime::conversions::usize_to_i32({ let dispatch_receiver_12 = &menu_fields; dispatch_receiver_12.dispatch.read_json_object_properties() }.len())? as f64)
                                                                    {
