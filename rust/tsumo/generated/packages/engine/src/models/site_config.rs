...
pub struct ModuleMount {
    ...
    #[doc(hidden)]
    pub dispatch: alloc::rc::Rc<dyn ModuleMountDispatch + 'static>,
}

impl core::fmt::Debug for ModuleMount {
...
impl rt::ObjectIdentityCarrier for ModuleMount {
...
pub struct SiteConfig {
    ...
    pub identity: rt::ObjectIdentity,
    #[doc(hidden)]
    pub dispatch: alloc::rc::Rc<dyn SiteConfigDispatch + 'static>,
}

impl core::fmt::Debug for SiteConfig {
    fn fmt(&self, formatter: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
...
impl rt::ObjectIdentityCarrier for SiteConfig {
    fn object_identity(&self) -> &rt::ObjectIdentity {
        &self.identity
    }
}
