...
{
    public static class Node_modules_Tsumo_engine_src_template_evaluation_pageSemantics
    {
        ...
        internal static PageArrayValue defaultRelatedPages(Tsonic.CSharp.Js.JSArray<PageContext> pages, PageContext source)
        {
            ...
            for (double left = 0; left < candidates.length; left++)
            {
                for (double right = left + 1; right < candidates.length; right++)
                {
                    ...
                    int dateOrder = Node_modules_Tsumo_engine_src_utils_strings.compareText(leftCandidate.page.date, rightCandidate.page.date);
                    int pathOrder = Node_modules_Tsumo_engine_src_utils_strings.compareText(leftCandidate.page.relPermalink, rightCandidate.page.relPermalink);
        ...
        internal static TemplateValue pageGroupingValue(PageContext page, string fieldRaw)
        {
            ...
            {
                ParamValue? parameter = Node_modules_Tsumo_engine_src_template_evaluation_paramSemantics.findParam(page.Params, Node_modules_Tsumo_engine_src_utils_strings.substringFrom(Tsonic.CSharp.Js.String.trim(fieldRaw), "params.".Length));
                if (parameter is not null)
                {
                    return Node_modules_Tsumo_engine_src_template_evaluation_paramSemantics.paramToTemplateValue(parameter);
                }
            }
            throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_PAGE_GROUP_FIELD_UNSUPPORTED", $"Pages.GroupBy cannot resolve page field '{fieldRaw}'");
        }
        ...
        {
            return Node_modules_Tsumo_engine_src_template_evaluation_scalarSemantics.formatDateTime(value, layout);
        }
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            toTitleCase = (string text) =>
            {
                ...
                for (double i = 0; i < parts.length; i++)
                {
                    ...
                    string first = Tsonic.CSharp.Js.String.toUpperCase(Node_modules_Tsumo_engine_src_utils_strings.substringCount(word, 0, 1));
                    string rest = word.Length > 1 ? Tsonic.CSharp.Js.String.toLowerCase(Node_modules_Tsumo_engine_src_utils_strings.substringFrom(word, 1)) : "";
                    sb.append(first);
                    sb.append(rest);
                }
                return sb.toString();
            ...
            sortPagesByDate = (Tsonic.CSharp.Js.JSArray<PageContext> pages, string field) =>
            {
                ...
                for (double i_1 = 0; i_1 < len; i_1++)
                {
                    for (double j = 0; j < len - i_1 - 1; j++)
                    {
                        ...
                        if (Node_modules_Tsumo_engine_src_utils_strings.compareText(dateA, dateB) > 0)
                        {
                            arr[j] = b;
                            arr[j + 1] = a;
                        }
            ...
            sortPagesByTitle = (Tsonic.CSharp.Js.JSArray<PageContext> pages) =>
            {
                ...
                for (double i_1 = 0; i_1 < len; i_1++)
                {
                    for (double j = 0; j < len - i_1 - 1; j++)
                    {
                        PageContext a = arr[j];
                        PageContext b = arr[j + 1];
                        if (Node_modules_Tsumo_engine_src_utils_strings.compareText(a.title, b.title) > 0)
                        {
                            arr[j] = b;
                            arr[j + 1] = a;
                        }
            ...
            {
                ParamValue? value = Node_modules_Tsumo_engine_src_template_evaluation_paramSemantics.findParam(page.Params, "weight");
                if (value is null)
                {
                    return 0;
                }
                ...
                {
                    throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_PAGE_WEIGHT_INVALID", "Page weight requires a 32-bit integer front-matter value");
                }
            ...
            callPageCollectionMethod = (PageArrayValue collection, string method, Tsonic.CSharp.Js.JSArray<TemplateValue> args) =>
            {
                ...
                {
                    string order = args.length >= 2 ? Tsonic.CSharp.Js.String.toLowerCase(Tsonic.CSharp.Js.String.trim(Node_modules_Tsumo_engine_src_template_runtimeHelpers.toPlainString(args[1]))) : "asc";
                    if (order != "asc" && order != "desc")
                    {
                        throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_PAGE_GROUP_ORDER_INVALID", $"Page group order must be 'asc' or 'desc', received '{order}'");
                    }
                    return groupPagesByField(collection.value, Node_modules_Tsumo_engine_src_template_runtimeHelpers.toPlainString(args[0]), order == "asc");
                }
                if (method == "groupbydate" && args.length >= 1)
                {
                    string order_1 = args.length >= 2 ? Tsonic.CSharp.Js.String.toLowerCase(Tsonic.CSharp.Js.String.trim(Node_modules_Tsumo_engine_src_template_runtimeHelpers.toPlainString(args[1]))) : "desc";
                    if (order_1 != "asc" && order_1 != "desc")
                    {
                        throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_PAGE_GROUP_ORDER_INVALID", $"Page date group order must be 'asc' or 'desc', received '{order_1}'");
                    }
                    return groupPagesByDate(collection.value, Node_modules_Tsumo_engine_src_template_runtimeHelpers.toPlainString(args[0]), order_1 == "asc");
                }
                if (method == "related" && args.length == 1)
                {
                    ...
                    {
                        throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_RELATED_OPTIONS_UNSUPPORTED", "Page collection Related options require a configured related-content model");
                    }
                }
                return null;
            };
            ...
            compareValues = (TemplateValue a, TemplateValue b) =>
            {
                if ((object?)a is StringValue && (object?)b is StringValue)
                {
                    ...
                    return Node_modules_Tsumo_engine_src_utils_strings.compareText(aStr, bStr);
                }
                ...
                string aPlain = Node_modules_Tsumo_engine_src_template_runtimeHelpers.toPlainString(a);
                string bPlain = Node_modules_Tsumo_engine_src_template_runtimeHelpers.toPlainString(b);
                return Node_modules_Tsumo_engine_src_utils_strings.compareText(aPlain, bPlain);
            };
            matchWhere = (TemplateValue actual, string op, TemplateValue expected) =>
            {
                ...
                string actualText = Node_modules_Tsumo_engine_src_template_runtimeHelpers.toPlainString(actual);
                if (opLower == "eq" || opLower == "==")
                {
                    return actualText == Node_modules_Tsumo_engine_src_template_runtimeHelpers.toPlainString(expected);
                }
                ...
                if (opLower == "in")
                {
                    if ((object?)expected is AnyArrayValue)
                    {
                        ...
                        {
                            if (Node_modules_Tsumo_engine_src_template_runtimeHelpers.toPlainString(((AnyArrayValue)expected).value[i]) == actualText)
                            {
                                return true;
                            }
                        }
                ...
                throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_WHERE_OPERATOR_UNSUPPORTED", $"collections.Where does not support operator '{op}'");
            };
            return null;
        }
