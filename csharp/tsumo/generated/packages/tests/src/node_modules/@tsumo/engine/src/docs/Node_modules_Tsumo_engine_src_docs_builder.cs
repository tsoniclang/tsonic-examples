    ...
    public static class Node_modules_Tsumo_engine_src_docs_builder
    {
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            buildDocsSite = (BuildRequest request, LoadedDocsConfig docsLoaded, string outDir) =>
            {
                ...
                string? baseTpl = Node_modules_Tsumo_engine_src_build_layout.selectTemplate(env, Tsonic.CSharp.Js.JSArray<string>.of(["_default/baseof.html"]));
                string homeTpl = Node_modules_Tsumo_engine_src_build_layout.selectTemplate(env, Tsonic.CSharp.Js.JSArray<string>.of(["index.html", "docs/home.html", "docs/list.html", "_default/list.html"])) ?? "_default/list.html";
                string listTpl = Node_modules_Tsumo_engine_src_build_layout.selectTemplate(env, Tsonic.CSharp.Js.JSArray<string>.of(["docs/list.html", "_default/list.html"])) ?? "_default/list.html";
                string singleTpl = Node_modules_Tsumo_engine_src_build_layout.selectTemplate(env, Tsonic.CSharp.Js.JSArray<string>.of(["docs/single.html", "_default/single.html"])) ?? "_default/single.html";
