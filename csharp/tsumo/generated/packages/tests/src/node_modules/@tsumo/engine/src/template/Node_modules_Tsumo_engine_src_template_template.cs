...
{
    public static class Node_modules_Tsumo_engine_src_template_template
    {
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            Node_modules_Tsumo_engine_src_template_evaluation_render.__tsonic_module_init();
            return null;
        }
    ...
    public class Template
    {
        ...
        public Template withInheritedDefinitions(Tsonic.CSharp.Js.Map<string, Tsonic.CSharp.Js.JSArray<TemplateNode>> inherited)
        {
            ...
            foreach (string name in inherited.keys())
            {
                ...
                {
                    throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_DEFINE_INVENTORY_INVALID", $"Inherited template definition '{name}' has no body", this.sourcePath);
                }
            ...
            foreach (string name_1 in this.defines.keys())
            {
                ...
                if (body is null)
                {
                    throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_DEFINE_INVENTORY_INVALID", $"Template definition '{name_1}' has no body", this.sourcePath);
                }
                ...
                {
                    throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_DEFINE_CONFLICT", $"Template definition '{name_1}' conflicts with an inherited definition", this.sourcePath);
                }
        ...
        {
            string control = Node_modules_Tsumo_engine_src_template_evaluation_render.renderTemplateNodes(this.nodes, sb, scope, env, overrides, this.defines, "html");
            if (control != "normal")
            {
                throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_CONTROL_FLOW_INVALID", "Template loop control escaped the checked template root");
            }
        }
        ...
        {
            string control = Node_modules_Tsumo_engine_src_template_evaluation_render.renderTemplateNodes(this.nodes, sb, scope, env, overrides, this.defines, "text");
            if (control != "normal")
            {
                throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_CONTROL_FLOW_INVALID", "Template loop control escaped the checked template root");
            }
