...
{
    public static class Node_modules_Tsumo_engine_src_fs
    {
        ...
        internal static Tsonic.CSharp.Js.JSArray<ManagedDirectoryEntry> listManagedDirectoryEntries(string directory)
        {
            ...
            entries.sort((ManagedDirectoryEntry left, ManagedDirectoryEntry right) => Node_modules_Tsumo_engine_src_utils_strings.compareText(left.path, right.path));
            return entries;
        }
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            rejectFilesystemLink = (string path) =>
            {
                ...
                throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_FILESYSTEM_LINK_UNSUPPORTED", "Symbolic links and filesystem reparse points are not supported in Tsumo-managed filesystem trees", path);
            };
            ...
            listFilesRecursive = (string rootDir, string searchPattern) =>
            {
                ...
                walk(rootDir);
                files.sort((string left, string right) => Node_modules_Tsumo_engine_src_utils_strings.compareText(left, right));
                return files;
            };
