...
{
    public static class Node_modules_Tsumo_engine_src_build_renderPageContent
    {
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            renderStandardPageContent = (StandardPageGraph graph, BuildEnvironment environment) =>
            {
                foreach ((PageContext, string) entry in graph.rawBodyByPage.entries())
                {
                    ...
                    MarkdownResult rendered = Node_modules_Tsumo_engine_src_markdown_renderWithShortcodes.renderMarkdownWithShortcodes(rawBody, page, graph.site, environment);
