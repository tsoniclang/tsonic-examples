...
{
    public static class Node_modules_Tsumo_engine_src_docs_output
    {
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            resolveDocsOutputPath = (string outputRoot, string relativePath) =>
            {
                ...
                {
                    throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_DOCS_OUTPUT_PATH_ABSOLUTE", $"Docs output path must be relative: {relativePath}");
                }
                ...
                {
                    throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_DOCS_OUTPUT_PATH_ESCAPES_ROOT", $"Docs output path escapes its root: {relativePath}");
                }
                return candidate;
            };
