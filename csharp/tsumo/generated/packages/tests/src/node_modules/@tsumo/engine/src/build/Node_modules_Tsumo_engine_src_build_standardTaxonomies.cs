    ...
    public static class Node_modules_Tsumo_engine_src_build_standardTaxonomies
    {
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            createTaxonomyPage = (StandardPageGraph graph, string taxonomy, Tsonic.CSharp.Js.Map<string, Tsonic.CSharp.Js.JSArray<PageContext>> pagesByTerm) =>
            {
                ...
                PageContext root = new PageContext(Node_modules_Tsumo_engine_src_utils_text.humanizeSlug(taxonomy), "", "", false, "taxonomy", taxonomy, taxonomy, taxonomy, Node_modules_Tsumo_engine_src_utils_urlPath.combineUrlPath(new Tsonic.CSharp.Js.JSArray<string>(new string[] { taxonomy })), "", emptyHtml, emptyHtml, emptyHtml, "", emptyStrings, emptyStrings, taxonomyParameters, null, graph.site.Language, emptyPages, null, graph.site, emptyPages, graph.home, new Tsonic.CSharp.Js.JSArray<PageContext>(new PageContext[] { graph.home }), null);
