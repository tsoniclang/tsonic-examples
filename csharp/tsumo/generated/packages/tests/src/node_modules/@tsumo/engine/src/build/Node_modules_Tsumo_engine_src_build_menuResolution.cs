...
namespace Tsumo.Tests
{
    public static class Node_modules_Tsumo_engine_src_build_menuResolution
    {
        ...
        {
            return Tsonic.CSharp.Js.String.toLowerCase(Node_modules_Tsumo_engine_src_utils_strings.trimEndChar(Node_modules_Tsumo_engine_src_utils_strings.trimStartChar(Tsonic.CSharp.Js.String.trim(value), "/"), "/"));
        }
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            configureSiteMenus = (Tsonic.CSharp.Js.JSArray<ContentPageSource> pageSources, Tsonic.CSharp.Js.JSArray<PageContext> pages, SiteContext site) =>
            {
                ...
                for (double index = 0; index < menuNames.length; index++)
                {
                    ...
                    Tsonic.CSharp.Js.JSArray<MenuEntry> combined = existing is null ? Tsonic.CSharp.Js.JSArray<MenuEntry>.of([]) : Node_modules_Tsumo_engine_src_menus.flattenMenuEntries(existing);
