...
{
    public static class Node_modules_Tsumo_engine_src_docs_content
    {
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            loadDocsContent = (Tsonic.CSharp.Js.JSArray<DocsMarkdownRoute> routes, bool buildDrafts) =>
            {
                ...
                for (int index = 0; index < routes.length; index++)
                {
                    ...
                    ParsedContent parsed = Node_modules_Tsumo_engine_src_frontmatter_parse.parseContent(Node_modules_Tsumo_engine_src_fs.readTextFile(route.sourcePath), route.sourcePath);
