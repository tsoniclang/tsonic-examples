...
namespace Tsumo.Tests
{
    public static class Node_modules_Tsumo_engine_src_resources_pageBundle
    {
        ...
        {
            return Node_modules_Tsumo_engine_src_fs.fileExists(Tsonic.CSharp.Node.path.join(directory, "index.md")) || Node_modules_Tsumo_engine_src_fs.fileExists(Tsonic.CSharp.Node.path.join(directory, "_index.md"));
        }
