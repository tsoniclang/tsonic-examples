...
{
    public static class Node_modules_Tsumo_engine_src_docs_config
    {
        internal static TsumoError docsConfigError(string code, string message, string path)
        {
            return Node_modules_Tsumo_engine_src_diagnostics.createTsumoError(code, message, path);
        }
        ...
        {
            return Node_modules_Tsumo_engine_src_utils_text.ensureTrailingSlash(Node_modules_Tsumo_engine_src_utils_text.ensureLeadingSlash(Tsonic.CSharp.Js.String.trim(raw)));
        }
        ...
        internal static DocsMountConfig parseMount(string siteDir, JsonValue value, double index, string path)
        {
            ...
            string fallbackName = urlPrefix == "/" ? "Docs" : Node_modules_Tsumo_engine_src_utils_strings.trimEndChar(Node_modules_Tsumo_engine_src_utils_strings.trimStartChar(urlPrefix, "/"), "/");
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            loadDocsConfig = (string siteDir) =>
            {
                ...
                JsonObject? parsedRoot = Node_modules_Tsumo_engine_src_utils_json.jsonObject(Node_modules_Tsumo_engine_src_utils_json.parseJson(Node_modules_Tsumo_engine_src_fs.readTextFile(candidate), candidate));
