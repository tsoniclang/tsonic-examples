...
{
    public static class Node_modules_Tsumo_engine_src_docs_directoryGraph
    {
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            addDocsDirectoryWithParents = (string directory, Tsonic.CSharp.Js.Map<string, bool> directories) =>
            {
                ...
                while (true)
                {
                    ...
                    current = separator < 0 ? "" : Node_modules_Tsumo_engine_src_utils_strings.substringCount(current, 0, separator);
                }
            };
            ...
            docsParentDirectory = (string directory) =>
            {
                ...
                return separator < 0 ? "" : Node_modules_Tsumo_engine_src_utils_strings.substringCount(directory, 0, separator);
            };
            docsDirectoryName = (string directory) =>
            {
                int separator = Tsonic.CSharp.Js.String.lastIndexOf(directory, "/");
                return separator < 0 ? directory : Node_modules_Tsumo_engine_src_utils_strings.substringFrom(directory, separator + 1);
            };
