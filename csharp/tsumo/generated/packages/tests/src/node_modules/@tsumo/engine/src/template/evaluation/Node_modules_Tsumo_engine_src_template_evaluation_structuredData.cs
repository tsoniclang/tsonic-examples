...
{
    public static class Node_modules_Tsumo_engine_src_template_evaluation_structuredData
    {
        internal static TsumoError yamlError(string message, string? sourcePath, int line)
        {
            return Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_UNMARSHAL_YAML_INVALID", message, sourcePath, line, 1);
        }
        ...
        internal static int? yamlQuotedScalarStart(string content)
        {
            ...
            string candidate = Node_modules_Tsumo_engine_src_utils_strings.substringFrom(content, start);
        ...
        internal static YamlLogicalLine readYamlLogicalLine(Tsonic.CSharp.Js.JSArray<string> sourceLines, int sourceIndex, int indent, string? sourcePath)
        {
            ...
            string content = Tsonic.CSharp.Js.String.trimEnd(Node_modules_Tsumo_engine_src_utils_structuredScalars.stripStructuredComment(Node_modules_Tsumo_engine_src_utils_strings.substringFrom(raw, indent), "yaml"));
            ...
            return new YamlLogicalLine(Tsonic.CSharp.Js.String.trimEnd(Node_modules_Tsumo_engine_src_utils_structuredScalars.stripStructuredComment(content, "yaml")), nextSourceIndex);
        }
        internal static TemplateValue jsonToTemplateValue(JsonValue value)
        {
            ...
            if ((object?)value is JsonNumber)
            {
                ...
                {
                    throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_UNMARSHAL_NUMBER_UNSUPPORTED", "Structured template data currently requires 32-bit integer numbers", null, ((JsonNumber)value).line, ((JsonNumber)value).column);
                }
            ...
            throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_UNMARSHAL_VALUE_INVALID", "Structured data contains an unknown value kind");
        }
        internal static StructuredInput inputFromValue(TemplateValue value)
        {
            if ((object?)value is ResourceValue)
            {
                ...
                return new StructuredInput(Node_modules_Tsumo_engine_src_resources_text.readResourceText(resource, "transform.Unmarshal"), sourcePath, formatHint);
            }
            ...
            throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_UNMARSHAL_INPUT_INVALID", "transform.Unmarshal requires a string or resource input");
        }
        internal static string? optionValue(DictValue options, string name)
        {
            ...
            {
                return Node_modules_Tsumo_engine_src_template_runtimeHelpers.toPlainString(exact);
            }
            ...
            foreach (string key in options.value.keys())
            {
                if (Tsonic.CSharp.Js.String.toLowerCase(key) == normalized)
                {
                    ...
                    return value is null ? null : Node_modules_Tsumo_engine_src_template_runtimeHelpers.toPlainString(value);
                }
            }
            return null;
        }
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            Node_modules_Tsumo_engine_src_utils_json.__tsonic_module_init();
            ...
            Node_modules_Tsumo_engine_src_template_evaluation_tomlData.__tsonic_module_init();
            parseTemplateDataText = (string text, string formatRaw, string? sourcePath) =>
            {
                ...
                if (format == "json")
                {
                    return jsonToTemplateValue(Node_modules_Tsumo_engine_src_utils_json.parseJson(text, sourcePath));
                }
                ...
                if (format == "toml")
                {
                    return Node_modules_Tsumo_engine_src_template_evaluation_tomlData.parseTomlTemplateData(text, sourcePath);
                }
                throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_UNMARSHAL_FORMAT_UNSUPPORTED", $"transform.Unmarshal format '{format}' is not supported by the current template data contract", sourcePath);
            };
            unmarshalTemplateData = (Tsonic.CSharp.Js.JSArray<TemplateValue> args) =>
            {
                if (args.length == 0)
                {
                    throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_UNMARSHAL_INPUT_MISSING", "transform.Unmarshal requires an input");
                }
                ...
                if (args.length >= 2)
                {
                    ...
                    {
                        throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_UNMARSHAL_OPTIONS_INVALID", "transform.Unmarshal options must be a dictionary");
                    }
    ...
    public class YamlTemplateParser
    {
        ...
        public YamlTemplateParser(string text, string? sourcePath = null)
        {
            ...
            while (index < sourceLines.length)
            {
                ...
                int indent = Node_modules_Tsumo_engine_src_template_evaluation_structuredData.yamlSourceIndentation(raw, sourcePath, index + 1);
                YamlLogicalLine logical = Node_modules_Tsumo_engine_src_template_evaluation_structuredData.readYamlLogicalLine(sourceLines, index, indent, sourcePath);
        ...
        public YamlParseResult parseBlock(int index, int indent)
        {
            ...
            if (Node_modules_Tsumo_engine_src_template_evaluation_structuredData.yamlMappingSeparator(line.content) >= 0)
            {
        ...
        public YamlParseResult parseSequence(int index, int indent)
        {
            ...
            while (current < this.lines.length)
            {
                ...
                string item = line.content == "-" ? "" : Tsonic.CSharp.Js.String.trim(Node_modules_Tsumo_engine_src_utils_strings.substringFrom(line.content, 2));
                current++;
                if (item != "")
                {
                    int separator = Node_modules_Tsumo_engine_src_template_evaluation_structuredData.yamlMappingSeparator(item);
                    if (separator >= 0)
                    {
                        ...
                        string valueText = Tsonic.CSharp.Js.String.trim(Node_modules_Tsumo_engine_src_utils_strings.substringFrom(item, separator + 1));
                        if (valueText == "")
                        {
                ...
                if (current >= this.lines.length || this.lines[current].indent <= indent)
                {
                    values.push(Node_modules_Tsumo_engine_src_template_runtimeHelpers.nil);
                    continue;
                }
        ...
        public YamlParseResult parseMapping(int index, int indent)
        {
            ...
            while (current < this.lines.length)
            {
                ...
                int separator = Node_modules_Tsumo_engine_src_template_evaluation_structuredData.yamlMappingSeparator(line.content);
                if (separator < 0)
                {
                ...
                string valueText = Tsonic.CSharp.Js.String.trim(Node_modules_Tsumo_engine_src_utils_strings.substringFrom(line.content, separator + 1));
                current++;
                if (valueText != "")
                {
                    YamlBlockScalarHeader? blockHeader = this.parseBlockScalarHeader(valueText, line.lineNumber);
                ...
                if (current >= this.lines.length || this.lines[current].indent <= indent)
                {
                    fields.set(key, Node_modules_Tsumo_engine_src_template_runtimeHelpers.nil);
                    continue;
                }
                YamlParseResult nested = this.parseBlock(current, this.lines[current].indent);
        ...
        public YamlBlockScalarHeader? parseBlockScalarHeader(string value, int line)
        {
            ...
            for (int index = 1; index < value.Length; index++)
            {
                ...
                int? parsedIndentation = Node_modules_Tsumo_engine_src_utils_int32.parseInt32(character);
        ...
        public YamlParseResult parseBlockScalar(YamlBlockScalarHeader header, int parentIndent, int headerLine, int nextParsedIndex)
        {
            ...
            while (sourceEnd < this.sourceLines.length)
            {
                ...
                int indentation = Node_modules_Tsumo_engine_src_template_evaluation_structuredData.yamlSourceIndentation(raw, this.sourcePath, sourceEnd + 1);
            ...
            if (contentIndent is null)
            {
                for (int sourceIndex = sourceStart; sourceIndex < sourceEnd; sourceIndex++)
                {
                    ...
                    contentIndent = Node_modules_Tsumo_engine_src_template_evaluation_structuredData.yamlSourceIndentation(raw_1, this.sourcePath, sourceIndex + 1);
                    break;
                }
            }
            ...
            for (int sourceIndex_1 = sourceStart; sourceIndex_1 < sourceEnd; sourceIndex_1++)
            {
                ...
                int indentation_1 = Node_modules_Tsumo_engine_src_template_evaluation_structuredData.yamlSourceIndentation(raw_2, this.sourcePath, sourceIndex_1 + 1);
                if (indentation_1 < selectedIndent)
                {
                    throw this.error("YAML block scalar indentation is inconsistent", sourceIndex_1 + 1);
                }
                values.push(Node_modules_Tsumo_engine_src_utils_strings.substringFrom(raw_2, selectedIndent));
        ...
        public TemplateValue parseScalar(string value, int line)
        {
            ...
            ParamValue parsed = Node_modules_Tsumo_engine_src_utils_structuredScalars.parseStructuredScalar(value, "yaml", (string message) => Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_UNMARSHAL_YAML_INVALID", message, sourcePath, line, 1));
        ...
        {
            return Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_UNMARSHAL_YAML_INVALID", message, this.sourcePath, line, 1);
        }
    }
}
