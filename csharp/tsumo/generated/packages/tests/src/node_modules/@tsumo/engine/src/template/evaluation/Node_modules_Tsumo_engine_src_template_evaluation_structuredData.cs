...
namespace Tsumo.Tests
{
    public static class Node_modules_Tsumo_engine_src_template_evaluation_structuredData
    {
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            yamlError = (string message, string? sourcePath, int line) => Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_UNMARSHAL_YAML_INVALID", message, sourcePath, line, 1);
