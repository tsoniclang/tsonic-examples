...
namespace Tsumo.Engine
{
    public static class Menus
    {
        ...
        internal static Tsonic.CSharp.Js.JSArray<MenuEntry> sortHierarchy(Tsonic.CSharp.Js.JSArray<MenuEntry> entries)
        {
        ...
        internal static void assertAcyclicParents(Tsonic.CSharp.Js.JSArray<MenuEntry> entries, Tsonic.CSharp.Js.Map<string, MenuEntry> byIdentity)
        {
            for (double index = 0; index < entries.length; index++)
            {
        ...
        internal static void appendFlatMenuEntries(Tsonic.CSharp.Js.JSArray<MenuEntry> entries, Tsonic.CSharp.Js.JSArray<MenuEntry> result)
        {
            for (double index = 0; index < entries.length; index++)
            {
                MenuEntry entry = entries[index];
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            buildMenuHierarchy = (Tsonic.CSharp.Js.JSArray<MenuEntry> entries) =>
            {
                ...
                {
                    MenuEntry entry = entries[index];
                    entry.children = Tsonic.CSharp.Js.JSArray<MenuEntry>.of([]);
                ...
                Tsonic.CSharp.Js.JSArray<MenuEntry> topLevel = Tsonic.CSharp.Js.JSArray<MenuEntry>.of([]);
                for (double index_1 = 0; index_1 < entries.length; index_1++)
                {
            ...
            {
                Tsonic.CSharp.Js.JSArray<MenuEntry> result = Tsonic.CSharp.Js.JSArray<MenuEntry>.of([]);
