...
namespace Tsumo.Engine
{
    ...
    {
        public static Func<string, string, string> resolveDocsOutputPath
        {
            get;
            private set;
        } = default(Func<string, string, string>)!;
        public static Func<string, string> docsOutputPathForPermalink
        {
            get;
            private set;
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            resolveDocsOutputPath = (string outputRoot, string relativePath) =>
            {
            ...
            docsOutputPathForPermalink = (string permalink) =>
            {
    ...
    public class DocsOutputClaims
    {
        ...
        public void add(string outputRelPath, string sourcePath)
        {
            ...
            string? previous = Tsonic.CSharp.Js.Map.getReference<string, string>(this.sourcesByOutputPath, key);
