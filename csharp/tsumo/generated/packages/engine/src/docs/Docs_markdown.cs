...
namespace Tsumo.Engine
{
    public static class Docs_markdown
    {
        ...
        internal static bool isUnsafeUrl(string url)
        {
            string lower = Tsonic.CSharp.Js.String.toLowerCase(Tsonic.CSharp.Js.String.trim(url));
        ...
        internal static bool isMarkdownLink(string path)
        {
        ...
        internal static string? maybeRewriteUrl(string? urlValue, DocsLinkRewriteContext ctx)
        {
        ...
        internal static void rewriteInInlines(Markdig.Syntax.Inlines.ContainerInline container, DocsLinkRewriteContext ctx)
        {
        ...
        internal static void rewriteInBlock(Markdig.Syntax.Block block, DocsLinkRewriteContext ctx)
        {
            if ((object?)block is Markdig.Syntax.LeafBlock)
            {
                ...
                if ((object?)(Markdig.Syntax.LeafBlock)block is Markdig.Syntax.LinkReferenceDefinition)
                {
        ...
        internal static void rewriteLinks(Markdig.Syntax.MarkdownDocument document, DocsLinkRewriteContext ctx)
        {
        ...
        internal static int findSummaryDividerIndex(string markdown)
        {
            return Utils_strings.indexOfTextIgnoreCase(markdown, summaryMarker);
        }
        internal static string firstBlock(string markdown)
        {
        ...
        internal static string renderWithRewrites(string markdown, DocsLinkRewriteContext ctx)
        {
