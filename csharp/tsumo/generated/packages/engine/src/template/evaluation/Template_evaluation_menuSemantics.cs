...
namespace Tsumo.Engine
{
    ...
    {
        internal static bool menuEntryRepresentsPage(MenuEntry entry, PageContext page)
        {
        ...
        internal static bool menuEntryBelongsToMenu(MenuEntry entry, string menuName)
        {
            return entry.menu == menuName;
        }
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            hasMenuCurrent = (PageContext page, string menuName, MenuEntry entry) =>
            {
                ...
                Tsonic.CSharp.Js.JSArray<MenuEntry> pending = Tsonic.CSharp.Js.JSArray<MenuEntry>.of([]);
                for (double index = 0; index < entry.children.length; index++)
                {
                ...
                while (pending.length > 0)
                {
                    ...
                    for (double index_1 = 0; index_1 < candidate.children.length; index_1++)
                    {
