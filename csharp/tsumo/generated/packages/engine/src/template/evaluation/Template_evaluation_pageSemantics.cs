...
namespace Tsumo.Engine
{
    public static class Template_evaluation_pageSemantics
    {
        ...
        {
            for (double leftIndex = 0; leftIndex < left.length; leftIndex++)
            {
                for (double rightIndex = 0; rightIndex < right.length; rightIndex++)
                {
        ...
        internal static PageArrayValue defaultRelatedPages(Tsonic.CSharp.Js.JSArray<PageContext> pages, PageContext source)
        {
            ...
            for (double left = 0; left < candidates.length; left++)
            {
                for (double right = left + 1; right < candidates.length; right++)
                {
            ...
            for (double index_1 = 0; index_1 < candidates.length; index_1++)
            {
        ...
        internal static double pageDateMilliseconds(PageContext page)
        {
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            toPages = (TemplateValue value) =>
            {
                ...
                if ((object?)value is AnyArrayValue)
                {
                    ...
                    for (double i = 0; i < ((AnyArrayValue)value).value.length; i++)
                    {
            ...
            callPageCollectionMethod = (PageArrayValue collection, string method, Tsonic.CSharp.Js.JSArray<TemplateValue> args) =>
            {
                ...
                {
                    double count = (object?)args[0] is NumberValue ? ((NumberValue)args[0]).value : 0;
                    Tsonic.CSharp.Js.JSArray<PageContext> result = Tsonic.CSharp.Js.JSArray<PageContext>.of([]);
            ...
            groupPagesByDate = (Tsonic.CSharp.Js.JSArray<PageContext> pages, string layout, bool ascending) =>
            {
                ...
                for (double left = 0; left < ordered.length; left++)
                {
                    for (double right = left + 1; right < ordered.length; right++)
                    {
                ...
                for (double index = 0; index < ordered.length; index++)
                {
                ...
                Tsonic.CSharp.Js.JSArray<TemplateValue> result = Tsonic.CSharp.Js.JSArray<TemplateValue>.of([]);
                for (double index_1 = 0; index_1 < keys.length; index_1++)
                {
            ...
            copyStringArray = (Tsonic.CSharp.Js.JSArray<string> strings) =>
            {
                ...
                for (double i = 0; i < strings.length; i++)
                {
                    copy.push(strings[i]);
                }
                return copy;
            ...
            matchWhere = (TemplateValue actual, string op, TemplateValue expected) =>
            {
                ...
                if (opLower == "in")
                {
                    ...
                    {
                        for (double i = 0; i < ((AnyArrayValue)expected).value.length; i++)
                        {
                    ...
                    {
                        for (double i_1 = 0; i_1 < ((StringArrayValue)expected).value.length; i_1++)
                        {
