...
namespace Tsumo.Engine
{
    public static class Template_evaluation_scalarSemantics
    {
        ...
        internal static string stripLeadingZero(string value)
        {
            return Tsonic.CSharp.Js.String.startsWith(value, "0") ? Tsonic.CSharp.Js.String.slice(value, 1) : value;
        }
        internal static int weekdayIndex(double milliseconds)
        {
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            longWeekdays = Tsonic.CSharp.Js.JSArray<string>.of(["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"]);
            shortWeekdays = Tsonic.CSharp.Js.JSArray<string>.of(["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"]);
            longMonths = Tsonic.CSharp.Js.JSArray<string>.of(["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"]);
            shortMonths = Tsonic.CSharp.Js.JSArray<string>.of(["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]);
