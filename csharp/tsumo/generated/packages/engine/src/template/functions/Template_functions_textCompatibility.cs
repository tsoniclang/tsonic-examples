...
namespace Tsumo.Engine
{
    ...
    {
        internal static Tsonic.CSharp.Js.Map<string, string> createEmojiShortcodes()
        {
        ...
        internal static bool isAsciiLetterOrDigit(string character)
        {
            double code = Tsonic.CSharp.Js.String.charCodeAt(character, 0);
            return ((code >= 48 && code <= 57) || (code >= 65 && code <= 90) || (code >= 97 && code <= 122));
        }
        internal static bool isAsciiWhitespace(string character)
        {
