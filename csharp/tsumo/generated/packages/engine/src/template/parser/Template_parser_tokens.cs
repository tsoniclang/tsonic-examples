...
namespace Tsumo.Engine
{
    ...
    {
        internal static TemplatePosition positionAt(IndexedSourceText source, Tsonic.CSharp.Js.JSArray<int> lineStarts, int offset)
        {
            int low = 0;
        ...
        internal static int findDelimiter(IndexedSourceText source, string first, string second, int start)
        {
