...
namespace Tsumo.Engine
{
    ...
    {
        public static Func<string, string, string> trimLeadingCharacter
        {
            get;
            private set;
        } = default(Func<string, string, string>)!;
        public static Func<string, string, string> trimTrailingCharacter
        {
            get;
            private set;
        } = default(Func<string, string, string>)!;
        ...
        {
            trimLeadingCharacter = (string value, string character) => Tsonic.CSharp.Js.String.startsWith(value, character) ? Tsonic.CSharp.Js.String.slice(value, character.Length) : value;
            trimTrailingCharacter = (string value, string character) => Tsonic.CSharp.Js.String.endsWith(value, character) ? Tsonic.CSharp.Js.String.slice(value, 0, value.Length - character.Length) : value;
            return null;
        }
