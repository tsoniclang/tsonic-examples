namespace Tsumo.Engine
{
    ...
    public class TemplateEnvironment
    {
        ...
        public TemplateEnvironment(Tsonic.CSharp.Js.Date? buildTime = null, DictValue? siteData = null)
        {
            ...
            this.deferredRequests = Tsonic.CSharp.Js.JSArray<DeferredTemplateRequest>.of([]);
            this.deferredPlacements = Tsonic.CSharp.Js.JSArray<DeferredTemplatePlacement>.of([]);
