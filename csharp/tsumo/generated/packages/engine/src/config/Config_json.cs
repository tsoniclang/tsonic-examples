...
namespace Tsumo.Engine
{
    public static class Config_json
    {
        ...
        internal static JsonObject requireObject(string field, JsonValue value, string? sourcePath)
        {
        ...
        internal static JsonArray requireArray(string field, JsonValue value, string? sourcePath)
        {
        ...
        internal static void applyLanguageField(LanguageConfigBuilder builder, string field, JsonValue value, string? sourcePath)
        {
        ...
        internal static void applyMenuField(MenuEntryBuilder builder, string field, JsonValue value, string? sourcePath)
        {
            string normalized = Tsonic.CSharp.Js.String.toLowerCase(field);
            if (normalized == "name")
            {
