...
namespace Tsumo.Engine
{
    ...
    {
        internal static ParsedContent? tryParseJsonFrontMatter(string text, string? sourcePath)
        {
            int start = 0;
        ...
        internal static ParsedContent parseDelimitedFrontMatter(Tsonic.CSharp.Js.JSArray<string> lines, string delimiter, string format, string? sourcePath)
        {
            Tsonic.CSharp.Js.JSArray<string> frontMatterLines = Tsonic.CSharp.Js.JSArray<string>.of([]);
