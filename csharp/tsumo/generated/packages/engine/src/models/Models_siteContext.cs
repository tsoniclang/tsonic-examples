namespace Tsumo.Engine
{
    ...
    public class SiteContext
    {
        ...
        public SiteContext(SiteConfig config, Tsonic.CSharp.Js.JSArray<PageContext> pages, LanguageConfig? languageRaw, Tsonic.CSharp.Js.JSArray<LanguageContext>? allLanguagesRaw)
        {
            ...
            {
                Tsonic.CSharp.Js.JSArray<LanguageContext> langs = Tsonic.CSharp.Js.JSArray<LanguageContext>.of([this.Language]);
            ...
            this.allPages = pages;
            this.home = null;
            Tsonic.CSharp.Js.JSArray<DocsMountContext> empty = Tsonic.CSharp.Js.JSArray<DocsMountContext>.of([]);
            this.docsMounts = empty;
            Tsonic.CSharp.Js.JSArray<SiteContext> emptySites = Tsonic.CSharp.Js.JSArray<SiteContext>.of([]);
        ...
        public Tsonic.CSharp.Js.JSArray<OutputFormat> getOutputFormats()
        {
            ...
            Tsonic.CSharp.Js.JSArray<OutputFormat> formats = Tsonic.CSharp.Js.JSArray<OutputFormat>.of([rss]);
            return formats;
        }
    }
}
