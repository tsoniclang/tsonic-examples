...
namespace Tsumo.Engine
{
    ...
    {
        internal static string cacheKeyPart(string value)
        {
            return $"{value.Length}:{value}";
        }
        internal static string sourceExtension(Resource resource)
        {
        ...
        internal static string outputRelativePath(Resource resource, JavaScriptBuildOptions options)
        {
