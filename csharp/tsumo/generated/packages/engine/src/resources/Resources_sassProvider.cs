        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            compileSassResource = (Resource resource, Tsonic.CSharp.Js.JSArray<string> loadPaths) =>
            {
                ...
                try
                {
                    ...
                    Tsonic.CSharp.Js.JSArray<string> argumentsList = implementation == "dart-sass" ? Tsonic.CSharp.Js.JSArray<string>.of(["--no-source-map", "--style", "expanded"]) : Tsonic.CSharp.Js.JSArray<string>.of(["-t", "expanded"]);
                    for (double index = 0; index < loadPaths.length; index++)
                    {
