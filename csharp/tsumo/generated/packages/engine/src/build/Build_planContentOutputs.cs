...
namespace Tsumo.Engine
{
    ...
    {
        internal static string outputDirectory(string relativePath)
        {
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            {
                for (double index = 0; index < graph.pageSources.length; index++)
                {
                    ...
                    Tsonic.CSharp.Js.JSArray<string> candidates = layout is not null && Tsonic.CSharp.Js.String.trim(layout) != "" ? Tsonic.CSharp.Js.JSArray<string>.of([$"{templateType}/{layout}.html", $"{source.section}/{layout}.html", $"_default/{layout}.html", $"{layout}.html", $"{templateType}/single.html", $"{source.section}/single.html", "_default/single.html"]) : Tsonic.CSharp.Js.JSArray<string>.of([$"{templateType}/single.html", source.section != "" ? $"{source.section}/single.html" : "_default/single.html", "_default/single.html"]);
                    string main = Build_layout.selectTemplate(environment, candidates) ?? templates.single;
                    string? @base = Build_layout.selectTemplate(environment, templateType != "" ? Tsonic.CSharp.Js.JSArray<string>.of([$"{templateType}/baseof.html", $"{source.section}/baseof.html", "_default/baseof.html", "baseof.html"]) : Tsonic.CSharp.Js.JSArray<string>.of(["_default/baseof.html", "baseof.html"])) ?? templates.@base;
