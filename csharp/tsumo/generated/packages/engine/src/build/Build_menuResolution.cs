...
namespace Tsumo.Engine
{
    ...
    {
        internal static string normalizePageReference(string value)
        {
            return Tsonic.CSharp.Js.String.toLowerCase(Utils_strings.trimEndChar(Utils_strings.trimStartChar(Tsonic.CSharp.Js.String.trim(value), "/"), "/"));
        }
