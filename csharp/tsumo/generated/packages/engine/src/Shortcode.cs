...
namespace Tsumo.Engine
{
    ...
    {
        internal static string parseQuotedString(ParseState state, string? sourcePath, int line, int column)
        {
        ...
        internal static string parseUnquotedValue(ParseState state)
        {
            string result = "";
            while (!state.atEnd())
            {
        ...
        internal static ObjectShape_0b74f910f8f5 parseParams(string argsText, string? sourcePath, int line, int column)
        {
            Tsonic.CSharp.Js.Map<string, ParamValue> @params = new Tsonic.CSharp.Js.Map<string, ParamValue>();
            Tsonic.CSharp.Js.JSArray<string> positional = Tsonic.CSharp.Js.JSArray<string>.of([]);
            bool isNamed = false;
            ...
            return new ObjectShape_d8df0b9373c7
            {
        ...
        internal static ObjectShape_ec37db37c8f1? findClosingTag(string text, string name, int startPos, bool isMarkdown)
        {
            ...
            while (pos < text.Length)
            {
                ...
                if (Tsonic.CSharp.Js.String.startsWith(remaining, closeTagPrefix) || Tsonic.CSharp.Js.String.startsWith(remaining, closeTagPrefix2))
                {
                    ...
                    if (depth == 0)
                    {
                        ...
                        return new ObjectShape_d9144763d433
                        {
                            inner = inner,
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            {
                Tsonic.CSharp.Js.JSArray<ShortcodeCall> results = Tsonic.CSharp.Js.JSArray<ShortcodeCall>.of([]);
                if (!Tsonic.CSharp.Js.String.includes(text, "{{<") && !Tsonic.CSharp.Js.String.includes(text, "{{%"))
                {
                    return results;
                }
                ...
                while (pos < text.Length)
                {
                    ...
                    ObjectShape_0b74f910f8f5 parsed = parseParams(argsText, sourcePath, position_2.line, position_2.column);
                    ...
                    ObjectShape_ec37db37c8f1? closeResult = findClosingTag(text, name, tagEndPos, isMarkdown);
            ...
            collectShortcodeNames = (string text, string? sourcePath) =>
            {
                ...
                Tsonic.CSharp.Js.JSArray<string> pending = Tsonic.CSharp.Js.JSArray<string>.of([text]);
    ...
    public class ShortcodeSourceMap
    {
        ...
        public ShortcodeSourceMap(string text)
        {
            ...
            this.codeFences = Tsonic.CSharp.Js.JSArray<ShortcodeRange>.of([]);
            int fenceStart = -1;
