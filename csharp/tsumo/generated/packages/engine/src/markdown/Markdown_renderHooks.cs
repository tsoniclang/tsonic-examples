...
namespace Tsumo.Engine
{
    public static class Markdown_renderHooks
    {
        ...
        internal static Markdig.Parsers.HtmlBlockParser getHtmlBlockParser()
        {
        ...
        internal static string renderInlineChildrenToHtml(Markdig.Syntax.Inlines.ContainerInline container)
        {
        ...
        internal static string renderLinkHookTemplate(Template template, LinkHookValue hookValue, SiteContext site, TemplateEnvironment env)
        {
        ...
        internal static string renderImageHookTemplate(Template template, ImageHookValue hookValue, SiteContext site, TemplateEnvironment env)
        {
            Tsonic.CSharp.Js.Map<string, Tsonic.CSharp.Js.JSArray<TemplateNode>> emptyOverrides = new Tsonic.CSharp.Js.Map<string, Tsonic.CSharp.Js.JSArray<TemplateNode>>();
            return env.renderTemplate(template, hookValue, site, emptyOverrides);
        }
        internal static string renderHeadingHookTemplate(Template template, HeadingHookValue hookValue, SiteContext site, TemplateEnvironment env)
        {
            Tsonic.CSharp.Js.Map<string, Tsonic.CSharp.Js.JSArray<TemplateNode>> emptyOverrides = new Tsonic.CSharp.Js.Map<string, Tsonic.CSharp.Js.JSArray<TemplateNode>>();
            return env.renderTemplate(template, hookValue, site, emptyOverrides);
        }
        internal static void rewriteInlinesForHooks(Markdig.Syntax.Inlines.ContainerInline container, RenderHookContext hookCtx)
        {
            Tsonic.CSharp.Js.JSArray<Markdig.Syntax.Inlines.LinkInline> linksToRewrite = Tsonic.CSharp.Js.JSArray<Markdig.Syntax.Inlines.LinkInline>.of([]);
            ...
            while (it.MoveNext())
            {
                ...
                if ((object?)inline is Markdig.Syntax.Inlines.LinkInline)
                {
        ...
        internal static void rewriteBlocksForHooks(Markdig.Syntax.ContainerBlock containerBlock, RenderHookContext hookCtx)
        {
            Tsonic.CSharp.Js.JSArray<Markdig.Syntax.HeadingBlock> headingsToRewrite = Tsonic.CSharp.Js.JSArray<Markdig.Syntax.HeadingBlock>.of([]);
            Tsonic.CSharp.Js.JSArray<int> headingIndices = Tsonic.CSharp.Js.JSArray<int>.of([]);
            ...
            while (blockIt.MoveNext())
            {
                ...
                if ((object?)block is Markdig.Syntax.HeadingBlock && hookCtx.headingHook is not null)
                {
                ...
                if ((object?)block is Markdig.Syntax.LeafBlock)
                {
        ...
        internal static void applyRenderHooksToAst(Markdig.Syntax.MarkdownDocument document, RenderHookContext hookCtx)
        {
