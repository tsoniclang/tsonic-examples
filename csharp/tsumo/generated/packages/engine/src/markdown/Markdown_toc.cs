...
namespace Tsumo.Engine
{
    public static class Markdown_toc
    {
        ...
        public static Action<Markdig.Syntax.Inlines.Inline, TextBuilder> appendInlinePlainText
        {
            get;
            private set;
        } = default(Action<Markdig.Syntax.Inlines.Inline, TextBuilder>)!;
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            appendInlinePlainText = (Markdig.Syntax.Inlines.Inline inline, TextBuilder output) =>
            {
            ...
            generateTableOfContents = (string markdown) =>
            {
                ...
                Tsonic.CSharp.Js.JSArray<TocListFrame> listStack = new Tsonic.CSharp.Js.JSArray<TocListFrame>(new TocListFrame[] { });
                int currentLevel = 0;
