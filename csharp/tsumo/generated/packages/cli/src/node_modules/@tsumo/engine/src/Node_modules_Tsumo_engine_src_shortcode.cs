...
namespace Tsumo.Cli
{
    public static class Node_modules_Tsumo_engine_src_shortcode
    {
        ...
        public static Func<string, string?, int, int, ObjectShape_5c9886b59427> parseParams
        {
            get;
            private set;
        } = default(Func<string, string?, int, int, ObjectShape_5c9886b59427>)!;
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            parseParams = (string argsText, string? sourcePath, int line, int column) =>
            {
                ...
                return new ObjectShape_5c9886b59427
                {
            ...
            parseShortcodes = (string text, string? sourcePath) =>
            {
                ...
                while (pos < text.Length)
                {
                    ...
                    ObjectShape_5c9886b59427 parsed = parseParams(argsText, sourcePath, position_2.line, position_2.column);
