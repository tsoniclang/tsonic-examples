...
namespace Tsumo.Cli
{
    public static class Node_modules_Tsumo_engine_src_frontmatter_scalars
    {
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            parseFrontMatterParam = (string value, string format, string? sourcePath, int? line) => Node_modules_Tsumo_engine_src_utils_structuredScalars.parseStructuredScalar(value, format, (string message) => Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_FRONTMATTER_SCALAR_INVALID", message, sourcePath, line, 1));
            parseFrontMatterString = (string value, string field, string format, string? sourcePath, int? line) =>
            {
                ...
                throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_FRONTMATTER_FIELD_INVALID", $"Front matter field '{field}' requires a string", sourcePath, line, 1);
            };
            recordFrontMatterField = (Tsonic.CSharp.Js.Set<string> fields, string field, string context, string? sourcePath, int? line) =>
            {
                ...
                {
                    throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_FRONTMATTER_FIELD_DUPLICATE", $"{context} field '{field}' is declared more than once", sourcePath, line, 1);
                }
            ...
            parseFrontMatterInt = (string value, string field, string format, string? sourcePath, int? line) =>
            {
                ...
                {
                    throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_FRONTMATTER_INVALID_INTEGER", $"Front matter field '{field}' requires a 32-bit integer", sourcePath, line, 1);
                }
            ...
            parseFrontMatterStringArray = (string value, string field, string format, string? sourcePath, int? line) =>
            {
                ...
                {
                    throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_FRONTMATTER_INVALID_STRING_ARRAY", $"Front matter field '{field}' requires a string array", sourcePath, line, 1);
                }
                string inner = Node_modules_Tsumo_engine_src_utils_strings.substringCount(trimmed, 1, trimmed.Length - 2);
                ...
                for (int index = 0; index <= inner.Length; index++)
                {
                    ...
                    string item = Tsonic.CSharp.Js.String.trim(Node_modules_Tsumo_engine_src_utils_strings.substringCount(inner, start, index - start));
                    if (item == "")
                    {
                        throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_FRONTMATTER_INVALID_STRING_ARRAY", $"Front matter field '{field}' contains an empty array item", sourcePath, line, 1);
                    }
                ...
                if (quote != "")
                {
                    throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_FRONTMATTER_STRING_INVALID", $"Front matter field '{field}' contains an unterminated string", sourcePath, line, 1);
                }
                return values;
            };
            applyFrontMatterScalar = (FrontMatter frontMatter, string keyRaw, string valueRaw, string format, string? sourcePath, int? line) =>
            {
                ...
                else
                {
                    if (key == "date")
                    {
                        ...
                        {
                            throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_FRONTMATTER_INVALID_DATE", $"Invalid front matter date: {authored}", sourcePath, line, 1);
                        }
                    ...
                    else
                    {
                        if (key == "draft")
                        {
                            ...
                            {
                                throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_FRONTMATTER_INVALID_BOOL", $"Front matter field '{Tsonic.CSharp.Js.String.trim(keyRaw)}' requires true or false", sourcePath, line, 1);
                            }
