...
namespace Tsumo.Cli
{
    public static class Node_modules_Tsumo_engine_src_docs_url
    {
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            splitUrlSuffix = (string url) =>
            {
                ...
                return new UrlSuffixSplit(Node_modules_Tsumo_engine_src_utils_strings.substringCount(url, 0, cut), Node_modules_Tsumo_engine_src_utils_strings.substringFrom(url, cut));
            };
            return null;
        }
