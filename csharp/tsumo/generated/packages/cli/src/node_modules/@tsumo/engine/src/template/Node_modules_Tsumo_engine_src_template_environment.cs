namespace Tsumo.Cli
{
    public static class Node_modules_Tsumo_engine_src_template_environment
    {
    ...
    public class TemplateEnvironment
    {
        ...
        public string registerDeferredTemplate(DeferredTemplateValue value, Tsonic.CSharp.Js.JSArray<TemplateNode> body, Tsonic.CSharp.Js.Map<string, Tsonic.CSharp.Js.JSArray<TemplateNode>> definitions, string? sourcePath, string sourceText, int sourceSegmentIndex, SiteContext site, Tsonic.CSharp.Js.Map<string, Tsonic.CSharp.Js.JSArray<TemplateNode>> overrides, RenderState state)
        {
            ...
            {
                throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_DEFER_LIFECYCLE_INVALID", "templates.Defer cannot register work after deferred-template finalization begins");
            }
        ...
        public Tsonic.CSharp.Js.Map<string, string> finalizeDeferredTemplates()
        {
            ...
            {
                throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_DEFER_LIFECYCLE_INVALID", "Deferred-template finalization is already running");
            }
            if (this.deferredPhase == "collecting")
            {
            ...
            for (double index_1 = 0; index_1 < this.deferredPlacements.length; index_1++)
            {
                ...
                if (result is null)
                {
                    throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_DEFER_LIFECYCLE_INVALID", "A deferred template has no finalized output");
                }
        ...
        {
            throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_ENVIRONMENT_OPERATION_UNAVAILABLE", "TemplateEnvironment.getTemplate is not implemented");
        }
        ...
        public PartialTemplateResolution? resolvePartialTemplate(string name, string? callerSourcePath, Tsonic.CSharp.Js.Map<string, Tsonic.CSharp.Js.JSArray<TemplateNode>> definitions)
        {
            ...
            Tsonic.CSharp.Js.JSArray<string> candidates = Node_modules_Tsumo_engine_src_template_paths.partialTemplateCandidates(name, callerRelativePath);
        ...
        {
            throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_ENVIRONMENT_OPERATION_UNAVAILABLE", "TemplateEnvironment.renderTextTemplateSource is not implemented");
        }
        ...
        {
            throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_ENVIRONMENT_OPERATION_UNAVAILABLE", "TemplateEnvironment.renderTemplate is not implemented");
        }
        ...
        {
            throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_ENVIRONMENT_OPERATION_UNAVAILABLE", "TemplateEnvironment.renderTextTemplate is not implemented");
        }
        ...
        {
            throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_ENVIRONMENT_OPERATION_UNAVAILABLE", "TemplateEnvironment.renderTemplateDefinition is not implemented");
        }
