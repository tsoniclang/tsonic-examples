namespace Tsumo.Cli
{
    public static class Node_modules_Tsumo_engine_src_i18n
    {
        ...
        internal static string i18nText(TemplateValue value, string identity, string sourcePath)
        {
            ...
            throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_I18N_MESSAGE_VALUE_INVALID", $"Internationalization message '{identity}' must contain text values", sourcePath);
        }
        internal static I18nMessage? messageFromValue(TemplateValue value, string identity, string sourcePath)
        {
            ...
            foreach (string key in fields.keys())
            {
                ...
                if (field is null)
                {
                    throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_I18N_MESSAGE_INCONSISTENT", $"Internationalization variant '{identity}.{key}' disappeared", sourcePath);
                }
        ...
        internal static void setLayerMessage(Tsonic.CSharp.Js.Map<string, I18nMessage> layer, string identity, I18nMessage message, string sourcePath)
        {
            if (identity == "")
            {
                throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_I18N_MESSAGE_IDENTITY_INVALID", "Internationalization message identity cannot be empty", sourcePath);
            }
            if (layer.has(identity))
            {
                throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_I18N_MESSAGE_CONFLICT", $"Internationalization message '{identity}' is declared more than once in the same layer", sourcePath);
            }
        ...
        internal static void collectMessageTree(TemplateValue value, string identity, Tsonic.CSharp.Js.Map<string, I18nMessage> layer, string sourcePath)
        {
            ...
            if (!((object?)value is DictValue))
            {
                throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_I18N_MESSAGE_SHAPE_INVALID", $"Internationalization value '{identity}' must be text or a message dictionary", sourcePath);
            }
            foreach (string key in ((DictValue)value).value.keys())
            {
                ...
                if (child is null)
                {
                    throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_I18N_MESSAGE_INCONSISTENT", $"Internationalization value '{key}' disappeared", sourcePath);
                }
        ...
        internal static void collectLegacyMessages(AnyArrayValue values, Tsonic.CSharp.Js.Map<string, I18nMessage> layer, string sourcePath)
        {
            for (int index = 0; index < values.value.length; index++)
            {
                ...
                {
                    throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_I18N_MESSAGE_SHAPE_INVALID", "Internationalization message list entries must be dictionaries", sourcePath);
                }
                ...
                {
                    throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_I18N_MESSAGE_SHAPE_INVALID", "Internationalization message list entries require text 'id' and 'translation' fields", sourcePath);
                }
                I18nMessage? message = messageFromValue(translation, ((StringValue)identityValue).value, sourcePath);
                if (message is null)
                {
                    throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_I18N_MESSAGE_SHAPE_INVALID", $"Internationalization message '{((StringValue)identityValue).value}' has an invalid translation", sourcePath);
                }
        ...
        {
            TemplateValue value = Node_modules_Tsumo_engine_src_template_evaluation_structuredData.parseTemplateDataText(content, format, sourcePath);
    ...
    public class I18nMessage
    {
        ...
        public string select(int? count)
        {
            ...
            for (int index = 0; index < Node_modules_Tsumo_engine_src_i18n.pluralVariantNames.length; index++)
            {
                string? value = Tsonic.CSharp.Js.Map.getReference<string, string>(this.variants, Node_modules_Tsumo_engine_src_i18n.pluralVariantNames[index]);
                if (value is not null)
                {
                    return value;
                }
            }
            throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_I18N_MESSAGE_EMPTY", "An internationalization message has no text variants");
        }
    }
    public class I18nStore
    {
        ...
        {
            Tsonic.CSharp.Js.JSArray<string> files = Node_modules_Tsumo_engine_src_fs.listFilesTopDirectory(dir, "*");
            files.sort();
            ...
            for (int index = 0; index < files.length; index++)
            {
                ...
                Node_modules_Tsumo_engine_src_i18n.collectI18nFile(Node_modules_Tsumo_engine_src_fs.readTextFile(file), format, file, languageLayer);
            }
            foreach (string language_1 in layer.keys())
            {
                ...
                if (messages is null)
                {
                    throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_I18N_LAYER_INCONSISTENT", $"Internationalization layer '{language_1}' disappeared", dir);
                }
                foreach (string identity in messages.keys())
                {
                    ...
                    if (message is null)
                    {
                        throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_I18N_LAYER_INCONSISTENT", $"Internationalization message '{identity}' disappeared", dir);
                    }
