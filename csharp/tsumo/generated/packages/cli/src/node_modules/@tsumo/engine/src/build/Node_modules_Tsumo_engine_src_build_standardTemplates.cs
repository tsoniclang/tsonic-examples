...
namespace Tsumo.Cli
{
    public static class Node_modules_Tsumo_engine_src_build_standardTemplates
    {
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            selectStandardTemplates = (BuildEnvironment environment) =>
            {
                ...
                string list = Node_modules_Tsumo_engine_src_build_layout.selectTemplate(environment, listCandidates) ?? listCandidates[0];
                return new StandardTemplates(Node_modules_Tsumo_engine_src_build_layout.selectTemplate(environment, baseCandidates), Node_modules_Tsumo_engine_src_build_layout.selectTemplate(environment, homeCandidates) ?? list, list, Node_modules_Tsumo_engine_src_build_layout.selectTemplate(environment, singleCandidates) ?? singleCandidates[0]);
            };
            return null;
        }
