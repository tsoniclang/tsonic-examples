...
namespace Tsumo.Cli
{
    public static class Node_modules_Tsumo_engine_src_docs_config
    {
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            docsConfigError = (string code, string message, string path) => Node_modules_Tsumo_engine_src_diagnostics.createTsumoError(code, message, path);
            ...
            normalizePrefix = (string raw) => Node_modules_Tsumo_engine_src_utils_text.ensureTrailingSlash(Node_modules_Tsumo_engine_src_utils_text.ensureLeadingSlash(Tsonic.CSharp.Js.String.trim(raw)));
