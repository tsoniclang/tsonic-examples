...
namespace Tsumo.Cli
{
    public static class Node_modules_Tsumo_engine_src_markdown_renderHooks
    {
        ...
        internal static string renderInlineChildrenToHtml(Markdig.Syntax.Inlines.ContainerInline container)
        {
            ...
            Node_modules_Tsumo_engine_src_markdown_pipeline.setupRenderer(renderer);
        ...
        internal static string stripHtmlTags(string html)
        {
            ...
            {
                string c = Node_modules_Tsumo_engine_src_utils_strings.substringCount(html, i, 1);
                if (c == "<")
                {
                    inTag = true;
                    continue;
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            renderMarkdownWithHooks = (string markdown, RenderHookContext hookCtx) =>
            {
                ...
                return Markdig.Markdown.ToHtml(document, Node_modules_Tsumo_engine_src_markdown_pipeline.markdownPipeline);
            };
            return null;
        }
