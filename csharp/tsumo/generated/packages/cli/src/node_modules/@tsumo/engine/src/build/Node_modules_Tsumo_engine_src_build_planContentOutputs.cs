        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            planContentOutputs = (StandardPageGraph graph, BuildEnvironment environment, StandardTemplates templates, SiteOutputPlan outputPlan, Tsonic.CSharp.Js.Map<string, bool> sitemapUrls) =>
            {
                for (int index = 0; index < graph.pageSources.length; index++)
                {
                    ...
                    string? @base = Node_modules_Tsumo_engine_src_build_layout.selectTemplate(environment, templateType != "" ? new Tsonic.CSharp.Js.JSArray<string>(new string[] { $"{templateType}/baseof.html", $"{source.section}/baseof.html", "_default/baseof.html", "baseof.html" }) : new Tsonic.CSharp.Js.JSArray<string>(new string[] { "_default/baseof.html", "baseof.html" })) ?? templates.@base;
