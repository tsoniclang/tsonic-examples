...
namespace Tsumo.Cli
{
    public static class Node_modules_Tsumo_engine_src_template_scope
    {
    ...
    public class RenderScope
    {
        ...
        public PaginatorValue selectPaginator(PaginatorValue paginator)
        {
            ...
            if (existing is not null)
            {
                ...
                {
                    throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_TEMPLATE_PAGINATION_CONFLICT", "A rendered page cannot select more than one pagination source");
                }
                return existing;
            }
