...
namespace Tsumo.Cli
{
    public static class Node_modules_Tsumo_engine_src_template_evaluation_scalarSemantics
    {
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            isNumberLiteral = (string token) =>
            {
                ...
                return Node_modules_Tsumo_engine_src_utils_int32.parseInt32(token) is not null;
            };
            ...
            addCalendarDate = (string value, int years, int months, int days) =>
            {
                ...
                int? sourceYear = Node_modules_Tsumo_engine_src_utils_int32.parseInt32(Node_modules_Tsumo_engine_src_utils_strings.substringCount(iso, 0, 4));
                int? sourceMonth = Node_modules_Tsumo_engine_src_utils_int32.parseInt32(Node_modules_Tsumo_engine_src_utils_strings.substringCount(iso, 5, 2));
                int? sourceDay = Node_modules_Tsumo_engine_src_utils_int32.parseInt32(Node_modules_Tsumo_engine_src_utils_strings.substringCount(iso, 8, 2));
                int? hour = Node_modules_Tsumo_engine_src_utils_int32.parseInt32(Node_modules_Tsumo_engine_src_utils_strings.substringCount(iso, 11, 2));
                int? minute = Node_modules_Tsumo_engine_src_utils_int32.parseInt32(Node_modules_Tsumo_engine_src_utils_strings.substringCount(iso, 14, 2));
                int? second = Node_modules_Tsumo_engine_src_utils_int32.parseInt32(Node_modules_Tsumo_engine_src_utils_strings.substringCount(iso, 17, 2));
                int? millisecond = Node_modules_Tsumo_engine_src_utils_int32.parseInt32(Node_modules_Tsumo_engine_src_utils_strings.substringCount(iso, 20, 3));
                ...
                int? targetYear = Node_modules_Tsumo_engine_src_utils_int32.toInt32(targetYearValue);
                int? targetMonth = Node_modules_Tsumo_engine_src_utils_int32.toInt32(totalMonths - targetYearValue * 12);
                if (targetYear is null || targetMonth is null)
                {
                    return null;
                }
                string yearText = Node_modules_Tsumo_engine_src_utils_strings.zeroPadInteger(targetYear.Value, 4);
                string monthText = Node_modules_Tsumo_engine_src_utils_strings.zeroPadInteger(targetMonth.Value + 1, 2);
                string hourText = Node_modules_Tsumo_engine_src_utils_strings.zeroPadInteger(hour.Value, 2);
                string minuteText = Node_modules_Tsumo_engine_src_utils_strings.zeroPadInteger(minute.Value, 2);
                string secondText = Node_modules_Tsumo_engine_src_utils_strings.zeroPadInteger(second.Value, 2);
                string millisecondText = Node_modules_Tsumo_engine_src_utils_strings.zeroPadInteger(millisecond.Value, 3);
            ...
            formatDateTime = (string value, string layout) =>
            {
                ...
                string iso = new Tsonic.CSharp.Js.Date(milliseconds).toISOString();
                string year = Node_modules_Tsumo_engine_src_utils_strings.substringCount(iso, 0, 4);
                string month = Node_modules_Tsumo_engine_src_utils_strings.substringCount(iso, 5, 2);
                string day = Node_modules_Tsumo_engine_src_utils_strings.substringCount(iso, 8, 2);
                string hour24 = Node_modules_Tsumo_engine_src_utils_strings.substringCount(iso, 11, 2);
                string minute = Node_modules_Tsumo_engine_src_utils_strings.substringCount(iso, 14, 2);
                string second = Node_modules_Tsumo_engine_src_utils_strings.substringCount(iso, 17, 2);
                int monthIndex = (Node_modules_Tsumo_engine_src_utils_int32.parseInt32(month) ?? 1) - 1;
                int hourValue = Node_modules_Tsumo_engine_src_utils_int32.parseInt32(hour24) ?? 0;
                                                                        ...
                                                                        else
                                                                        {
                                                                            ...
                                                                            else
                                                                            {
                                                                                ...
                                                                                else
                                                                                {
                                                                                    ...
                                                                                    {
                                                                                        output.Append(Node_modules_Tsumo_engine_src_utils_strings.substringCount(layout, index, 1));
                                                                                        index += 1;
                                                                                    }
                                                                                }
                                                                            }
            ...
            {
                string f = layout;
                f = Node_modules_Tsumo_engine_src_utils_strings.replaceText(f, "Monday", "dddd");
                f = Node_modules_Tsumo_engine_src_utils_strings.replaceText(f, "Mon", "ddd");
                f = Node_modules_Tsumo_engine_src_utils_strings.replaceText(f, "January", "MMMM");
                f = Node_modules_Tsumo_engine_src_utils_strings.replaceText(f, "Jan", "MMM");
                f = Node_modules_Tsumo_engine_src_utils_strings.replaceText(f, "2006", "yyyy");
                f = Node_modules_Tsumo_engine_src_utils_strings.replaceText(f, "06", "yy");
                f = Node_modules_Tsumo_engine_src_utils_strings.replaceText(f, "02", "dd");
                f = Node_modules_Tsumo_engine_src_utils_strings.replaceText(f, "2", "d");
                f = Node_modules_Tsumo_engine_src_utils_strings.replaceText(f, "01", "MM");
                f = Node_modules_Tsumo_engine_src_utils_strings.replaceText(f, "1", "M");
                f = Node_modules_Tsumo_engine_src_utils_strings.replaceText(f, "15", "HH");
                f = Node_modules_Tsumo_engine_src_utils_strings.replaceText(f, "03", "hh");
                f = Node_modules_Tsumo_engine_src_utils_strings.replaceText(f, "3", "h");
                f = Node_modules_Tsumo_engine_src_utils_strings.replaceText(f, "04", "mm");
                f = Node_modules_Tsumo_engine_src_utils_strings.replaceText(f, "05", "ss");
                f = Node_modules_Tsumo_engine_src_utils_strings.replaceText(f, "PM", "tt");
                return f;
            };
            return null;
        }
