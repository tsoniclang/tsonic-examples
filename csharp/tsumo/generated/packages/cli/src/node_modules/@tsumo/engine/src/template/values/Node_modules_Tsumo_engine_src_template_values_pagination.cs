...
namespace Tsumo.Cli
{
    public static class Node_modules_Tsumo_engine_src_template_values_pagination
    {
    ...
    public class PaginatorValue : TemplateValue
    {
        ...
        public string url()
        {
            return this.pageNumber <= 1 ? Node_modules_Tsumo_engine_src_utils_urlPath.combineUrlPath(new Tsonic.CSharp.Js.JSArray<string>(new string[] { this.basePath })) : Node_modules_Tsumo_engine_src_utils_urlPath.combineUrlPath(new Tsonic.CSharp.Js.JSArray<string>(new string[] { this.basePath, "page", $"{this.pageNumber}" }));
        }
