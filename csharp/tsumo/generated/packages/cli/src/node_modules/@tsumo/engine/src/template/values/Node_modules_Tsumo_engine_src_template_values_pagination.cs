namespace Tsumo.Cli
{
    ...
    public class PaginatorValue : TemplateValue
    {
        ...
        public string url()
        {
            return this.pageNumber <= 1 ? Node_modules_Tsumo_engine_src_utils_urlPath.combineUrlPath(Tsonic.CSharp.Js.JSArray<string>.of([this.basePath])) : Node_modules_Tsumo_engine_src_utils_urlPath.combineUrlPath(Tsonic.CSharp.Js.JSArray<string>.of([this.basePath, "page", $"{this.pageNumber}"]));
        }
