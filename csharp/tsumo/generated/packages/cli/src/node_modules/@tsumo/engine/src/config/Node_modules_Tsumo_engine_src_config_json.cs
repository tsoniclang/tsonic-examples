...
namespace Tsumo.Cli
{
    public static class Node_modules_Tsumo_engine_src_config_json
    {
        public static TsumoError invalidField(string field, string expected, JsonValue value, string? sourcePath = null)
        {
            return Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_CONFIG_INVALID_FIELD", $"Configuration field '{field}' requires {expected}", sourcePath, value.line, value.column);
        }
        ...
        internal static void assertUniqueFields(JsonObject @object, string context, string? sourcePath)
        {
            ...
            for (double index = 0; index < @object.properties.length; index++)
            {
                ...
                if (names.has(name))
                {
                    throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_CONFIG_DUPLICATE_FIELD", $"{context} field '{property.key}' is declared more than once", sourcePath, property.line, property.column);
                }
                names.add(name);
            }
        }
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_CONFIG_UNKNOWN_FIELD", $"Unknown language configuration field '{field}'", sourcePath, value.line, value.column);
                        }
                    }
                }
            }
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_CONFIG_UNKNOWN_FIELD", $"Unknown menu configuration field '{field}'", sourcePath, value.line, value.column);
                                            }
                                        }
                                    }
                                }
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            parseJsonConfig = (string text, string? sourcePath) =>
            {
                                                ...
                                                else
                                                {
                                                    if (key == "menu")
                                                    {
                                                        ...
                                                        for (double menuIndex = 0; menuIndex < object_2.properties.length; menuIndex++)
                                                        {
                                                            ...
                                                            menus.set(menu.key, Node_modules_Tsumo_engine_src_menus.buildMenuHierarchy(entries));
                                                        }
                                                    }
                                                    else
                                                    {
                                                        throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_CONFIG_UNKNOWN_FIELD", $"Unknown configuration field '{property.key}'", sourcePath, property.line, property.column);
                                                    }
                                                }
                                            }
                                        }
                ...
                {
                    config.languages = Node_modules_Tsumo_engine_src_config_helpers.sortLanguages(languages);
