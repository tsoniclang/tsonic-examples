...
namespace Tsumo.Cli
{
    public static class Node_modules_Tsumo_engine_src_config_helpers
    {
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            tryGetFirstExisting = (Tsonic.CSharp.Js.JSArray<string> paths) =>
            {
                ...
                {
                    string p = paths[i];
                    if (Node_modules_Tsumo_engine_src_fs.fileExists(p))
                    {
                        return p;
                    }
                }
            ...
            sortLanguages = (Tsonic.CSharp.Js.JSArray<LanguageConfig> langs) =>
            {
                ...
                return copy.sort((LanguageConfig a, LanguageConfig b) =>
                {
                    ...
                    return byWeight != 0 ? byWeight : Node_modules_Tsumo_engine_src_utils_strings.compareText(a.lang, b.lang);
                });
            };
            return null;
        }
