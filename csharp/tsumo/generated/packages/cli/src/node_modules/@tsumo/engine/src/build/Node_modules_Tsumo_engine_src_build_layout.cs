...
namespace Tsumo.Cli
{
    public static class Node_modules_Tsumo_engine_src_build_layout
    {
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            resolveThemeDir = (string siteDir, SiteConfig config, string? themesDirRaw) =>
            {
                ...
                if (customThemesDir != "")
                {
                    ...
                    if (Node_modules_Tsumo_engine_src_fs.dirExists(candidate))
                    {
                        return candidate;
                    }
                }
                string themeDir = Tsonic.CSharp.Node.path.join(siteDir, "themes", themeName);
                return Node_modules_Tsumo_engine_src_fs.dirExists(themeDir) ? themeDir : null;
            };
