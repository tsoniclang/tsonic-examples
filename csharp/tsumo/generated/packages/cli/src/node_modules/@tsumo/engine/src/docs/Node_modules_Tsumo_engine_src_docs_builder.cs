...
namespace Tsumo.Cli
{
    public static class Node_modules_Tsumo_engine_src_docs_builder
    {
        ...
        private static object? __tsonic_module_init_core()
        {
            ...
            Node_modules_Tsumo_engine_src_docs_config.__tsonic_module_init();
            Node_modules_Tsumo_engine_src_docs_content.__tsonic_module_init();
            Node_modules_Tsumo_engine_src_docs_directoryGraph.__tsonic_module_init();
            Node_modules_Tsumo_engine_src_docs_editUrl.__tsonic_module_init();
            Node_modules_Tsumo_engine_src_docs_markdown.__tsonic_module_init();
            Node_modules_Tsumo_engine_src_docs_models.__tsonic_module_init();
            Node_modules_Tsumo_engine_src_docs_nav.__tsonic_module_init();
            Node_modules_Tsumo_engine_src_docs_output.__tsonic_module_init();
            Node_modules_Tsumo_engine_src_docs_routes.__tsonic_module_init();
            Node_modules_Tsumo_engine_src_docs_searchIndex.__tsonic_module_init();
            buildDocsSite = (BuildRequest request, LoadedDocsConfig docsLoaded, string outDir) =>
            {
                ...
                LoadedConfig loaded = Node_modules_Tsumo_engine_src_config_loader.loadSiteConfig(siteDir);
                ...
                {
                    config.baseURL = Node_modules_Tsumo_engine_src_utils_text.ensureTrailingSlash(Tsonic.CSharp.Js.String.trim(requestBaseURL));
                }
                ...
                string? baseTpl = Node_modules_Tsumo_engine_src_build_layout.selectTemplate(env, new Tsonic.CSharp.Js.JSArray<string>(new string[] { "_default/baseof.html" }));
                string homeTpl = Node_modules_Tsumo_engine_src_build_layout.selectTemplate(env, new Tsonic.CSharp.Js.JSArray<string>(new string[] { "index.html", "docs/home.html", "docs/list.html", "_default/list.html" })) ?? "_default/list.html";
                string listTpl = Node_modules_Tsumo_engine_src_build_layout.selectTemplate(env, new Tsonic.CSharp.Js.JSArray<string>(new string[] { "docs/list.html", "_default/list.html" })) ?? "_default/list.html";
                string singleTpl = Node_modules_Tsumo_engine_src_build_layout.selectTemplate(env, new Tsonic.CSharp.Js.JSArray<string>(new string[] { "docs/single.html", "_default/single.html" })) ?? "_default/single.html";
                ...
                for (int mountIndex = 0; mountIndex < mounts.length; mountIndex++)
                {
                    ...
                    DocsMountRoutes discovered = Node_modules_Tsumo_engine_src_docs_routes.discoverDocsMountRoutes(mount);
                    DocsContentInventory content = Node_modules_Tsumo_engine_src_docs_content.loadDocsContent(discovered.markdown, request.buildDrafts);
                    ...
                    mountContexts.push(new DocsMountContext(mount.name, mount.urlPrefix, Node_modules_Tsumo_engine_src_docs_nav.loadMountNav(mount, routeMap)));
                    Tsonic.CSharp.Js.JSArray<string> prefixSegs = Node_modules_Tsumo_engine_src_docs_routes.docsMountPrefixSegments(mount.urlPrefix);
                    ...
                    for (int i = 0; i < leafArr.length; i++)
                    {
                        ...
                        MarkdownResult md = Node_modules_Tsumo_engine_src_docs_markdown.renderDocsMarkdown(parsed.body, new DocsLinkRewriteContext(mount, r.sourcePath, r.dirKey, routeMap, docsConfig.strictLinks));
                        HtmlString content_1 = new HtmlString(md.html);
                        HtmlString summary = new HtmlString(md.summaryHtml);
                        string plainText = Markdig.Markdown.ToPlainText(parsed.body, Node_modules_Tsumo_engine_src_markdown_pipeline.markdownPipeline);
                        string baseName = Node_modules_Tsumo_engine_src_docs_routes.withoutMarkdownExtension(r.fileName);
                        string title = fm.title ?? Node_modules_Tsumo_engine_src_utils_text.humanizeSlug(baseName);
                        ...
                        string? editUrl = Node_modules_Tsumo_engine_src_docs_editUrl.createDocsEditUrl(mount, r.relPath);
                    ...
                    Node_modules_Tsumo_engine_src_docs_directoryGraph.addDocsDirectoryWithParents("", dirSet);
                    foreach (string indexKey in indexByDir.keys())
                    {
                        Node_modules_Tsumo_engine_src_docs_directoryGraph.addDocsDirectoryWithParents(indexKey, dirSet);
                    }
                    foreach (string leafKey in leafPagesByDir.keys())
                    {
                        Node_modules_Tsumo_engine_src_docs_directoryGraph.addDocsDirectoryWithParents(leafKey, dirSet);
                    }
                    ...
                    foreach (string childDirKey in dirSet.keys())
                    {
                        ...
                        string parentKey = Node_modules_Tsumo_engine_src_docs_directoryGraph.docsParentDirectory(childDirKey);
                    ...
                    {
                        int depth = Node_modules_Tsumo_engine_src_docs_directoryGraph.docsDirectoryDepth(b) - Node_modules_Tsumo_engine_src_docs_directoryGraph.docsDirectoryDepth(a);
                        return depth != 0 ? depth : Node_modules_Tsumo_engine_src_utils_strings.compareText(a, b);
                    });
                    ...
                    for (int i_1 = 0; i_1 < dirKeys.length; i_1++)
                    {
                        ...
                        {
                            childDirList.sort((string a, string b) => Node_modules_Tsumo_engine_src_utils_strings.compareText(a, b));
                        ...
                        {
                            leafList.sort((PageContext a, PageContext b) => Node_modules_Tsumo_engine_src_utils_strings.compareText(a.title, b.title));
                        ...
                        string relPermalink = Node_modules_Tsumo_engine_src_utils_urlPath.combineUrlPath(urlParts);
                        DocsContentRoute? idxRoute = Tsonic.CSharp.Js.Map.getReference<string, DocsContentRoute>(indexByDir, dirKey);
                        if (idxRoute is null)
                        {
                            outputClaims.add(Node_modules_Tsumo_engine_src_docs_output.docsOutputPathForPermalink(relPermalink), $"<generated docs section {mount.name}:{dirKey}>");
                        }
                        string dirSlug = dirKey == "" ? mountSection : Node_modules_Tsumo_engine_src_docs_directoryGraph.docsDirectoryName(dirKey);
                        string title_1 = dirKey == "" ? mount.name : Node_modules_Tsumo_engine_src_utils_text.humanizeSlug(dirSlug);
                        ...
                        if (idxRoute is not null)
                        {
                            ...
                            {
                                MarkdownResult md_1 = Node_modules_Tsumo_engine_src_docs_markdown.renderDocsMarkdown(parsed_1.body, new DocsLinkRewriteContext(mount, route.sourcePath, dirKey, routeMap, docsConfig.strictLinks));
                                ...
                                string plainText_1 = Markdig.Markdown.ToPlainText(parsed_1.body, Node_modules_Tsumo_engine_src_markdown_pipeline.markdownPipeline);
                                plain = plainText_1;
                                ...
                                string? editUrl_1 = Node_modules_Tsumo_engine_src_docs_editUrl.createDocsEditUrl(mount, route.relPath);
                ...
                if (!homeMountMatched)
                {
                    throw Node_modules_Tsumo_engine_src_diagnostics.createTsumoError("TSUMO_DOCS_HOME_MOUNT_NOT_FOUND", $"Configured homeMount does not match a docs mount: {homeMount ?? ""}", docsLoaded.path);
                }
                ...
                Node_modules_Tsumo_engine_src_docs_directoryGraph.assignDocsPageAncestry(homeCtx, null, emptyPages);
                site.home = homeCtx;
                ...
                string homeHtml = Node_modules_Tsumo_engine_src_build_layout.renderWithBase(env, baseTpl, homeTpl, homeCtx);
                ...
                for (int i_3 = 0; i_3 < allPages.length; i_3++)
                {
                    ...
                    string html = Node_modules_Tsumo_engine_src_build_layout.renderWithBase(env, baseTpl, tpl, page);
                    string outputRelPath = Node_modules_Tsumo_engine_src_docs_output.docsOutputPathForPermalink(page.relPermalink);
                ...
                if (docsConfig.generateSearchIndex)
                {
                    ...
                    if (name != "")
                    {
                        ...
                        string json = Node_modules_Tsumo_engine_src_docs_searchIndex.renderSearchIndexJson(searchDocs);
